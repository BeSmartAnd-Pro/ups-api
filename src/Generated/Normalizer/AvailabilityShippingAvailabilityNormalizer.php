...
class AvailabilityShippingAvailabilityNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\AvailabilityShippingAvailability';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\AvailabilityShippingAvailability';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\AvailabilityShippingAvailability();
        ...
        if (\array_key_exists('UnavailableReason', $data)) {
            $object->setUnavailableReason($this->denormalizer->denormalize($data['UnavailableReason'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShippingAvailabilityUnavailableReason', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\AvailabilityShippingAvailability' => false);
    }
}