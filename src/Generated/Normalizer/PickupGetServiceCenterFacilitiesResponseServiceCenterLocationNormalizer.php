...
class PickupGetServiceCenterFacilitiesResponseServiceCenterLocationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupGetServiceCenterFacilitiesResponseServiceCenterLocation';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupGetServiceCenterFacilitiesResponseServiceCenterLocation';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\PickupGetServiceCenterFacilitiesResponseServiceCenterLocation();
        ...
        if (\array_key_exists('DropOffFacilities', $data)) {
            ...
            foreach ($data['DropOffFacilities'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\UpsApi\\Generated\\Model\\ServiceCenterLocationDropOffFacilities', 'json', $context);
            }
            $object->setDropOffFacilities($values);
            unset($data['DropOffFacilities']);
        }
        if (\array_key_exists('PickupFacilities', $data)) {
            $object->setPickupFacilities($this->denormalizer->denormalize($data['PickupFacilities'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ServiceCenterLocationPickupFacilities', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\PickupGetServiceCenterFacilitiesResponseServiceCenterLocation' => false);
    }
}