...
class OverSeasLegValueNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\OverSeasLegValue';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\OverSeasLegValue';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\OverSeasLegValue();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('Cube', $data)) {
            $object->setCube($this->denormalizer->denormalize($data['Cube'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ValueCube', 'json', $context));
            unset($data['Cube']);
        }
        if (\array_key_exists('CWT', $data)) {
            $object->setCWT($this->denormalizer->denormalize($data['CWT'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ValueCWT', 'json', $context));
            unset($data['CWT']);
        }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\OverSeasLegValue' => false);
    }
}