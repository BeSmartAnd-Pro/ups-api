...
class ShipmentResponseShipmentResultsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentResponseShipmentResults';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentResponseShipmentResults';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\ShipmentResponseShipmentResults();
        ...
        if (\array_key_exists('Disclaimer', $data) && $data['Disclaimer'] !== null) {
            ...
            foreach ($data['Disclaimer'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentResultsDisclaimer', 'json', $context);
            }
        ...
        if (\array_key_exists('ShipmentCharges', $data) && $data['ShipmentCharges'] !== null) {
            $object->setShipmentCharges($this->denormalizer->denormalize($data['ShipmentCharges'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentResultsShipmentCharges', 'json', $context));
        ...
        if (\array_key_exists('NegotiatedRateCharges', $data) && $data['NegotiatedRateCharges'] !== null) {
            $object->setNegotiatedRateCharges($this->denormalizer->denormalize($data['NegotiatedRateCharges'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentResultsNegotiatedRateCharges', 'json', $context));
        ...
        if (\array_key_exists('FRSShipmentData', $data) && $data['FRSShipmentData'] !== null) {
            $object->setFRSShipmentData($this->denormalizer->denormalize($data['FRSShipmentData'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentResultsFRSShipmentData', 'json', $context));
        ...
        if (\array_key_exists('BillingWeight', $data)) {
            $object->setBillingWeight($this->denormalizer->denormalize($data['BillingWeight'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentResultsBillingWeight', 'json', $context));
        ...
        if (\array_key_exists('PackageResults', $data) && $data['PackageResults'] !== null) {
            ...
            foreach ($data['PackageResults'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentResultsPackageResults', 'json', $context);
            }
        ...
        if (\array_key_exists('ControlLogReceipt', $data) && $data['ControlLogReceipt'] !== null) {
            ...
            foreach ($data['ControlLogReceipt'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentResultsControlLogReceipt', 'json', $context);
            }
        ...
        if (\array_key_exists('Form', $data) && $data['Form'] !== null) {
            $object->setForm($this->denormalizer->denormalize($data['Form'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentResultsForm', 'json', $context));
            unset($data['Form']);
        }
        ...
        if (\array_key_exists('CODTurnInPage', $data) && $data['CODTurnInPage'] !== null) {
            $object->setCODTurnInPage($this->denormalizer->denormalize($data['CODTurnInPage'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentResultsCODTurnInPage', 'json', $context));
        ...
        if (\array_key_exists('HighValueReport', $data) && $data['HighValueReport'] !== null) {
            $object->setHighValueReport($this->denormalizer->denormalize($data['HighValueReport'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentResultsHighValueReport', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentResponseShipmentResults' => false);
    }
}