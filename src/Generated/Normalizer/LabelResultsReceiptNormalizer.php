...
class LabelResultsReceiptNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\LabelResultsReceipt';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\LabelResultsReceipt';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\LabelResultsReceipt();
        ...
        if (\array_key_exists('Image', $data)) {
            $object->setImage($this->denormalizer->denormalize($data['Image'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ReceiptImage', 'json', $context));
            unset($data['Image']);
        }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\LabelResultsReceipt' => false);
    }
}