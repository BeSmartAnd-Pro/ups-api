...
class ShipmentReferenceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentReference';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentReference';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\ShipmentReference();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('Number', $data)) {
            $object->setNumber($this->denormalizer->denormalize($data['Number'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ReferenceNumber', 'json', $context));
            unset($data['Number']);
        }
        ...
        if (\array_key_exists('Weight', $data)) {
            $object->setWeight($this->denormalizer->denormalize($data['Weight'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ReferenceWeight', 'json', $context));
            unset($data['Weight']);
        }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentReference' => false);
    }
}