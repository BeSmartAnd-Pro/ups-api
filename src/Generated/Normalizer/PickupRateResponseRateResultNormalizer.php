...
class PickupRateResponseRateResultNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupRateResponseRateResult';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupRateResponseRateResult';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\PickupRateResponseRateResult();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('Disclaimer', $data)) {
            $object->setDisclaimer($this->denormalizer->denormalize($data['Disclaimer'], 'BesmartandPro\\UpsApi\\Generated\\Model\\RateResultDisclaimer', 'json', $context));
        ...
        if (\array_key_exists('ChargeDetail', $data)) {
            $object->setChargeDetail($this->denormalizer->denormalize($data['ChargeDetail'], 'BesmartandPro\\UpsApi\\Generated\\Model\\RateResultChargeDetail', 'json', $context));
            unset($data['ChargeDetail']);
        }
        if (\array_key_exists('TaxCharges', $data)) {
            $object->setTaxCharges($this->denormalizer->denormalize($data['TaxCharges'], 'BesmartandPro\\UpsApi\\Generated\\Model\\RateResultTaxCharges', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\PickupRateResponseRateResult' => false);
    }
}