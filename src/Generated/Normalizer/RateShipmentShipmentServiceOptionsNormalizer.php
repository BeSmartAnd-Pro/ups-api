...
class RateShipmentShipmentServiceOptionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\RateShipmentShipmentServiceOptions';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\RateShipmentShipmentServiceOptions';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\RateShipmentShipmentServiceOptions();
        ...
        if (\array_key_exists('DeliveryConfirmation', $data)) {
            $object->setDeliveryConfirmation($this->denormalizer->denormalize($data['DeliveryConfirmation'], 'BesmartandPro\\UpsApi\\Generated\\Model\\RateShipmentServiceOptionsDeliveryConfirmation', 'json', $context));
        ...
        if (\array_key_exists('PickupOptions', $data)) {
            $object->setPickupOptions($this->denormalizer->denormalize($data['PickupOptions'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentServiceOptionsPickupOptions', 'json', $context));
            unset($data['PickupOptions']);
        }
        if (\array_key_exists('DeliveryOptions', $data)) {
            $object->setDeliveryOptions($this->denormalizer->denormalize($data['DeliveryOptions'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentServiceOptionsDeliveryOptions', 'json', $context));
            unset($data['DeliveryOptions']);
        }
        if (\array_key_exists('RestrictedArticles', $data)) {
            $object->setRestrictedArticles($this->denormalizer->denormalize($data['RestrictedArticles'], 'BesmartandPro\\UpsApi\\Generated\\Model\\RateShipmentServiceOptionsRestrictedArticles', 'json', $context));
        ...
        if (\array_key_exists('ImportControl', $data)) {
            $object->setImportControl($this->denormalizer->denormalize($data['ImportControl'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentServiceOptionsImportControl', 'json', $context));
            unset($data['ImportControl']);
        }
        if (\array_key_exists('ReturnService', $data)) {
            $object->setReturnService($this->denormalizer->denormalize($data['ReturnService'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentServiceOptionsReturnService', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\RateShipmentShipmentServiceOptions' => false);
    }
}