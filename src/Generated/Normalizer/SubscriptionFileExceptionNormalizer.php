...
class SubscriptionFileExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\SubscriptionFileException';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\SubscriptionFileException';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\SubscriptionFileException();
        ...
        if (\array_key_exists('PackageReferenceNumber', $data)) {
            ...
            foreach ($data['PackageReferenceNumber'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\UpsApi\\Generated\\Model\\ExceptionPackageReferenceNumber', 'json', $context);
            }
        ...
        if (\array_key_exists('ShipmentReferenceNumber', $data)) {
            ...
            foreach ($data['ShipmentReferenceNumber'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\UpsApi\\Generated\\Model\\ExceptionShipmentReferenceNumber', 'json', $context);
            }
        ...
        if (\array_key_exists('UpdatedAddress', $data)) {
            $object->setUpdatedAddress($this->denormalizer->denormalize($data['UpdatedAddress'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ExceptionUpdatedAddress', 'json', $context));
        ...
        if (\array_key_exists('Resolution', $data)) {
            $object->setResolution($this->denormalizer->denormalize($data['Resolution'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ExceptionResolution', 'json', $context));
        ...
        if (\array_key_exists('ActivityLocation', $data)) {
            $object->setActivityLocation($this->denormalizer->denormalize($data['ActivityLocation'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ExceptionActivityLocation', 'json', $context));
            unset($data['ActivityLocation']);
        }
        if (\array_key_exists('BillToAccount', $data)) {
            $object->setBillToAccount($this->denormalizer->denormalize($data['BillToAccount'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ExceptionBillToAccount', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\SubscriptionFileException' => false);
    }
}