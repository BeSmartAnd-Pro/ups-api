...
class QuantumViewResponseQuantumViewEventsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\QuantumViewResponseQuantumViewEvents';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\QuantumViewResponseQuantumViewEvents';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\QuantumViewResponseQuantumViewEvents();
        ...
        if (\array_key_exists('SubscriptionEvents', $data)) {
            ...
            foreach ($data['SubscriptionEvents'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\UpsApi\\Generated\\Model\\QuantumViewEventsSubscriptionEvents', 'json', $context);
            }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\QuantumViewResponseQuantumViewEvents' => false);
    }
}