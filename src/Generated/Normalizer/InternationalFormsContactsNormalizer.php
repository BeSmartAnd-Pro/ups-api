...
class InternationalFormsContactsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\InternationalFormsContacts';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\InternationalFormsContacts';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\InternationalFormsContacts();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('ForwardAgent', $data)) {
            $object->setForwardAgent($this->denormalizer->denormalize($data['ForwardAgent'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ContactsForwardAgent', 'json', $context));
            unset($data['ForwardAgent']);
        }
        if (\array_key_exists('UltimateConsignee', $data)) {
            $object->setUltimateConsignee($this->denormalizer->denormalize($data['UltimateConsignee'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ContactsUltimateConsignee', 'json', $context));
            unset($data['UltimateConsignee']);
        }
        if (\array_key_exists('IntermediateConsignee', $data)) {
            $object->setIntermediateConsignee($this->denormalizer->denormalize($data['IntermediateConsignee'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ContactsIntermediateConsignee', 'json', $context));
            unset($data['IntermediateConsignee']);
        }
        if (\array_key_exists('Producer', $data)) {
            $object->setProducer($this->denormalizer->denormalize($data['Producer'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ContactsProducer', 'json', $context));
            unset($data['Producer']);
        }
        if (\array_key_exists('SoldTo', $data)) {
            $object->setSoldTo($this->denormalizer->denormalize($data['SoldTo'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ContactsSoldTo', 'json', $context));
            unset($data['SoldTo']);
        }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\InternationalFormsContacts' => false);
    }
}