...
class PickupGetPoliticalDivision1ListResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupGetPoliticalDivision1ListResponse';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupGetPoliticalDivision1ListResponse';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\PickupGetPoliticalDivision1ListResponse();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('Response', $data)) {
            $object->setResponse($this->denormalizer->denormalize($data['Response'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupGetPoliticalDivision1ListResponseResponse', 'json', $context));
            unset($data['Response']);
        }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\PickupGetPoliticalDivision1ListResponse' => false);
    }
}