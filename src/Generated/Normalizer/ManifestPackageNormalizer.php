...
class ManifestPackageNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\ManifestPackage';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\ManifestPackage';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\ManifestPackage();
        ...
        if (\array_key_exists('Activity', $data)) {
            ...
            foreach ($data['Activity'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\UpsApi\\Generated\\Model\\PackageActivity', 'json', $context);
            }
        ...
        if (\array_key_exists('Dimensions', $data)) {
            $object->setDimensions($this->denormalizer->denormalize($data['Dimensions'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ManifestPackageDimensions', 'json', $context));
            unset($data['Dimensions']);
        }
        if (\array_key_exists('DimensionalWeight', $data)) {
            $object->setDimensionalWeight($this->denormalizer->denormalize($data['DimensionalWeight'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PackageDimensionalWeight', 'json', $context));
            unset($data['DimensionalWeight']);
        }
        if (\array_key_exists('PackageWeight', $data)) {
            $object->setPackageWeight($this->denormalizer->denormalize($data['PackageWeight'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ManifestPackagePackageWeight', 'json', $context));
        ...
        if (\array_key_exists('ReferenceNumber', $data)) {
            $object->setReferenceNumber($this->denormalizer->denormalize($data['ReferenceNumber'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ManifestPackageReferenceNumber', 'json', $context));
            unset($data['ReferenceNumber']);
        }
        if (\array_key_exists('PackageServiceOptions', $data)) {
            $object->setPackageServiceOptions($this->denormalizer->denormalize($data['PackageServiceOptions'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ManifestPackagePackageServiceOptions', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\ManifestPackage' => false);
    }
}