...
class FreightShipShipmentShipmentServiceOptionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightShipShipmentShipmentServiceOptions';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightShipShipmentShipmentServiceOptions';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\FreightShipShipmentShipmentServiceOptions();
        ...
        if (\array_key_exists('EMailInformation', $data)) {
            ...
            foreach ($data['EMailInformation'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentServiceOptionsEMailInformation', 'json', $context);
            }
            $object->setEMailInformation($values);
            unset($data['EMailInformation']);
        }
        if (\array_key_exists('PickupOptions', $data)) {
            $object->setPickupOptions($this->denormalizer->denormalize($data['PickupOptions'], 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightShipmentServiceOptionsPickupOptions', 'json', $context));
            unset($data['PickupOptions']);
        }
        if (\array_key_exists('DeliveryOptions', $data)) {
            $object->setDeliveryOptions($this->denormalizer->denormalize($data['DeliveryOptions'], 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightShipmentServiceOptionsDeliveryOptions', 'json', $context));
            unset($data['DeliveryOptions']);
        }
        if (\array_key_exists('OverSeasLeg', $data)) {
            $object->setOverSeasLeg($this->denormalizer->denormalize($data['OverSeasLeg'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentServiceOptionsOverSeasLeg', 'json', $context));
            unset($data['OverSeasLeg']);
        }
        if (\array_key_exists('COD', $data)) {
            $object->setCOD($this->denormalizer->denormalize($data['COD'], 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightShipmentServiceOptionsCOD', 'json', $context));
            unset($data['COD']);
        }
        if (\array_key_exists('DangerousGoods', $data)) {
            $object->setDangerousGoods($this->denormalizer->denormalize($data['DangerousGoods'], 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightShipShipmentServiceOptionsDangerousGoods', 'json', $context));
            unset($data['DangerousGoods']);
        }
        if (\array_key_exists('SortingAndSegregating', $data)) {
            $object->setSortingAndSegregating($this->denormalizer->denormalize($data['SortingAndSegregating'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentServiceOptionsSortingAndSegregating', 'json', $context));
            unset($data['SortingAndSegregating']);
        }
        if (\array_key_exists('DeclaredValue', $data)) {
            $object->setDeclaredValue($this->denormalizer->denormalize($data['DeclaredValue'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentServiceOptionsDeclaredValue', 'json', $context));
            unset($data['DeclaredValue']);
        }
        if (\array_key_exists('ExcessDeclaredValue', $data)) {
            $object->setExcessDeclaredValue($this->denormalizer->denormalize($data['ExcessDeclaredValue'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentServiceOptionsExcessDeclaredValue', 'json', $context));
            unset($data['ExcessDeclaredValue']);
        }
        if (\array_key_exists('HandlingCharge', $data)) {
            $object->setHandlingCharge($this->denormalizer->denormalize($data['HandlingCharge'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentServiceOptionsHandlingCharge', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\FreightShipShipmentShipmentServiceOptions' => false);
    }
}