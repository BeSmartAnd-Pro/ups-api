...
class ShipmentPickupRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentPickupRequest';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentPickupRequest';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\ShipmentPickupRequest();
        ...
        if (\array_key_exists('Requester', $data)) {
            $object->setRequester($this->denormalizer->denormalize($data['Requester'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupRequestRequester', 'json', $context));
        ...
        if (\array_key_exists('POM', $data)) {
            $object->setPOM($this->denormalizer->denormalize($data['POM'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupRequestPOM', 'json', $context));
            unset($data['POM']);
        }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentPickupRequest' => false);
    }
}