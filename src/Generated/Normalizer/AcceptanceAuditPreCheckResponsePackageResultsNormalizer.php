...
class AcceptanceAuditPreCheckResponsePackageResultsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\AcceptanceAuditPreCheckResponsePackageResults';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\AcceptanceAuditPreCheckResponsePackageResults';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\AcceptanceAuditPreCheckResponsePackageResults();
        ...
        if (\array_key_exists('ChemicalRecordResults', $data)) {
            ...
            foreach ($data['ChemicalRecordResults'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\UpsApi\\Generated\\Model\\PackageResultsChemicalRecordResults', 'json', $context);
            }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\AcceptanceAuditPreCheckResponsePackageResults' => false);
    }
}