...
class PackageResultsShippingLabelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\PackageResultsShippingLabel';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\PackageResultsShippingLabel';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\PackageResultsShippingLabel();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('ImageFormat', $data)) {
            $object->setImageFormat($this->denormalizer->denormalize($data['ImageFormat'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShippingLabelImageFormat', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\PackageResultsShippingLabel' => false);
    }
}