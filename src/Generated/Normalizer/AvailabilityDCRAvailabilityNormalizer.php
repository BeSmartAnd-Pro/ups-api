...
class AvailabilityDCRAvailabilityNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\AvailabilityDCRAvailability';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\AvailabilityDCRAvailability';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\AvailabilityDCRAvailability();
        ...
        if (\array_key_exists('UnavailableReason', $data)) {
            $object->setUnavailableReason($this->denormalizer->denormalize($data['UnavailableReason'], 'BesmartandPro\\UpsApi\\Generated\\Model\\DCRAvailabilityUnavailableReason', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\AvailabilityDCRAvailability' => false);
    }
}