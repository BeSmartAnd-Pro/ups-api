...
class SubscriptionFileGenericNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\SubscriptionFileGeneric';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\SubscriptionFileGeneric';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\SubscriptionFileGeneric();
        ...
        if (\array_key_exists('ShipmentReferenceNumber', $data)) {
            ...
            foreach ($data['ShipmentReferenceNumber'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\UpsApi\\Generated\\Model\\GenericShipmentReferenceNumber', 'json', $context);
            }
        ...
        if (\array_key_exists('PackageReferenceNumber', $data)) {
            ...
            foreach ($data['PackageReferenceNumber'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\UpsApi\\Generated\\Model\\GenericPackageReferenceNumber', 'json', $context);
            }
            $object->setPackageReferenceNumber($values_1);
            unset($data['PackageReferenceNumber']);
        }
        if (\array_key_exists('Service', $data)) {
            $object->setService($this->denormalizer->denormalize($data['Service'], 'BesmartandPro\\UpsApi\\Generated\\Model\\GenericService', 'json', $context));
            unset($data['Service']);
        }
        if (\array_key_exists('Activity', $data)) {
            $object->setActivity($this->denormalizer->denormalize($data['Activity'], 'BesmartandPro\\UpsApi\\Generated\\Model\\GenericActivity', 'json', $context));
            unset($data['Activity']);
        }
        if (\array_key_exists('BillToAccount', $data)) {
            $object->setBillToAccount($this->denormalizer->denormalize($data['BillToAccount'], 'BesmartandPro\\UpsApi\\Generated\\Model\\GenericBillToAccount', 'json', $context));
            unset($data['BillToAccount']);
        }
        if (\array_key_exists('ShipTo', $data)) {
            $object->setShipTo($this->denormalizer->denormalize($data['ShipTo'], 'BesmartandPro\\UpsApi\\Generated\\Model\\GenericShipTo', 'json', $context));
            unset($data['ShipTo']);
        }
        ...
        if (\array_key_exists('FailureNotification', $data)) {
            $object->setFailureNotification($this->denormalizer->denormalize($data['FailureNotification'], 'BesmartandPro\\UpsApi\\Generated\\Model\\GenericFailureNotification', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\SubscriptionFileGeneric' => false);
    }
}