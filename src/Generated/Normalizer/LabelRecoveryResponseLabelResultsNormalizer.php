...
class LabelRecoveryResponseLabelResultsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\LabelRecoveryResponseLabelResults';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\LabelRecoveryResponseLabelResults';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\LabelRecoveryResponseLabelResults();
        ...
        if (\array_key_exists('LabelImage', $data)) {
            $object->setLabelImage($this->denormalizer->denormalize($data['LabelImage'], 'BesmartandPro\\UpsApi\\Generated\\Model\\LabelResultsLabelImage', 'json', $context));
        ...
        if (\array_key_exists('MailInnovationsLabelImage', $data)) {
            $object->setMailInnovationsLabelImage($this->denormalizer->denormalize($data['MailInnovationsLabelImage'], 'BesmartandPro\\UpsApi\\Generated\\Model\\LabelResultsMailInnovationsLabelImage', 'json', $context));
            unset($data['MailInnovationsLabelImage']);
        }
        if (\array_key_exists('Receipt', $data)) {
            $object->setReceipt($this->denormalizer->denormalize($data['Receipt'], 'BesmartandPro\\UpsApi\\Generated\\Model\\LabelResultsReceipt', 'json', $context));
            unset($data['Receipt']);
        }
        if (\array_key_exists('Form', $data)) {
            $object->setForm($this->denormalizer->denormalize($data['Form'], 'BesmartandPro\\UpsApi\\Generated\\Model\\LabelResultsForm', 'json', $context));
            unset($data['Form']);
        }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\LabelRecoveryResponseLabelResults' => false);
    }
}