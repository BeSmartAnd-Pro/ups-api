...
class LocationSearchCriteriaAccessPointSearchNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\LocationSearchCriteriaAccessPointSearch';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\LocationSearchCriteriaAccessPointSearch';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\LocationSearchCriteriaAccessPointSearch();
        ...
        if (\array_key_exists('IncludeCriteria', $data)) {
            $object->setIncludeCriteria($this->denormalizer->denormalize($data['IncludeCriteria'], 'BesmartandPro\\UpsApi\\Generated\\Model\\AccessPointSearchIncludeCriteria', 'json', $context));
            unset($data['IncludeCriteria']);
        }
        if (\array_key_exists('ExcludeFromResult', $data)) {
            $object->setExcludeFromResult($this->denormalizer->denormalize($data['ExcludeFromResult'], 'BesmartandPro\\UpsApi\\Generated\\Model\\AccessPointSearchExcludeFromResult', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\LocationSearchCriteriaAccessPointSearch' => false);
    }
}