...
class FreightShipPOMPickupNotificationsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightShipPOMPickupNotifications';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightShipPOMPickupNotifications';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\FreightShipPOMPickupNotifications();
        ...
        if (\array_key_exists('EMailNotification', $data)) {
            $object->setEMailNotification($this->denormalizer->denormalize($data['EMailNotification'], 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightShipPickupNotificationsEMailNotification', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\FreightShipPOMPickupNotifications' => false);
    }
}