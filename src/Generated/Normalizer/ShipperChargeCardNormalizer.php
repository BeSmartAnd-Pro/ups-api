...
class ShipperChargeCardNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipperChargeCard';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipperChargeCard';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\ShipperChargeCard();
        ...
        if (\array_key_exists('CardAddress', $data)) {
            $object->setCardAddress($this->denormalizer->denormalize($data['CardAddress'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ChargeCardCardAddress', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\ShipperChargeCard' => false);
    }
}