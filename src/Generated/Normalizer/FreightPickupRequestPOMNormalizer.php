...
class FreightPickupRequestPOMNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightPickupRequestPOM';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightPickupRequestPOM';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\FreightPickupRequestPOM();
        ...
        if (\array_key_exists('PickupNotifications', $data)) {
            $object->setPickupNotifications($this->denormalizer->denormalize($data['PickupNotifications'], 'BesmartandPro\\UpsApi\\Generated\\Model\\POMPickupNotifications', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\FreightPickupRequestPOM' => false);
    }
}