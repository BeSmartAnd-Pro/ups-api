...
class FreightRateRequestCommodityNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightRateRequestCommodity';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightRateRequestCommodity';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\FreightRateRequestCommodity();
        ...
        if (\array_key_exists('Weight', $data)) {
            $object->setWeight($this->denormalizer->denormalize($data['Weight'], 'BesmartandPro\\UpsApi\\Generated\\Model\\CommodityWeight', 'json', $context));
            unset($data['Weight']);
        }
        if (\array_key_exists('AdjustedWeight', $data)) {
            $object->setAdjustedWeight($this->denormalizer->denormalize($data['AdjustedWeight'], 'BesmartandPro\\UpsApi\\Generated\\Model\\CommodityAdjustedWeight', 'json', $context));
            unset($data['AdjustedWeight']);
        }
        if (\array_key_exists('Dimensions', $data)) {
            $object->setDimensions($this->denormalizer->denormalize($data['Dimensions'], 'BesmartandPro\\UpsApi\\Generated\\Model\\CommodityDimensions', 'json', $context));
        ...
        if (\array_key_exists('PackagingType', $data)) {
            $object->setPackagingType($this->denormalizer->denormalize($data['PackagingType'], 'BesmartandPro\\UpsApi\\Generated\\Model\\CommodityPackagingType', 'json', $context));
        ...
        if (\array_key_exists('CommodityValue', $data)) {
            $object->setCommodityValue($this->denormalizer->denormalize($data['CommodityValue'], 'BesmartandPro\\UpsApi\\Generated\\Model\\CommodityCommodityValue', 'json', $context));
        ...
        if (\array_key_exists('NMFCCommodity', $data)) {
            $object->setNMFCCommodity($this->denormalizer->denormalize($data['NMFCCommodity'], 'BesmartandPro\\UpsApi\\Generated\\Model\\CommodityNMFCCommodity', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\FreightRateRequestCommodity' => false);
    }
}