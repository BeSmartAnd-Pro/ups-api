...
class FreightRateRequestGFPOptionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightRateRequestGFPOptions';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightRateRequestGFPOptions';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\FreightRateRequestGFPOptions();
        ...
        if (\array_key_exists('OnCallInformation', $data)) {
            $object->setOnCallInformation($this->denormalizer->denormalize($data['OnCallInformation'], 'BesmartandPro\\UpsApi\\Generated\\Model\\GFPOptionsOnCallInformation', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\FreightRateRequestGFPOptions' => false);
    }
}