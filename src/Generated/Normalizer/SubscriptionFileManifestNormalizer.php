...
class SubscriptionFileManifestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\SubscriptionFileManifest';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\SubscriptionFileManifest';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\SubscriptionFileManifest();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('Shipper', $data)) {
            $object->setShipper($this->denormalizer->denormalize($data['Shipper'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ManifestShipper', 'json', $context));
            unset($data['Shipper']);
        }
        if (\array_key_exists('ShipTo', $data)) {
            $object->setShipTo($this->denormalizer->denormalize($data['ShipTo'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ManifestShipTo', 'json', $context));
            unset($data['ShipTo']);
        }
        if (\array_key_exists('ReferenceNumber', $data)) {
            $values = array();
            foreach ($data['ReferenceNumber'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\UpsApi\\Generated\\Model\\ManifestReferenceNumber', 'json', $context);
            }
            $object->setReferenceNumber($values);
            unset($data['ReferenceNumber']);
        }
        if (\array_key_exists('Service', $data)) {
            $object->setService($this->denormalizer->denormalize($data['Service'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ManifestService', 'json', $context));
            unset($data['Service']);
        }
        ...
        if (\array_key_exists('Package', $data)) {
            ...
            foreach ($data['Package'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\UpsApi\\Generated\\Model\\ManifestPackage', 'json', $context);
            }
            $object->setPackage($values_1);
            unset($data['Package']);
        }
        if (\array_key_exists('ShipmentServiceOptions', $data)) {
            $object->setShipmentServiceOptions($this->denormalizer->denormalize($data['ShipmentServiceOptions'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ManifestShipmentServiceOptions', 'json', $context));
        ...
        if (\array_key_exists('CustomsValue', $data)) {
            $object->setCustomsValue($this->denormalizer->denormalize($data['CustomsValue'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ManifestCustomsValue', 'json', $context));
        ...
        if (\array_key_exists('BillToAccount', $data)) {
            $object->setBillToAccount($this->denormalizer->denormalize($data['BillToAccount'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ManifestBillToAccount', 'json', $context));
        ...
        if (\array_key_exists('UAPAddress', $data)) {
            $object->setUAPAddress($this->denormalizer->denormalize($data['UAPAddress'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ManifestUAPAddress', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\SubscriptionFileManifest' => false);
    }
}