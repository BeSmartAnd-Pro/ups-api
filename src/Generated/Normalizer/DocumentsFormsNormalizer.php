...
class DocumentsFormsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\DocumentsForms';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\DocumentsForms';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\DocumentsForms();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('Type', $data)) {
            $object->setType($this->denormalizer->denormalize($data['Type'], 'BesmartandPro\\UpsApi\\Generated\\Model\\FormsType', 'json', $context));
            unset($data['Type']);
        }
        ...
        if (\array_key_exists('Format', $data)) {
            $object->setFormat($this->denormalizer->denormalize($data['Format'], 'BesmartandPro\\UpsApi\\Generated\\Model\\FormsFormat', 'json', $context));
            unset($data['Format']);
        }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\DocumentsForms' => false);
    }
}