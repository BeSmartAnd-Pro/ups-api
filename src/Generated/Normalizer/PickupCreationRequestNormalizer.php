...
class PickupCreationRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupCreationRequest';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupCreationRequest';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\PickupCreationRequest();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('Request', $data)) {
            $object->setRequest($this->denormalizer->denormalize($data['Request'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupCreationRequestRequest', 'json', $context));
            unset($data['Request']);
        }
        ...
        if (\array_key_exists('Shipper', $data)) {
            $object->setShipper($this->denormalizer->denormalize($data['Shipper'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupCreationRequestShipper', 'json', $context));
            unset($data['Shipper']);
        }
        if (\array_key_exists('PickupDateInfo', $data)) {
            $object->setPickupDateInfo($this->denormalizer->denormalize($data['PickupDateInfo'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupCreationRequestPickupDateInfo', 'json', $context));
            unset($data['PickupDateInfo']);
        }
        if (\array_key_exists('PickupAddress', $data)) {
            $object->setPickupAddress($this->denormalizer->denormalize($data['PickupAddress'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupCreationRequestPickupAddress', 'json', $context));
        ...
        if (\array_key_exists('PickupPiece', $data)) {
            ...
            foreach ($data['PickupPiece'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupCreationRequestPickupPiece', 'json', $context);
            }
            $object->setPickupPiece($values);
            unset($data['PickupPiece']);
        }
        if (\array_key_exists('TotalWeight', $data)) {
            $object->setTotalWeight($this->denormalizer->denormalize($data['TotalWeight'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupCreationRequestTotalWeight', 'json', $context));
        ...
        if (\array_key_exists('TrackingData', $data)) {
            ...
            foreach ($data['TrackingData'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupCreationRequestTrackingData', 'json', $context);
            }
            $object->setTrackingData($values_1);
            unset($data['TrackingData']);
        }
        if (\array_key_exists('TrackingDataWithReferenceNumber', $data)) {
            $object->setTrackingDataWithReferenceNumber($this->denormalizer->denormalize($data['TrackingDataWithReferenceNumber'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupCreationRequestTrackingDataWithReferenceNumber', 'json', $context));
        ...
        if (\array_key_exists('FreightOptions', $data)) {
            $object->setFreightOptions($this->denormalizer->denormalize($data['FreightOptions'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupCreationRequestFreightOptions', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\PickupCreationRequest' => false);
    }
}