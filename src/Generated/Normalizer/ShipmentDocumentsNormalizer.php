...
class ShipmentDocumentsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentDocuments';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentDocuments';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\ShipmentDocuments();
        ...
        if (\array_key_exists('Image', $data)) {
            ...
            foreach ($data['Image'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\UpsApi\\Generated\\Model\\DocumentsImage', 'json', $context);
            }
            $object->setImage($values);
            unset($data['Image']);
        }
        if (\array_key_exists('PackingList', $data)) {
            $object->setPackingList($this->denormalizer->denormalize($data['PackingList'], 'BesmartandPro\\UpsApi\\Generated\\Model\\DocumentsPackingList', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentDocuments' => false);
    }
}