...
class PaymentInformationShipmentChargeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\PaymentInformationShipmentCharge';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\PaymentInformationShipmentCharge';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\PaymentInformationShipmentCharge();
        ...
        if (\array_key_exists('BillShipper', $data)) {
            $object->setBillShipper($this->denormalizer->denormalize($data['BillShipper'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentChargeBillShipper', 'json', $context));
            unset($data['BillShipper']);
        }
        if (\array_key_exists('BillReceiver', $data)) {
            $object->setBillReceiver($this->denormalizer->denormalize($data['BillReceiver'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentChargeBillReceiver', 'json', $context));
            unset($data['BillReceiver']);
        }
        if (\array_key_exists('BillThirdParty', $data)) {
            $object->setBillThirdParty($this->denormalizer->denormalize($data['BillThirdParty'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentChargeBillThirdParty', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\PaymentInformationShipmentCharge' => false);
    }
}