...
class TimeInTransitResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\TimeInTransitResponse';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\TimeInTransitResponse';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\TimeInTransitResponse();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('validationList', $data)) {
            $object->setValidationList($this->denormalizer->denormalize($data['validationList'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ValidationList', 'json', $context));
            unset($data['validationList']);
        }
        if (\array_key_exists('destinationPickList', $data)) {
            $values = array();
            foreach ($data['destinationPickList'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\UpsApi\\Generated\\Model\\CandidateAddress', 'json', $context);
            }
        ...
        if (\array_key_exists('originPickList', $data)) {
            ...
            foreach ($data['originPickList'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\UpsApi\\Generated\\Model\\CandidateAddress', 'json', $context);
            }
            $object->setOriginPickList($values_1);
            unset($data['originPickList']);
        }
        if (\array_key_exists('emsResponse', $data)) {
            $object->setEmsResponse($this->denormalizer->denormalize($data['emsResponse'], 'BesmartandPro\\UpsApi\\Generated\\Model\\EmsResponse', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\TimeInTransitResponse' => false);
    }
}