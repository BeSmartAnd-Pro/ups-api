...
class RateRequestShipmentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\RateRequestShipment';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\RateRequestShipment';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\RateRequestShipment();
        ...
        if (\array_key_exists('Shipper', $data)) {
            $object->setShipper($this->denormalizer->denormalize($data['Shipper'], 'BesmartandPro\\UpsApi\\Generated\\Model\\RateShipmentShipper', 'json', $context));
            unset($data['Shipper']);
        }
        if (\array_key_exists('ShipTo', $data)) {
            $object->setShipTo($this->denormalizer->denormalize($data['ShipTo'], 'BesmartandPro\\UpsApi\\Generated\\Model\\RateShipmentShipTo', 'json', $context));
            unset($data['ShipTo']);
        }
        if (\array_key_exists('ShipFrom', $data)) {
            $object->setShipFrom($this->denormalizer->denormalize($data['ShipFrom'], 'BesmartandPro\\UpsApi\\Generated\\Model\\RateShipmentShipFrom', 'json', $context));
            unset($data['ShipFrom']);
        }
        if (\array_key_exists('AlternateDeliveryAddress', $data)) {
            $object->setAlternateDeliveryAddress($this->denormalizer->denormalize($data['AlternateDeliveryAddress'], 'BesmartandPro\\UpsApi\\Generated\\Model\\RateShipmentAlternateDeliveryAddress', 'json', $context));
        ...
        if (\array_key_exists('ShipmentIndicationType', $data)) {
            ...
            foreach ($data['ShipmentIndicationType'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentShipmentIndicationType', 'json', $context);
            }
            $object->setShipmentIndicationType($values);
            unset($data['ShipmentIndicationType']);
        }
        if (\array_key_exists('PaymentDetails', $data)) {
            $object->setPaymentDetails($this->denormalizer->denormalize($data['PaymentDetails'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentPaymentDetails', 'json', $context));
            unset($data['PaymentDetails']);
        }
        if (\array_key_exists('FRSPaymentInformation', $data)) {
            $object->setFRSPaymentInformation($this->denormalizer->denormalize($data['FRSPaymentInformation'], 'BesmartandPro\\UpsApi\\Generated\\Model\\RateShipmentFRSPaymentInformation', 'json', $context));
        ...
        if (\array_key_exists('ShipmentTotalWeight', $data)) {
            $object->setShipmentTotalWeight($this->denormalizer->denormalize($data['ShipmentTotalWeight'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentShipmentTotalWeight', 'json', $context));
        ...
        if (\array_key_exists('Package', $data)) {
            ...
            foreach ($data['Package'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\UpsApi\\Generated\\Model\\RateShipmentPackage', 'json', $context);
            }
            $object->setPackage($values_1);
            unset($data['Package']);
        }
        if (\array_key_exists('ShipmentServiceOptions', $data)) {
            $object->setShipmentServiceOptions($this->denormalizer->denormalize($data['ShipmentServiceOptions'], 'BesmartandPro\\UpsApi\\Generated\\Model\\RateShipmentShipmentServiceOptions', 'json', $context));
        ...
        if (\array_key_exists('DeliveryTimeInformation', $data)) {
            $object->setDeliveryTimeInformation($this->denormalizer->denormalize($data['DeliveryTimeInformation'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentDeliveryTimeInformation', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\RateRequestShipment' => false);
    }
}