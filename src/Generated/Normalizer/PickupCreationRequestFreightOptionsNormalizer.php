...
class PickupCreationRequestFreightOptionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupCreationRequestFreightOptions';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupCreationRequestFreightOptions';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\PickupCreationRequestFreightOptions();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('ShipmentServiceOptions', $data)) {
            $object->setShipmentServiceOptions($this->denormalizer->denormalize($data['ShipmentServiceOptions'], 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightOptionsShipmentServiceOptions', 'json', $context));
        ...
        if (\array_key_exists('DestinationAddress', $data)) {
            $object->setDestinationAddress($this->denormalizer->denormalize($data['DestinationAddress'], 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightOptionsDestinationAddress', 'json', $context));
            unset($data['DestinationAddress']);
        }
        if (\array_key_exists('ShipmentDetail', $data)) {
            $object->setShipmentDetail($this->denormalizer->denormalize($data['ShipmentDetail'], 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightOptionsShipmentDetail', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\PickupCreationRequestFreightOptions' => false);
    }
}