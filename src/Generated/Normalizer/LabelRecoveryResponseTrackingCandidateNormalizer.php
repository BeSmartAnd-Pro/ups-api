...
class LabelRecoveryResponseTrackingCandidateNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\LabelRecoveryResponseTrackingCandidate';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\LabelRecoveryResponseTrackingCandidate';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\LabelRecoveryResponseTrackingCandidate();
        ...
        if (\array_key_exists('PickupDateRange', $data)) {
            $object->setPickupDateRange($this->denormalizer->denormalize($data['PickupDateRange'], 'BesmartandPro\\UpsApi\\Generated\\Model\\TrackingCandidatePickupDateRange', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\LabelRecoveryResponseTrackingCandidate' => false);
    }
}