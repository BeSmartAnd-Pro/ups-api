...
class TrackSubsServiceErrorResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\TrackSubsServiceErrorResponse';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\TrackSubsServiceErrorResponse';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\TrackSubsServiceErrorResponse();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('response', $data)) {
            $object->setResponse($this->denormalizer->denormalize($data['response'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ErrorResponse', 'json', $context));
            unset($data['response']);
        }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\TrackSubsServiceErrorResponse' => false);
    }
}