...
class PickupCreationRequestPickupAddressNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupCreationRequestPickupAddress';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupCreationRequestPickupAddress';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\PickupCreationRequestPickupAddress();
        ...
        if (\array_key_exists('Phone', $data)) {
            $object->setPhone($this->denormalizer->denormalize($data['Phone'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupAddressPhone', 'json', $context));
            unset($data['Phone']);
        }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\PickupCreationRequestPickupAddress' => false);
    }
}