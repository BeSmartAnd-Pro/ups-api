...
class QuantumViewResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\QuantumViewResponse';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\QuantumViewResponse';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\QuantumViewResponse();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('Response', $data)) {
            $object->setResponse($this->denormalizer->denormalize($data['Response'], 'BesmartandPro\\UpsApi\\Generated\\Model\\QuantumViewResponseResponse', 'json', $context));
            unset($data['Response']);
        }
        if (\array_key_exists('QuantumViewEvents', $data)) {
            $object->setQuantumViewEvents($this->denormalizer->denormalize($data['QuantumViewEvents'], 'BesmartandPro\\UpsApi\\Generated\\Model\\QuantumViewResponseQuantumViewEvents', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\QuantumViewResponse' => false);
    }
}