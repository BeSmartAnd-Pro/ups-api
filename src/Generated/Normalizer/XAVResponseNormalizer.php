...
class XAVResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\XAVResponse';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\XAVResponse';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\XAVResponse();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('Response', $data)) {
            $object->setResponse($this->denormalizer->denormalize($data['Response'], 'BesmartandPro\\UpsApi\\Generated\\Model\\XAVResponseResponse', 'json', $context));
            unset($data['Response']);
        }
        ...
        if (\array_key_exists('AddressClassification', $data)) {
            $object->setAddressClassification($this->denormalizer->denormalize($data['AddressClassification'], 'BesmartandPro\\UpsApi\\Generated\\Model\\XAVResponseAddressClassification', 'json', $context));
            unset($data['AddressClassification']);
        }
        if (\array_key_exists('Candidate', $data) && $data['Candidate'] !== null) {
            $object->setCandidate($this->denormalizer->denormalize($data['Candidate'], 'BesmartandPro\\UpsApi\\Generated\\Model\\XAVResponseCandidate', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\XAVResponse' => false);
    }
}