...
class ManifestShipmentServiceOptionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\ManifestShipmentServiceOptions';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\ManifestShipmentServiceOptions';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\ManifestShipmentServiceOptions();
        ...
        if (\array_key_exists('CallTagARS', $data)) {
            $object->setCallTagARS($this->denormalizer->denormalize($data['CallTagARS'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentServiceOptionsCallTagARS', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\ManifestShipmentServiceOptions' => false);
    }
}