...
class SearchResultsDropLocationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\SearchResultsDropLocation';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\SearchResultsDropLocation';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\SearchResultsDropLocation();
        ...
        if (\array_key_exists('IVR', $data)) {
            $object->setIVR($this->denormalizer->denormalize($data['IVR'], 'BesmartandPro\\UpsApi\\Generated\\Model\\DropLocationIVR', 'json', $context));
            unset($data['IVR']);
        }
        if (\array_key_exists('Geocode', $data)) {
            $object->setGeocode($this->denormalizer->denormalize($data['Geocode'], 'BesmartandPro\\UpsApi\\Generated\\Model\\DropLocationGeocode', 'json', $context));
            unset($data['Geocode']);
        }
        if (\array_key_exists('AddressKeyFormat', $data)) {
            $object->setAddressKeyFormat($this->denormalizer->denormalize($data['AddressKeyFormat'], 'BesmartandPro\\UpsApi\\Generated\\Model\\DropLocationAddressKeyFormat', 'json', $context));
        ...
        if (\array_key_exists('LocationAttribute', $data)) {
            ...
            foreach ($data['LocationAttribute'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\UpsApi\\Generated\\Model\\DropLocationLocationAttribute', 'json', $context);
            }
            $object->setLocationAttribute($values_1);
            unset($data['LocationAttribute']);
        }
        if (\array_key_exists('Distance', $data)) {
            $object->setDistance($this->denormalizer->denormalize($data['Distance'], 'BesmartandPro\\UpsApi\\Generated\\Model\\DropLocationDistance', 'json', $context));
            unset($data['Distance']);
        }
        if (\array_key_exists('SpecialInstructions', $data)) {
            $values_2 = array();
            foreach ($data['SpecialInstructions'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'BesmartandPro\\UpsApi\\Generated\\Model\\DropLocationSpecialInstructions', 'json', $context);
            }
        ...
        if (\array_key_exists('AdditionalComments', $data)) {
            $object->setAdditionalComments($this->denormalizer->denormalize($data['AdditionalComments'], 'BesmartandPro\\UpsApi\\Generated\\Model\\DropLocationAdditionalComments', 'json', $context));
        ...
        if (\array_key_exists('OperatingHours', $data)) {
            $object->setOperatingHours($this->denormalizer->denormalize($data['OperatingHours'], 'BesmartandPro\\UpsApi\\Generated\\Model\\DropLocationOperatingHours', 'json', $context));
            unset($data['OperatingHours']);
        }
        if (\array_key_exists('LocalizedInstruction', $data)) {
            $values_6 = array();
            foreach ($data['LocalizedInstruction'] as $value_6) {
                $values_6[] = $this->denormalizer->denormalize($value_6, 'BesmartandPro\\UpsApi\\Generated\\Model\\DropLocationLocalizedInstruction', 'json', $context);
            }
        ...
        if (\array_key_exists('PromotionInformation', $data)) {
            ...
            foreach ($data['PromotionInformation'] as $value_7) {
                $values_7[] = $this->denormalizer->denormalize($value_7, 'BesmartandPro\\UpsApi\\Generated\\Model\\DropLocationPromotionInformation', 'json', $context);
            }
            $object->setPromotionInformation($values_7);
            unset($data['PromotionInformation']);
        }
        if (\array_key_exists('SortCode', $data)) {
            $object->setSortCode($this->denormalizer->denormalize($data['SortCode'], 'BesmartandPro\\UpsApi\\Generated\\Model\\DropLocationSortCode', 'json', $context));
            unset($data['SortCode']);
        }
        if (\array_key_exists('ServiceOfferingList', $data)) {
            $object->setServiceOfferingList($this->denormalizer->denormalize($data['ServiceOfferingList'], 'BesmartandPro\\UpsApi\\Generated\\Model\\DropLocationServiceOfferingList', 'json', $context));
        ...
        if (\array_key_exists('AccessPointInformation', $data)) {
            $object->setAccessPointInformation($this->denormalizer->denormalize($data['AccessPointInformation'], 'BesmartandPro\\UpsApi\\Generated\\Model\\DropLocationAccessPointInformation', 'json', $context));
            unset($data['AccessPointInformation']);
        }
        if (\array_key_exists('LocationImage', $data)) {
            $object->setLocationImage($this->denormalizer->denormalize($data['LocationImage'], 'BesmartandPro\\UpsApi\\Generated\\Model\\DropLocationLocationImage', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\SearchResultsDropLocation' => false);
    }
}