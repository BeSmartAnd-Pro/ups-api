...
class QuantumViewResponseResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\QuantumViewResponseResponse';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\QuantumViewResponseResponse';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\QuantumViewResponseResponse();
        ...
        if (\array_key_exists('Error', $data)) {
            ...
            foreach ($data['Error'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\UpsApi\\Generated\\Model\\ResponseError', 'json', $context);
            }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\QuantumViewResponseResponse' => false);
    }
}