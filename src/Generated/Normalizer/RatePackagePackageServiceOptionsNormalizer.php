...
class RatePackagePackageServiceOptionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\RatePackagePackageServiceOptions';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\RatePackagePackageServiceOptions';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\RatePackagePackageServiceOptions();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('DeliveryConfirmation', $data)) {
            $object->setDeliveryConfirmation($this->denormalizer->denormalize($data['DeliveryConfirmation'], 'BesmartandPro\\UpsApi\\Generated\\Model\\RatePackageServiceOptionsDeliveryConfirmation', 'json', $context));
            unset($data['DeliveryConfirmation']);
        }
        if (\array_key_exists('AccessPointCOD', $data)) {
            $object->setAccessPointCOD($this->denormalizer->denormalize($data['AccessPointCOD'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PackageServiceOptionsAccessPointCOD', 'json', $context));
            unset($data['AccessPointCOD']);
        }
        if (\array_key_exists('COD', $data)) {
            $object->setCOD($this->denormalizer->denormalize($data['COD'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PackageServiceOptionsCOD', 'json', $context));
            unset($data['COD']);
        }
        if (\array_key_exists('DeclaredValue', $data)) {
            $object->setDeclaredValue($this->denormalizer->denormalize($data['DeclaredValue'], 'BesmartandPro\\UpsApi\\Generated\\Model\\RatePackageServiceOptionsDeclaredValue', 'json', $context));
            unset($data['DeclaredValue']);
        }
        if (\array_key_exists('ShipperDeclaredValue', $data)) {
            $object->setShipperDeclaredValue($this->denormalizer->denormalize($data['ShipperDeclaredValue'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PackageServiceOptionsShipperDeclaredValue', 'json', $context));
        ...
        if (\array_key_exists('HazMat', $data)) {
            $object->setHazMat($this->denormalizer->denormalize($data['HazMat'], 'BesmartandPro\\UpsApi\\Generated\\Model\\RatePackageServiceOptionsHazMat', 'json', $context));
            unset($data['HazMat']);
        }
        if (\array_key_exists('DryIce', $data)) {
            $object->setDryIce($this->denormalizer->denormalize($data['DryIce'], 'BesmartandPro\\UpsApi\\Generated\\Model\\RatePackageServiceOptionsDryIce', 'json', $context));
            unset($data['DryIce']);
        }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\RatePackagePackageServiceOptions' => false);
    }
}