...
class PickupCreationResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupCreationResponse';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupCreationResponse';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\PickupCreationResponse();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('Response', $data)) {
            $object->setResponse($this->denormalizer->denormalize($data['Response'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupCreationResponseResponse', 'json', $context));
            unset($data['Response']);
        }
        ...
        if (\array_key_exists('WeekendServiceTerritory', $data)) {
            $object->setWeekendServiceTerritory($this->denormalizer->denormalize($data['WeekendServiceTerritory'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupCreationResponseWeekendServiceTerritory', 'json', $context));
        ...
        if (\array_key_exists('RateStatus', $data)) {
            $object->setRateStatus($this->denormalizer->denormalize($data['RateStatus'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupCreationResponseRateStatus', 'json', $context));
            unset($data['RateStatus']);
        }
        if (\array_key_exists('RateResult', $data)) {
            $object->setRateResult($this->denormalizer->denormalize($data['RateResult'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupCreationResponseRateResult', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\PickupCreationResponse' => false);
    }
}