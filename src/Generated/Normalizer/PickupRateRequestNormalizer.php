...
class PickupRateRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupRateRequest';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupRateRequest';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\PickupRateRequest();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('Request', $data)) {
            $object->setRequest($this->denormalizer->denormalize($data['Request'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupRateRequestRequest', 'json', $context));
            unset($data['Request']);
        }
        if (\array_key_exists('ShipperAccount', $data)) {
            $object->setShipperAccount($this->denormalizer->denormalize($data['ShipperAccount'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupRateRequestShipperAccount', 'json', $context));
            unset($data['ShipperAccount']);
        }
        if (\array_key_exists('PickupAddress', $data)) {
            $object->setPickupAddress($this->denormalizer->denormalize($data['PickupAddress'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupRateRequestPickupAddress', 'json', $context));
        ...
        if (\array_key_exists('PickupDateInfo', $data)) {
            $object->setPickupDateInfo($this->denormalizer->denormalize($data['PickupDateInfo'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupRateRequestPickupDateInfo', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\PickupRateRequest' => false);
    }
}