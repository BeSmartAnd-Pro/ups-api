...
class RatePackageServiceOptionsDryIceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\RatePackageServiceOptionsDryIce';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\RatePackageServiceOptionsDryIce';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\RatePackageServiceOptionsDryIce();
        ...
        if (\array_key_exists('DryIceWeight', $data)) {
            $object->setDryIceWeight($this->denormalizer->denormalize($data['DryIceWeight'], 'BesmartandPro\\UpsApi\\Generated\\Model\\DryIceDryIceWeight', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\RatePackageServiceOptionsDryIce' => false);
    }
}