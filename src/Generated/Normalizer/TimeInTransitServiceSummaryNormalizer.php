...
class TimeInTransitServiceSummaryNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\TimeInTransitServiceSummary';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\TimeInTransitServiceSummary';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\TimeInTransitServiceSummary();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('Service', $data)) {
            $object->setService($this->denormalizer->denormalize($data['Service'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ServiceSummaryService', 'json', $context));
            unset($data['Service']);
        }
        ...
        if (\array_key_exists('EstimatedArrival', $data)) {
            $object->setEstimatedArrival($this->denormalizer->denormalize($data['EstimatedArrival'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ServiceSummaryEstimatedArrival', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\TimeInTransitServiceSummary' => false);
    }
}