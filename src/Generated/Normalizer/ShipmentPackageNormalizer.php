...
class ShipmentPackageNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentPackage';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentPackage';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\ShipmentPackage();
        ...
        if (\array_key_exists('Packaging', $data)) {
            $object->setPackaging($this->denormalizer->denormalize($data['Packaging'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PackagePackaging', 'json', $context));
        ...
        if (\array_key_exists('ReferenceNumber', $data)) {
            ...
            foreach ($data['ReferenceNumber'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\UpsApi\\Generated\\Model\\PackageReferenceNumber', 'json', $context);
            }
        ...
        if (\array_key_exists('UPSPremier', $data)) {
            $object->setUPSPremier($this->denormalizer->denormalize($data['UPSPremier'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PackageUPSPremier', 'json', $context));
            unset($data['UPSPremier']);
        }
        if (\array_key_exists('PackageServiceOptions', $data)) {
            $object->setPackageServiceOptions($this->denormalizer->denormalize($data['PackageServiceOptions'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PackagePackageServiceOptions', 'json', $context));
        ...
        if (\array_key_exists('HazMatPackageInformation', $data)) {
            $object->setHazMatPackageInformation($this->denormalizer->denormalize($data['HazMatPackageInformation'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PackageHazMatPackageInformation', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentPackage' => false);
    }
}