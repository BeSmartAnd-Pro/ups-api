...
class AlternateRatesResponseRateNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\AlternateRatesResponseRate';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\AlternateRatesResponseRate';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\AlternateRatesResponseRate();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('Type', $data)) {
            $object->setType($this->denormalizer->denormalize($data['Type'], 'BesmartandPro\\UpsApi\\Generated\\Model\\RateType', 'json', $context));
            unset($data['Type']);
        }
        ...
        if (\array_key_exists('Factor', $data)) {
            $object->setFactor($this->denormalizer->denormalize($data['Factor'], 'BesmartandPro\\UpsApi\\Generated\\Model\\RateFactor', 'json', $context));
            unset($data['Factor']);
        }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\AlternateRatesResponseRate' => false);
    }
}