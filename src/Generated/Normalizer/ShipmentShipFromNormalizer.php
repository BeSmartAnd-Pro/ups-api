...
class ShipmentShipFromNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentShipFrom';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentShipFrom';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\ShipmentShipFrom();
        ...
        if (\array_key_exists('TaxIDType', $data)) {
            $object->setTaxIDType($this->denormalizer->denormalize($data['TaxIDType'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipFromTaxIDType', 'json', $context));
            unset($data['TaxIDType']);
        }
        if (\array_key_exists('Phone', $data)) {
            $object->setPhone($this->denormalizer->denormalize($data['Phone'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipFromPhone', 'json', $context));
            unset($data['Phone']);
        }
        ...
        if (\array_key_exists('Address', $data)) {
            $object->setAddress($this->denormalizer->denormalize($data['Address'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipFromAddress', 'json', $context));
            unset($data['Address']);
        }
        if (\array_key_exists('VendorInfo', $data)) {
            $object->setVendorInfo($this->denormalizer->denormalize($data['VendorInfo'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipFromVendorInfo', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentShipFrom' => false);
    }
}