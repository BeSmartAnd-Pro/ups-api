...
class FreightRateResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightRateResponse';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightRateResponse';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\FreightRateResponse();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('Response', $data)) {
            $object->setResponse($this->denormalizer->denormalize($data['Response'], 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightRateResponseResponse', 'json', $context));
            unset($data['Response']);
        }
        if (\array_key_exists('Rate', $data)) {
            $values = array();
            foreach ($data['Rate'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightRateResponseRate', 'json', $context);
            }
            $object->setRate($values);
            unset($data['Rate']);
        }
        if (\array_key_exists('FreightDensityRate', $data)) {
            $object->setFreightDensityRate($this->denormalizer->denormalize($data['FreightDensityRate'], 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightRateResponseFreightDensityRate', 'json', $context));
            unset($data['FreightDensityRate']);
        }
        if (\array_key_exists('Commodity', $data)) {
            $values_1 = array();
            foreach ($data['Commodity'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightRateResponseCommodity', 'json', $context);
            }
            $object->setCommodity($values_1);
            unset($data['Commodity']);
        }
        if (\array_key_exists('TotalShipmentCharge', $data)) {
            $object->setTotalShipmentCharge($this->denormalizer->denormalize($data['TotalShipmentCharge'], 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightRateResponseTotalShipmentCharge', 'json', $context));
            unset($data['TotalShipmentCharge']);
        }
        if (\array_key_exists('BillableShipmentWeight', $data)) {
            $object->setBillableShipmentWeight($this->denormalizer->denormalize($data['BillableShipmentWeight'], 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightRateResponseBillableShipmentWeight', 'json', $context));
            unset($data['BillableShipmentWeight']);
        }
        if (\array_key_exists('DimensionalWeight', $data)) {
            $object->setDimensionalWeight($this->denormalizer->denormalize($data['DimensionalWeight'], 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightRateResponseDimensionalWeight', 'json', $context));
            unset($data['DimensionalWeight']);
        }
        if (\array_key_exists('Service', $data)) {
            $object->setService($this->denormalizer->denormalize($data['Service'], 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightRateResponseService', 'json', $context));
            unset($data['Service']);
        }
        ...
        if (\array_key_exists('AlternateRatesResponse', $data)) {
            ...
            foreach ($data['AlternateRatesResponse'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightRateResponseAlternateRatesResponse', 'json', $context);
            }
            $object->setAlternateRatesResponse($values_2);
            unset($data['AlternateRatesResponse']);
        }
        if (\array_key_exists('TimeInTransit', $data)) {
            $object->setTimeInTransit($this->denormalizer->denormalize($data['TimeInTransit'], 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightRateResponseTimeInTransit', 'json', $context));
            unset($data['TimeInTransit']);
        }
        if (\array_key_exists('HandlingUnits', $data)) {
            $object->setHandlingUnits($this->denormalizer->denormalize($data['HandlingUnits'], 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightRateResponseHandlingUnits', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\FreightRateResponse' => false);
    }
}