...
class InternationalFormsEEIFilingOptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\InternationalFormsEEIFilingOption';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\InternationalFormsEEIFilingOption';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\InternationalFormsEEIFilingOption();
        ...
        if (\array_key_exists('UPSFiled', $data)) {
            $object->setUPSFiled($this->denormalizer->denormalize($data['UPSFiled'], 'BesmartandPro\\UpsApi\\Generated\\Model\\EEIFilingOptionUPSFiled', 'json', $context));
            unset($data['UPSFiled']);
        }
        if (\array_key_exists('ShipperFiled', $data)) {
            $object->setShipperFiled($this->denormalizer->denormalize($data['ShipperFiled'], 'BesmartandPro\\UpsApi\\Generated\\Model\\EEIFilingOptionShipperFiled', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\InternationalFormsEEIFilingOption' => false);
    }
}