...
class DeliveryDeliveryLocationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\DeliveryDeliveryLocation';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\DeliveryDeliveryLocation';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\DeliveryDeliveryLocation();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('AddressArtifactFormat', $data)) {
            $object->setAddressArtifactFormat($this->denormalizer->denormalize($data['AddressArtifactFormat'], 'BesmartandPro\\UpsApi\\Generated\\Model\\DeliveryLocationAddressArtifactFormat', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\DeliveryDeliveryLocation' => false);
    }
}