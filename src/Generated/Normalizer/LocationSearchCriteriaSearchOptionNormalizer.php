...
class LocationSearchCriteriaSearchOptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\LocationSearchCriteriaSearchOption';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\LocationSearchCriteriaSearchOption';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\LocationSearchCriteriaSearchOption();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('OptionType', $data)) {
            $object->setOptionType($this->denormalizer->denormalize($data['OptionType'], 'BesmartandPro\\UpsApi\\Generated\\Model\\SearchOptionOptionType', 'json', $context));
            unset($data['OptionType']);
        }
        if (\array_key_exists('OptionCode', $data)) {
            $values = array();
            foreach ($data['OptionCode'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\UpsApi\\Generated\\Model\\SearchOptionOptionCode', 'json', $context);
            }
            $object->setOptionCode($values);
            unset($data['OptionCode']);
        }
        if (\array_key_exists('Relation', $data)) {
            $object->setRelation($this->denormalizer->denormalize($data['Relation'], 'BesmartandPro\\UpsApi\\Generated\\Model\\SearchOptionRelation', 'json', $context));
            unset($data['Relation']);
        }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\LocationSearchCriteriaSearchOption' => false);
    }
}