...
class FreightPickupRequestRequesterNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightPickupRequestRequester';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightPickupRequestRequester';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\FreightPickupRequestRequester();
        ...
        if (\array_key_exists('Phone', $data)) {
            $object->setPhone($this->denormalizer->denormalize($data['Phone'], 'BesmartandPro\\UpsApi\\Generated\\Model\\RequesterPhone', 'json', $context));
            unset($data['Phone']);
        }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\FreightPickupRequestRequester' => false);
    }
}