...
class SearchResultsGeocodeCandidateNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\SearchResultsGeocodeCandidate';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\SearchResultsGeocodeCandidate';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\SearchResultsGeocodeCandidate();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('AddressKeyFormat', $data)) {
            $object->setAddressKeyFormat($this->denormalizer->denormalize($data['AddressKeyFormat'], 'BesmartandPro\\UpsApi\\Generated\\Model\\GeocodeCandidateAddressKeyFormat', 'json', $context));
            unset($data['AddressKeyFormat']);
        }
        if (\array_key_exists('Geocode', $data)) {
            $object->setGeocode($this->denormalizer->denormalize($data['Geocode'], 'BesmartandPro\\UpsApi\\Generated\\Model\\GeocodeCandidateGeocode', 'json', $context));
            unset($data['Geocode']);
        }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\SearchResultsGeocodeCandidate' => false);
    }
}