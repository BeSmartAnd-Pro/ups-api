...
class XAVRequestWrapperNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\XAVRequestWrapper';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\XAVRequestWrapper';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\XAVRequestWrapper();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('XAVRequest', $data)) {
            $object->setXAVRequest($this->denormalizer->denormalize($data['XAVRequest'], 'BesmartandPro\\UpsApi\\Generated\\Model\\XAVRequest', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\XAVRequestWrapper' => false);
    }
}