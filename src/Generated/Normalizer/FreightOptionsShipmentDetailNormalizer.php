...
class FreightOptionsShipmentDetailNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightOptionsShipmentDetail';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightOptionsShipmentDetail';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\FreightOptionsShipmentDetail();
        ...
        if (\array_key_exists('PalletInformation', $data)) {
            $object->setPalletInformation($this->denormalizer->denormalize($data['PalletInformation'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentDetailPalletInformation', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\FreightOptionsShipmentDetail' => false);
    }
}