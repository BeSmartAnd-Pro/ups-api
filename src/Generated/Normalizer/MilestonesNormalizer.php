...
class MilestonesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\Milestones';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\Milestones';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\Milestones();
        ...
        if (\array_key_exists('subMilestone', $data)) {
            $object->setSubMilestone($this->denormalizer->denormalize($data['subMilestone'], 'BesmartandPro\\UpsApi\\Generated\\Model\\SubMilestone', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\Milestones' => false);
    }
}