...
class ManifestPackagePackageServiceOptionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\ManifestPackagePackageServiceOptions';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\ManifestPackagePackageServiceOptions';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\ManifestPackagePackageServiceOptions();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('COD', $data)) {
            $object->setCOD($this->denormalizer->denormalize($data['COD'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ManifestPackageServiceOptionsCOD', 'json', $context));
            unset($data['COD']);
        }
        if (\array_key_exists('InsuredValue', $data)) {
            $object->setInsuredValue($this->denormalizer->denormalize($data['InsuredValue'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PackageServiceOptionsInsuredValue', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\ManifestPackagePackageServiceOptions' => false);
    }
}