...
class PaymentInformationPayerNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\PaymentInformationPayer';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\PaymentInformationPayer';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\PaymentInformationPayer();
        ...
        if (\array_key_exists('Address', $data)) {
            $object->setAddress($this->denormalizer->denormalize($data['Address'], 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightShipPayerAddress', 'json', $context));
            unset($data['Address']);
        }
        ...
        if (\array_key_exists('Phone', $data)) {
            $object->setPhone($this->denormalizer->denormalize($data['Phone'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PayerPhone', 'json', $context));
            unset($data['Phone']);
        }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\PaymentInformationPayer' => false);
    }
}