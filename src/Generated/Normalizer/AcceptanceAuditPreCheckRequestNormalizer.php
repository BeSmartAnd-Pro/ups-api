...
class AcceptanceAuditPreCheckRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\AcceptanceAuditPreCheckRequest';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\AcceptanceAuditPreCheckRequest';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\AcceptanceAuditPreCheckRequest();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('Request', $data)) {
            $object->setRequest($this->denormalizer->denormalize($data['Request'], 'BesmartandPro\\UpsApi\\Generated\\Model\\AcceptanceAuditPreCheckRequestRequest', 'json', $context));
            unset($data['Request']);
        }
        ...
        if (\array_key_exists('Shipment', $data)) {
            $object->setShipment($this->denormalizer->denormalize($data['Shipment'], 'BesmartandPro\\UpsApi\\Generated\\Model\\AcceptanceAuditPreCheckRequestShipment', 'json', $context));
            unset($data['Shipment']);
        }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\AcceptanceAuditPreCheckRequest' => false);
    }
}