...
class PickupCreationRequestShipperNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupCreationRequestShipper';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupCreationRequestShipper';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\PickupCreationRequestShipper();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('Account', $data)) {
            $object->setAccount($this->denormalizer->denormalize($data['Account'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipperAccount', 'json', $context));
            unset($data['Account']);
        }
        if (\array_key_exists('ChargeCard', $data)) {
            $object->setChargeCard($this->denormalizer->denormalize($data['ChargeCard'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipperChargeCard', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\PickupCreationRequestShipper' => false);
    }
}