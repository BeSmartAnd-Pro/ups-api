...
class PackageCommodityNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\PackageCommodity';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\PackageCommodity';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\PackageCommodity();
        ...
        if (\array_key_exists('NMFC', $data)) {
            $object->setNMFC($this->denormalizer->denormalize($data['NMFC'], 'BesmartandPro\\UpsApi\\Generated\\Model\\CommodityNMFC', 'json', $context));
            unset($data['NMFC']);
        }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\PackageCommodity' => false);
    }
}