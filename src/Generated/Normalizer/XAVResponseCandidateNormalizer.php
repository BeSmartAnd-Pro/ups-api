...
class XAVResponseCandidateNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\XAVResponseCandidate';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\XAVResponseCandidate';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\XAVResponseCandidate();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('AddressClassification', $data) && $data['AddressClassification'] !== null) {
            $object->setAddressClassification($this->denormalizer->denormalize($data['AddressClassification'], 'BesmartandPro\\UpsApi\\Generated\\Model\\CandidateAddressClassification', 'json', $context));
        ...
        if (\array_key_exists('AddressKeyFormat', $data)) {
            ...
            foreach ($data['AddressKeyFormat'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\UpsApi\\Generated\\Model\\CandidateAddressKeyFormat', 'json', $context);
            }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\XAVResponseCandidate' => false);
    }
}