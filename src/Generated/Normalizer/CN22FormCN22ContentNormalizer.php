...
class CN22FormCN22ContentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\CN22FormCN22Content';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\CN22FormCN22Content';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\CN22FormCN22Content();
        ...
        if (\array_key_exists('CN22ContentWeight', $data)) {
            $object->setCN22ContentWeight($this->denormalizer->denormalize($data['CN22ContentWeight'], 'BesmartandPro\\UpsApi\\Generated\\Model\\CN22ContentCN22ContentWeight', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\CN22FormCN22Content' => false);
    }
}