...
class SubscriptionEventsSubscriptionFileNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\SubscriptionEventsSubscriptionFile';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\SubscriptionEventsSubscriptionFile';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\SubscriptionEventsSubscriptionFile();
        ...
        if (\array_key_exists('StatusType', $data)) {
            $object->setStatusType($this->denormalizer->denormalize($data['StatusType'], 'BesmartandPro\\UpsApi\\Generated\\Model\\SubscriptionFileStatusType', 'json', $context));
            unset($data['StatusType']);
        }
        if (\array_key_exists('Manifest', $data)) {
            $values = array();
            foreach ($data['Manifest'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\UpsApi\\Generated\\Model\\SubscriptionFileManifest', 'json', $context);
            }
        ...
        if (\array_key_exists('Origin', $data)) {
            ...
            foreach ($data['Origin'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\UpsApi\\Generated\\Model\\SubscriptionFileOrigin', 'json', $context);
            }
        ...
        if (\array_key_exists('Exception', $data)) {
            ...
            foreach ($data['Exception'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'BesmartandPro\\UpsApi\\Generated\\Model\\SubscriptionFileException', 'json', $context);
            }
        ...
        if (\array_key_exists('Delivery', $data)) {
            ...
            foreach ($data['Delivery'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'BesmartandPro\\UpsApi\\Generated\\Model\\SubscriptionFileDelivery', 'json', $context);
            }
        ...
        if (\array_key_exists('Generic', $data)) {
            ...
            foreach ($data['Generic'] as $value_4) {
                $values_4[] = $this->denormalizer->denormalize($value_4, 'BesmartandPro\\UpsApi\\Generated\\Model\\SubscriptionFileGeneric', 'json', $context);
            }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\SubscriptionEventsSubscriptionFile' => false);
    }
}