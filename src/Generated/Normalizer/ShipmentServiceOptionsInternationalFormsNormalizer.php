...
class ShipmentServiceOptionsInternationalFormsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentServiceOptionsInternationalForms';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentServiceOptionsInternationalForms';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\ShipmentServiceOptionsInternationalForms();
        ...
        if (\array_key_exists('UserCreatedForm', $data)) {
            $object->setUserCreatedForm($this->denormalizer->denormalize($data['UserCreatedForm'], 'BesmartandPro\\UpsApi\\Generated\\Model\\InternationalFormsUserCreatedForm', 'json', $context));
            unset($data['UserCreatedForm']);
        }
        if (\array_key_exists('UPSPremiumCareForm', $data)) {
            $object->setUPSPremiumCareForm($this->denormalizer->denormalize($data['UPSPremiumCareForm'], 'BesmartandPro\\UpsApi\\Generated\\Model\\InternationalFormsUPSPremiumCareForm', 'json', $context));
            unset($data['UPSPremiumCareForm']);
        }
        if (\array_key_exists('CN22Form', $data)) {
            $object->setCN22Form($this->denormalizer->denormalize($data['CN22Form'], 'BesmartandPro\\UpsApi\\Generated\\Model\\InternationalFormsCN22Form', 'json', $context));
            unset($data['CN22Form']);
        }
        ...
        if (\array_key_exists('EEIFilingOption', $data)) {
            $object->setEEIFilingOption($this->denormalizer->denormalize($data['EEIFilingOption'], 'BesmartandPro\\UpsApi\\Generated\\Model\\InternationalFormsEEIFilingOption', 'json', $context));
            unset($data['EEIFilingOption']);
        }
        if (\array_key_exists('Contacts', $data)) {
            $object->setContacts($this->denormalizer->denormalize($data['Contacts'], 'BesmartandPro\\UpsApi\\Generated\\Model\\InternationalFormsContacts', 'json', $context));
            unset($data['Contacts']);
        }
        if (\array_key_exists('Product', $data)) {
            $values_1 = array();
            foreach ($data['Product'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\UpsApi\\Generated\\Model\\InternationalFormsProduct', 'json', $context);
            }
        ...
        if (\array_key_exists('Discount', $data)) {
            $object->setDiscount($this->denormalizer->denormalize($data['Discount'], 'BesmartandPro\\UpsApi\\Generated\\Model\\InternationalFormsDiscount', 'json', $context));
            unset($data['Discount']);
        }
        if (\array_key_exists('FreightCharges', $data)) {
            $object->setFreightCharges($this->denormalizer->denormalize($data['FreightCharges'], 'BesmartandPro\\UpsApi\\Generated\\Model\\InternationalFormsFreightCharges', 'json', $context));
            unset($data['FreightCharges']);
        }
        if (\array_key_exists('InsuranceCharges', $data)) {
            $object->setInsuranceCharges($this->denormalizer->denormalize($data['InsuranceCharges'], 'BesmartandPro\\UpsApi\\Generated\\Model\\InternationalFormsInsuranceCharges', 'json', $context));
            unset($data['InsuranceCharges']);
        }
        if (\array_key_exists('OtherCharges', $data)) {
            $object->setOtherCharges($this->denormalizer->denormalize($data['OtherCharges'], 'BesmartandPro\\UpsApi\\Generated\\Model\\InternationalFormsOtherCharges', 'json', $context));
        ...
        if (\array_key_exists('BlanketPeriod', $data)) {
            $object->setBlanketPeriod($this->denormalizer->denormalize($data['BlanketPeriod'], 'BesmartandPro\\UpsApi\\Generated\\Model\\InternationalFormsBlanketPeriod', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentServiceOptionsInternationalForms' => false);
    }
}