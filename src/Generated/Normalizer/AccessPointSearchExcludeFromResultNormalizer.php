...
class AccessPointSearchExcludeFromResultNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\AccessPointSearchExcludeFromResult';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\AccessPointSearchExcludeFromResult';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\AccessPointSearchExcludeFromResult();
        ...
        if (\array_key_exists('PostalCodeList', $data)) {
            $object->setPostalCodeList($this->denormalizer->denormalize($data['PostalCodeList'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ExcludeFromResultPostalCodeList', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\AccessPointSearchExcludeFromResult' => false);
    }
}