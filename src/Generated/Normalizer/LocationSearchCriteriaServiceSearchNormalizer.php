...
class LocationSearchCriteriaServiceSearchNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\LocationSearchCriteriaServiceSearch';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\LocationSearchCriteriaServiceSearch';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\LocationSearchCriteriaServiceSearch();
        ...
        if (\array_key_exists('ServiceCode', $data)) {
            ...
            foreach ($data['ServiceCode'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\UpsApi\\Generated\\Model\\ServiceSearchServiceCode', 'json', $context);
            }
        ...
        if (\array_key_exists('ServiceOptionCode', $data)) {
            ...
            foreach ($data['ServiceOptionCode'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\UpsApi\\Generated\\Model\\ServiceSearchServiceOptionCode', 'json', $context);
            }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\LocationSearchCriteriaServiceSearch' => false);
    }
}