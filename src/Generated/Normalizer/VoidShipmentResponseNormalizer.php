...
class VoidShipmentResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\VoidShipmentResponse';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\VoidShipmentResponse';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\VoidShipmentResponse();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('Response', $data)) {
            $object->setResponse($this->denormalizer->denormalize($data['Response'], 'BesmartandPro\\UpsApi\\Generated\\Model\\VoidShipmentResponseResponse', 'json', $context));
            unset($data['Response']);
        }
        if (\array_key_exists('SummaryResult', $data)) {
            $object->setSummaryResult($this->denormalizer->denormalize($data['SummaryResult'], 'BesmartandPro\\UpsApi\\Generated\\Model\\VoidShipmentResponseSummaryResult', 'json', $context));
            unset($data['SummaryResult']);
        }
        if (\array_key_exists('PackageLevelResult', $data)) {
            $values = array();
            foreach ($data['PackageLevelResult'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\UpsApi\\Generated\\Model\\VoidShipmentResponsePackageLevelResult', 'json', $context);
            }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\VoidShipmentResponse' => false);
    }
}