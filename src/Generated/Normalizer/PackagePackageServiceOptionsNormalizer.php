...
class PackagePackageServiceOptionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\PackagePackageServiceOptions';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\PackagePackageServiceOptions';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\PackagePackageServiceOptions();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('DeliveryConfirmation', $data)) {
            $object->setDeliveryConfirmation($this->denormalizer->denormalize($data['DeliveryConfirmation'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PackageServiceOptionsDeliveryConfirmation', 'json', $context));
            unset($data['DeliveryConfirmation']);
        }
        if (\array_key_exists('DeclaredValue', $data)) {
            $object->setDeclaredValue($this->denormalizer->denormalize($data['DeclaredValue'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PackageServiceOptionsDeclaredValue', 'json', $context));
        ...
        if (\array_key_exists('Notification', $data)) {
            $object->setNotification($this->denormalizer->denormalize($data['Notification'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PackageServiceOptionsNotification', 'json', $context));
            unset($data['Notification']);
        }
        if (\array_key_exists('HazMat', $data)) {
            $values = array();
            foreach ($data['HazMat'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\UpsApi\\Generated\\Model\\PackageServiceOptionsHazMat', 'json', $context);
            }
            $object->setHazMat($values);
            unset($data['HazMat']);
        }
        if (\array_key_exists('DryIce', $data)) {
            $object->setDryIce($this->denormalizer->denormalize($data['DryIce'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PackageServiceOptionsDryIce', 'json', $context));
            unset($data['DryIce']);
        }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\PackagePackageServiceOptions' => false);
    }
}