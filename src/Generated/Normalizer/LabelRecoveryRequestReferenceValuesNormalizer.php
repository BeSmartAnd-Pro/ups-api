...
class LabelRecoveryRequestReferenceValuesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\LabelRecoveryRequestReferenceValues';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\LabelRecoveryRequestReferenceValues';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\LabelRecoveryRequestReferenceValues();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('ReferenceNumber', $data)) {
            $object->setReferenceNumber($this->denormalizer->denormalize($data['ReferenceNumber'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ReferenceValuesReferenceNumber', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\LabelRecoveryRequestReferenceValues' => false);
    }
}