...
class ShipmentRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentRequest';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentRequest';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\ShipmentRequest();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('Request', $data)) {
            $object->setRequest($this->denormalizer->denormalize($data['Request'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentRequestRequest', 'json', $context));
            unset($data['Request']);
        }
        if (\array_key_exists('Shipment', $data)) {
            $object->setShipment($this->denormalizer->denormalize($data['Shipment'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentRequestShipment', 'json', $context));
            unset($data['Shipment']);
        }
        if (\array_key_exists('LabelSpecification', $data)) {
            $object->setLabelSpecification($this->denormalizer->denormalize($data['LabelSpecification'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentRequestLabelSpecification', 'json', $context));
            unset($data['LabelSpecification']);
        }
        if (\array_key_exists('ReceiptSpecification', $data)) {
            $object->setReceiptSpecification($this->denormalizer->denormalize($data['ReceiptSpecification'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentRequestReceiptSpecification', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentRequest' => false);
    }
}