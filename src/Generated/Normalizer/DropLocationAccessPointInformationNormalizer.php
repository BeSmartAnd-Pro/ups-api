...
class DropLocationAccessPointInformationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\DropLocationAccessPointInformation';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\DropLocationAccessPointInformation';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\DropLocationAccessPointInformation();
        ...
        if (\array_key_exists('BusinessClassificationList', $data)) {
            $object->setBusinessClassificationList($this->denormalizer->denormalize($data['BusinessClassificationList'], 'BesmartandPro\\UpsApi\\Generated\\Model\\AccessPointInformationBusinessClassificationList', 'json', $context));
            unset($data['BusinessClassificationList']);
        }
        if (\array_key_exists('AccessPointStatus', $data)) {
            $object->setAccessPointStatus($this->denormalizer->denormalize($data['AccessPointStatus'], 'BesmartandPro\\UpsApi\\Generated\\Model\\AccessPointInformationAccessPointStatus', 'json', $context));
        ...
        if (\array_key_exists('PrivateNetworkList', $data)) {
            $object->setPrivateNetworkList($this->denormalizer->denormalize($data['PrivateNetworkList'], 'BesmartandPro\\UpsApi\\Generated\\Model\\AccessPointInformationPrivateNetworkList', 'json', $context));
            unset($data['PrivateNetworkList']);
        }
        if (\array_key_exists('Availability', $data)) {
            $object->setAvailability($this->denormalizer->denormalize($data['Availability'], 'BesmartandPro\\UpsApi\\Generated\\Model\\AccessPointInformationAvailability', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\DropLocationAccessPointInformation' => false);
    }
}