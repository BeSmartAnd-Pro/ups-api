...
class ProductEEIInformationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\ProductEEIInformation';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\ProductEEIInformation';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\ProductEEIInformation();
        ...
        if (\array_key_exists('License', $data)) {
            $object->setLicense($this->denormalizer->denormalize($data['License'], 'BesmartandPro\\UpsApi\\Generated\\Model\\EEIInformationLicense', 'json', $context));
            unset($data['License']);
        }
        if (\array_key_exists('DDTCInformation', $data)) {
            $object->setDDTCInformation($this->denormalizer->denormalize($data['DDTCInformation'], 'BesmartandPro\\UpsApi\\Generated\\Model\\EEIInformationDDTCInformation', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\ProductEEIInformation' => false);
    }
}