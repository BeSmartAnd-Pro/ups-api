...
class FreightPickupRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightPickupRequest';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightPickupRequest';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\FreightPickupRequest();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('Request', $data)) {
            $object->setRequest($this->denormalizer->denormalize($data['Request'], 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightPickupRequestRequest', 'json', $context));
            unset($data['Request']);
        }
        ...
        if (\array_key_exists('Requester', $data)) {
            $object->setRequester($this->denormalizer->denormalize($data['Requester'], 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightPickupRequestRequester', 'json', $context));
            unset($data['Requester']);
        }
        if (\array_key_exists('ShipFrom', $data)) {
            $object->setShipFrom($this->denormalizer->denormalize($data['ShipFrom'], 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightPickupRequestShipFrom', 'json', $context));
            unset($data['ShipFrom']);
        }
        if (\array_key_exists('ShipTo', $data)) {
            $object->setShipTo($this->denormalizer->denormalize($data['ShipTo'], 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightPickupRequestShipTo', 'json', $context));
            unset($data['ShipTo']);
        }
        ...
        if (\array_key_exists('ShipmentServiceOptions', $data)) {
            $object->setShipmentServiceOptions($this->denormalizer->denormalize($data['ShipmentServiceOptions'], 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightPickupRequestShipmentServiceOptions', 'json', $context));
            unset($data['ShipmentServiceOptions']);
        }
        if (\array_key_exists('ShipmentDetail', $data)) {
            $values = array();
            foreach ($data['ShipmentDetail'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightPickupRequestShipmentDetail', 'json', $context);
            }
            $object->setShipmentDetail($values);
            unset($data['ShipmentDetail']);
        }
        if (\array_key_exists('ExistingShipmentID', $data)) {
            $object->setExistingShipmentID($this->denormalizer->denormalize($data['ExistingShipmentID'], 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightPickupRequestExistingShipmentID', 'json', $context));
            unset($data['ExistingShipmentID']);
        }
        if (\array_key_exists('POM', $data)) {
            $object->setPOM($this->denormalizer->denormalize($data['POM'], 'BesmartandPro\\UpsApi\\Generated\\Model\\FreightPickupRequestPOM', 'json', $context));
            unset($data['POM']);
        }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\FreightPickupRequest' => false);
    }
}