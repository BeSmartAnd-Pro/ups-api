...
class ServiceCenterLocationPickupFacilitiesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\ServiceCenterLocationPickupFacilities';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\ServiceCenterLocationPickupFacilities';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\ServiceCenterLocationPickupFacilities();
        ...
        if (\array_key_exists('Address', $data)) {
            $object->setAddress($this->denormalizer->denormalize($data['Address'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupFacilitiesAddress', 'json', $context));
            unset($data['Address']);
        }
        ...
        if (\array_key_exists('FacilityTime', $data)) {
            $object->setFacilityTime($this->denormalizer->denormalize($data['FacilityTime'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PickupFacilitiesFacilityTime', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\ServiceCenterLocationPickupFacilities' => false);
    }
}