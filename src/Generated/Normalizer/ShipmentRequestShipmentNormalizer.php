...
class ShipmentRequestShipmentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentRequestShipment';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentRequestShipment';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\ShipmentRequestShipment();
        ...
        if (\array_key_exists('ReturnService', $data)) {
            $object->setReturnService($this->denormalizer->denormalize($data['ReturnService'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentReturnService', 'json', $context));
        ...
        if (\array_key_exists('Shipper', $data)) {
            $object->setShipper($this->denormalizer->denormalize($data['Shipper'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentShipper', 'json', $context));
            unset($data['Shipper']);
        }
        if (\array_key_exists('ShipTo', $data)) {
            $object->setShipTo($this->denormalizer->denormalize($data['ShipTo'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentShipTo', 'json', $context));
            unset($data['ShipTo']);
        }
        if (\array_key_exists('AlternateDeliveryAddress', $data)) {
            $object->setAlternateDeliveryAddress($this->denormalizer->denormalize($data['AlternateDeliveryAddress'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentAlternateDeliveryAddress', 'json', $context));
            unset($data['AlternateDeliveryAddress']);
        }
        if (\array_key_exists('ShipFrom', $data)) {
            $object->setShipFrom($this->denormalizer->denormalize($data['ShipFrom'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentShipFrom', 'json', $context));
            unset($data['ShipFrom']);
        }
        if (\array_key_exists('PaymentInformation', $data)) {
            $object->setPaymentInformation($this->denormalizer->denormalize($data['PaymentInformation'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentPaymentInformation', 'json', $context));
            unset($data['PaymentInformation']);
        }
        if (\array_key_exists('FRSPaymentInformation', $data)) {
            $object->setFRSPaymentInformation($this->denormalizer->denormalize($data['FRSPaymentInformation'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentFRSPaymentInformation', 'json', $context));
            unset($data['FRSPaymentInformation']);
        }
        if (\array_key_exists('FreightShipmentInformation', $data)) {
            $object->setFreightShipmentInformation($this->denormalizer->denormalize($data['FreightShipmentInformation'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentFreightShipmentInformation', 'json', $context));
        ...
        if (\array_key_exists('PromotionalDiscountInformation', $data)) {
            $object->setPromotionalDiscountInformation($this->denormalizer->denormalize($data['PromotionalDiscountInformation'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentPromotionalDiscountInformation', 'json', $context));
            unset($data['PromotionalDiscountInformation']);
        }
        if (\array_key_exists('DGSignatoryInfo', $data)) {
            $object->setDGSignatoryInfo($this->denormalizer->denormalize($data['DGSignatoryInfo'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentDGSignatoryInfo', 'json', $context));
            unset($data['DGSignatoryInfo']);
        }
        if (\array_key_exists('ShipmentRatingOptions', $data)) {
            $object->setShipmentRatingOptions($this->denormalizer->denormalize($data['ShipmentRatingOptions'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentShipmentRatingOptions', 'json', $context));
        ...
        if (\array_key_exists('ReferenceNumber', $data)) {
            ...
            foreach ($data['ReferenceNumber'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentReferenceNumber', 'json', $context);
            }
            $object->setReferenceNumber($values);
            unset($data['ReferenceNumber']);
        }
        if (\array_key_exists('Service', $data)) {
            $object->setService($this->denormalizer->denormalize($data['Service'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentService', 'json', $context));
            unset($data['Service']);
        }
        if (\array_key_exists('InvoiceLineTotal', $data)) {
            $object->setInvoiceLineTotal($this->denormalizer->denormalize($data['InvoiceLineTotal'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentInvoiceLineTotal', 'json', $context));
        ...
        if (\array_key_exists('ShipmentIndicationType', $data)) {
            ...
            foreach ($data['ShipmentIndicationType'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentShipmentIndicationType', 'json', $context);
            }
        ...
        if (\array_key_exists('ShipmentServiceOptions', $data)) {
            $object->setShipmentServiceOptions($this->denormalizer->denormalize($data['ShipmentServiceOptions'], 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentShipmentServiceOptions', 'json', $context));
        ...
        if (\array_key_exists('Package', $data)) {
            ...
            foreach ($data['Package'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentPackage', 'json', $context);
            }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentRequestShipment' => false);
    }
}