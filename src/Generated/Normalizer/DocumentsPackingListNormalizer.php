...
class DocumentsPackingListNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\DocumentsPackingList';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\DocumentsPackingList';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\DocumentsPackingList();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('ShipFrom', $data)) {
            $object->setShipFrom($this->denormalizer->denormalize($data['ShipFrom'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PackingListShipFrom', 'json', $context));
            unset($data['ShipFrom']);
        }
        if (\array_key_exists('ShipTo', $data)) {
            $object->setShipTo($this->denormalizer->denormalize($data['ShipTo'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PackingListShipTo', 'json', $context));
            unset($data['ShipTo']);
        }
        if (\array_key_exists('Reference', $data)) {
            $values = array();
            foreach ($data['Reference'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\UpsApi\\Generated\\Model\\PackingListReference', 'json', $context);
            }
            $object->setReference($values);
            unset($data['Reference']);
        }
        if (\array_key_exists('HandlingUnit', $data)) {
            $object->setHandlingUnit($this->denormalizer->denormalize($data['HandlingUnit'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PackingListHandlingUnit', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\DocumentsPackingList' => false);
    }
}