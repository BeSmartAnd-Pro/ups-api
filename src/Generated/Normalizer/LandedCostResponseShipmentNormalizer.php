...
class LandedCostResponseShipmentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\LandedCostResponseShipment';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\LandedCostResponseShipment';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\LandedCostResponseShipment();
        ...
        if (\array_key_exists('brokerageFeeItems', $data)) {
            ...
            foreach ($data['brokerageFeeItems'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\UpsApi\\Generated\\Model\\BrokerageFeeItems', 'json', $context);
            }
        ...
        if (\array_key_exists('shipmentItems', $data)) {
            ...
            foreach ($data['shipmentItems'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\UpsApi\\Generated\\Model\\ResponseShipmentItems', 'json', $context);
            }
        ...
        if (\array_key_exists('perfStats', $data)) {
            $object->setPerfStats($this->denormalizer->denormalize($data['perfStats'], 'BesmartandPro\\UpsApi\\Generated\\Model\\LandedCostResponseShipmentPerfStats', 'json', $context));
        ...
        if (\array_key_exists('errors', $data)) {
            $object->setErrors($this->denormalizer->denormalize($data['errors'], 'BesmartandPro\\UpsApi\\Generated\\Model\\Errors', 'json', $context));
            unset($data['errors']);
        }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\LandedCostResponseShipment' => false);
    }
}