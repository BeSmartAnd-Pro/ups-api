...
class ServiceCenterLocationDropOffFacilitiesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\ServiceCenterLocationDropOffFacilities';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\ServiceCenterLocationDropOffFacilities';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\ServiceCenterLocationDropOffFacilities();
        ...
        if (\array_key_exists('Address', $data)) {
            $object->setAddress($this->denormalizer->denormalize($data['Address'], 'BesmartandPro\\UpsApi\\Generated\\Model\\DropOffFacilitiesAddress', 'json', $context));
            unset($data['Address']);
        }
        ...
        if (\array_key_exists('FacilityTime', $data)) {
            $object->setFacilityTime($this->denormalizer->denormalize($data['FacilityTime'], 'BesmartandPro\\UpsApi\\Generated\\Model\\DropOffFacilitiesFacilityTime', 'json', $context));
        ...
        if (\array_key_exists('LocalizedInstruction', $data)) {
            ...
            foreach ($data['LocalizedInstruction'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\UpsApi\\Generated\\Model\\DropOffFacilitiesLocalizedInstruction', 'json', $context);
            }
            $object->setLocalizedInstruction($values);
            unset($data['LocalizedInstruction']);
        }
        if (\array_key_exists('Distance', $data)) {
            $object->setDistance($this->denormalizer->denormalize($data['Distance'], 'BesmartandPro\\UpsApi\\Generated\\Model\\DropOffFacilitiesDistance', 'json', $context));
            unset($data['Distance']);
        }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\ServiceCenterLocationDropOffFacilities' => false);
    }
}