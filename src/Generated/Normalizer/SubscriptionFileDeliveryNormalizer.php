...
class SubscriptionFileDeliveryNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\SubscriptionFileDelivery';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\SubscriptionFileDelivery';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\SubscriptionFileDelivery();
        ...
        if (\array_key_exists('PackageReferenceNumber', $data)) {
            ...
            foreach ($data['PackageReferenceNumber'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\UpsApi\\Generated\\Model\\DeliveryPackageReferenceNumber', 'json', $context);
            }
        ...
        if (\array_key_exists('ShipmentReferenceNumber', $data)) {
            ...
            foreach ($data['ShipmentReferenceNumber'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\UpsApi\\Generated\\Model\\DeliveryShipmentReferenceNumber', 'json', $context);
            }
        ...
        if (\array_key_exists('ActivityLocation', $data)) {
            $object->setActivityLocation($this->denormalizer->denormalize($data['ActivityLocation'], 'BesmartandPro\\UpsApi\\Generated\\Model\\DeliveryActivityLocation', 'json', $context));
            unset($data['ActivityLocation']);
        }
        if (\array_key_exists('DeliveryLocation', $data)) {
            $object->setDeliveryLocation($this->denormalizer->denormalize($data['DeliveryLocation'], 'BesmartandPro\\UpsApi\\Generated\\Model\\DeliveryDeliveryLocation', 'json', $context));
            unset($data['DeliveryLocation']);
        }
        if (\array_key_exists('COD', $data)) {
            $object->setCOD($this->denormalizer->denormalize($data['COD'], 'BesmartandPro\\UpsApi\\Generated\\Model\\DeliveryCOD', 'json', $context));
            unset($data['COD']);
        }
        if (\array_key_exists('BillToAccount', $data)) {
            $object->setBillToAccount($this->denormalizer->denormalize($data['BillToAccount'], 'BesmartandPro\\UpsApi\\Generated\\Model\\DeliveryBillToAccount', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\SubscriptionFileDelivery' => false);
    }
}