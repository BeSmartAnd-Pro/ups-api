...
class AcceptanceAuditPreCheckRequestShipmentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\AcceptanceAuditPreCheckRequestShipment';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\AcceptanceAuditPreCheckRequestShipment';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\AcceptanceAuditPreCheckRequestShipment();
        ...
        if (\array_key_exists('ShipFromAddress', $data)) {
            $object->setShipFromAddress($this->denormalizer->denormalize($data['ShipFromAddress'], 'BesmartandPro\\UpsApi\\Generated\\Model\\AcceptanceAuditPreCheckShipmentShipFromAddress', 'json', $context));
            unset($data['ShipFromAddress']);
        }
        if (\array_key_exists('ShipToAddress', $data)) {
            $object->setShipToAddress($this->denormalizer->denormalize($data['ShipToAddress'], 'BesmartandPro\\UpsApi\\Generated\\Model\\AcceptanceAuditPreCheckShipmentShipToAddress', 'json', $context));
        ...
        if (\array_key_exists('Package', $data)) {
            ...
            foreach ($data['Package'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\UpsApi\\Generated\\Model\\AcceptanceAuditPreCheckShipmentPackage', 'json', $context);
            }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\AcceptanceAuditPreCheckRequestShipment' => false);
    }
}