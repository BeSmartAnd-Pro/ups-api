...
class PreNotificationRequestShipmentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\PreNotificationRequestShipment';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\PreNotificationRequestShipment';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\PreNotificationRequestShipment();
        ...
        if (\array_key_exists('ShipToAddress', $data)) {
            $object->setShipToAddress($this->denormalizer->denormalize($data['ShipToAddress'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PreNotificationShipmentShipToAddress', 'json', $context));
            unset($data['ShipToAddress']);
        }
        if (\array_key_exists('ShipFromAddress', $data)) {
            $object->setShipFromAddress($this->denormalizer->denormalize($data['ShipFromAddress'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PreNotificationShipmentShipFromAddress', 'json', $context));
        ...
        if (\array_key_exists('Package', $data)) {
            ...
            foreach ($data['Package'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\UpsApi\\Generated\\Model\\PreNotificationShipmentPackage', 'json', $context);
            }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\PreNotificationRequestShipment' => false);
    }
}