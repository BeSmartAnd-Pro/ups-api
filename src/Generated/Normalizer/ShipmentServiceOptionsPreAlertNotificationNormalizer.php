...
class ShipmentServiceOptionsPreAlertNotificationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentServiceOptionsPreAlertNotification';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentServiceOptionsPreAlertNotification';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\ShipmentServiceOptionsPreAlertNotification();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('EMailMessage', $data)) {
            $object->setEMailMessage($this->denormalizer->denormalize($data['EMailMessage'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PreAlertNotificationEMailMessage', 'json', $context));
            unset($data['EMailMessage']);
        }
        if (\array_key_exists('VoiceMessage', $data)) {
            $object->setVoiceMessage($this->denormalizer->denormalize($data['VoiceMessage'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PreAlertNotificationVoiceMessage', 'json', $context));
            unset($data['VoiceMessage']);
        }
        if (\array_key_exists('TextMessage', $data)) {
            $object->setTextMessage($this->denormalizer->denormalize($data['TextMessage'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PreAlertNotificationTextMessage', 'json', $context));
            unset($data['TextMessage']);
        }
        if (\array_key_exists('Locale', $data)) {
            $object->setLocale($this->denormalizer->denormalize($data['Locale'], 'BesmartandPro\\UpsApi\\Generated\\Model\\PreAlertNotificationLocale', 'json', $context));
            unset($data['Locale']);
        }
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\ShipmentServiceOptionsPreAlertNotification' => false);
    }
}