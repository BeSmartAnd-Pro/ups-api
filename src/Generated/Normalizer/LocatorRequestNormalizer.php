...
class LocatorRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\LocatorRequest';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\LocatorRequest';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\LocatorRequest();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('Request', $data)) {
            $object->setRequest($this->denormalizer->denormalize($data['Request'], 'BesmartandPro\\UpsApi\\Generated\\Model\\LocatorRequestRequest', 'json', $context));
            unset($data['Request']);
        }
        if (\array_key_exists('OriginAddress', $data)) {
            $object->setOriginAddress($this->denormalizer->denormalize($data['OriginAddress'], 'BesmartandPro\\UpsApi\\Generated\\Model\\LocatorRequestOriginAddress', 'json', $context));
            unset($data['OriginAddress']);
        }
        if (\array_key_exists('Translate', $data)) {
            $object->setTranslate($this->denormalizer->denormalize($data['Translate'], 'BesmartandPro\\UpsApi\\Generated\\Model\\LocatorRequestTranslate', 'json', $context));
            unset($data['Translate']);
        }
        if (\array_key_exists('UnitOfMeasurement', $data)) {
            $object->setUnitOfMeasurement($this->denormalizer->denormalize($data['UnitOfMeasurement'], 'BesmartandPro\\UpsApi\\Generated\\Model\\LocatorRequestUnitOfMeasurement', 'json', $context));
        ...
        if (\array_key_exists('LocationSearchCriteria', $data)) {
            $object->setLocationSearchCriteria($this->denormalizer->denormalize($data['LocationSearchCriteria'], 'BesmartandPro\\UpsApi\\Generated\\Model\\LocatorRequestLocationSearchCriteria', 'json', $context));
            unset($data['LocationSearchCriteria']);
        }
        if (\array_key_exists('SortCriteria', $data)) {
            $object->setSortCriteria($this->denormalizer->denormalize($data['SortCriteria'], 'BesmartandPro\\UpsApi\\Generated\\Model\\LocatorRequestSortCriteria', 'json', $context));
        ...
        if (\array_key_exists('ServiceGeoUnit', $data)) {
            $object->setServiceGeoUnit($this->denormalizer->denormalize($data['ServiceGeoUnit'], 'BesmartandPro\\UpsApi\\Generated\\Model\\LocatorRequestServiceGeoUnit', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\LocatorRequest' => false);
    }
}