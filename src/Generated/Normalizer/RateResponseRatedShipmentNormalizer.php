...
class RateResponseRatedShipmentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BesmartandPro\\UpsApi\\Generated\\Model\\RateResponseRatedShipment';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'BesmartandPro\\UpsApi\\Generated\\Model\\RateResponseRatedShipment';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BesmartandPro\UpsApi\Generated\Model\RateResponseRatedShipment();
        ...
        if (\array_key_exists('Disclaimer', $data)) {
            ...
            foreach ($data['Disclaimer'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\UpsApi\\Generated\\Model\\RatedShipmentDisclaimer', 'json', $context);
            }
            $object->setDisclaimer($values);
            unset($data['Disclaimer']);
        }
        if (\array_key_exists('Service', $data)) {
            $object->setService($this->denormalizer->denormalize($data['Service'], 'BesmartandPro\\UpsApi\\Generated\\Model\\RatedShipmentService', 'json', $context));
            unset($data['Service']);
        }
        ...
        if (\array_key_exists('RatedShipmentAlert', $data)) {
            ...
            foreach ($data['RatedShipmentAlert'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\UpsApi\\Generated\\Model\\RatedShipmentRatedShipmentAlert', 'json', $context);
            }
        ...
        if (\array_key_exists('BillingWeight', $data)) {
            $object->setBillingWeight($this->denormalizer->denormalize($data['BillingWeight'], 'BesmartandPro\\UpsApi\\Generated\\Model\\RatedShipmentBillingWeight', 'json', $context));
            unset($data['BillingWeight']);
        }
        if (\array_key_exists('TransportationCharges', $data)) {
            $object->setTransportationCharges($this->denormalizer->denormalize($data['TransportationCharges'], 'BesmartandPro\\UpsApi\\Generated\\Model\\RatedShipmentTransportationCharges', 'json', $context));
            unset($data['TransportationCharges']);
        }
        if (\array_key_exists('BaseServiceCharge', $data)) {
            $object->setBaseServiceCharge($this->denormalizer->denormalize($data['BaseServiceCharge'], 'BesmartandPro\\UpsApi\\Generated\\Model\\RatedShipmentBaseServiceCharge', 'json', $context));
            unset($data['BaseServiceCharge']);
        }
        if (\array_key_exists('ItemizedCharges', $data)) {
            $values_2 = array();
            foreach ($data['ItemizedCharges'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'BesmartandPro\\UpsApi\\Generated\\Model\\RatedShipmentItemizedCharges', 'json', $context);
            }
            $object->setItemizedCharges($values_2);
            unset($data['ItemizedCharges']);
        }
        if (\array_key_exists('FRSShipmentData', $data)) {
            $object->setFRSShipmentData($this->denormalizer->denormalize($data['FRSShipmentData'], 'BesmartandPro\\UpsApi\\Generated\\Model\\RatedShipmentFRSShipmentData', 'json', $context));
            unset($data['FRSShipmentData']);
        }
        if (\array_key_exists('ServiceOptionsCharges', $data)) {
            $object->setServiceOptionsCharges($this->denormalizer->denormalize($data['ServiceOptionsCharges'], 'BesmartandPro\\UpsApi\\Generated\\Model\\RatedShipmentServiceOptionsCharges', 'json', $context));
            unset($data['ServiceOptionsCharges']);
        }
        if (\array_key_exists('TaxCharges', $data)) {
            $values_3 = array();
            foreach ($data['TaxCharges'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'BesmartandPro\\UpsApi\\Generated\\Model\\RatedShipmentTaxCharges', 'json', $context);
            }
            $object->setTaxCharges($values_3);
            unset($data['TaxCharges']);
        }
        if (\array_key_exists('TotalCharges', $data)) {
            $object->setTotalCharges($this->denormalizer->denormalize($data['TotalCharges'], 'BesmartandPro\\UpsApi\\Generated\\Model\\RatedShipmentTotalCharges', 'json', $context));
            unset($data['TotalCharges']);
        }
        if (\array_key_exists('TotalChargesWithTaxes', $data)) {
            $object->setTotalChargesWithTaxes($this->denormalizer->denormalize($data['TotalChargesWithTaxes'], 'BesmartandPro\\UpsApi\\Generated\\Model\\RatedShipmentTotalChargesWithTaxes', 'json', $context));
            unset($data['TotalChargesWithTaxes']);
        }
        if (\array_key_exists('NegotiatedRateCharges', $data)) {
            $object->setNegotiatedRateCharges($this->denormalizer->denormalize($data['NegotiatedRateCharges'], 'BesmartandPro\\UpsApi\\Generated\\Model\\RatedShipmentNegotiatedRateCharges', 'json', $context));
            unset($data['NegotiatedRateCharges']);
        }
        if (\array_key_exists('RatedPackage', $data)) {
            $values_4 = array();
            foreach ($data['RatedPackage'] as $value_4) {
                $values_4[] = $this->denormalizer->denormalize($value_4, 'BesmartandPro\\UpsApi\\Generated\\Model\\RatedShipmentRatedPackage', 'json', $context);
            }
            $object->setRatedPackage($values_4);
            unset($data['RatedPackage']);
        }
        if (\array_key_exists('TimeInTransit', $data)) {
            $object->setTimeInTransit($this->denormalizer->denormalize($data['TimeInTransit'], 'BesmartandPro\\UpsApi\\Generated\\Model\\RatedShipmentTimeInTransit', 'json', $context));
    ...
    {
        return array('BesmartandPro\\UpsApi\\Generated\\Model\\RateResponseRatedShipment' => false);
    }
}