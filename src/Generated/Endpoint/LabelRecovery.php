...
class LabelRecovery extends \BesmartandPro\UpsApi\Generated\Runtime\Client\BaseEndpoint implements \BesmartandPro\UpsApi\Generated\Runtime\Client\Endpoint
{
    protected $version;
    /**
    ...
    * }
    */
    public function __construct(string $version = 'v1', \BesmartandPro\UpsApi\Generated\Model\LABELRECOVERYRequestWrapper $requestBody, array $headerParameters = array())
    {
    ...
    {
        if ($this->body instanceof \BesmartandPro\UpsApi\Generated\Model\LABELRECOVERYRequestWrapper) {
     ...
     *
     * @return \BesmartandPro\UpsApi\Generated\Model\LABELRECOVERYResponseWrapper
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (is_null($contentType) === false && (200 === $status && mb_strpos($contentType, 'application/json') !== false)) {
            return $serializer->deserialize($body, 'BesmartandPro\\UpsApi\\Generated\\Model\\LABELRECOVERYResponseWrapper', 'json');
        }
        if (401 === $status) {
            throw new \BesmartandPro\UpsApi\Generated\Exception\LabelRecoveryUnauthorizedException($response);
        }
