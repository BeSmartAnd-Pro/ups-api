...
class FreightShip extends \BesmartandPro\UpsApi\Generated\Runtime\Client\BaseEndpoint implements \BesmartandPro\UpsApi\Generated\Runtime\Client\Endpoint
{
    protected $version;
    protected $reqoption;
    /**
    ...
    * }
    */
    public function __construct(string $version = 'v1', string $reqoption, \BesmartandPro\UpsApi\Generated\Model\FREIGHTSHIPRequestWrapper $requestBody, array $headerParameters = array())
    {
    ...
    {
        if ($this->body instanceof \BesmartandPro\UpsApi\Generated\Model\FREIGHTSHIPRequestWrapper) {
     ...
     *
     * @return \BesmartandPro\UpsApi\Generated\Model\FREIGHTSHIPResponseWrapper
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (is_null($contentType) === false && (200 === $status && mb_strpos($contentType, 'application/json') !== false)) {
            return $serializer->deserialize($body, 'BesmartandPro\\UpsApi\\Generated\\Model\\FREIGHTSHIPResponseWrapper', 'json');
        }
        if (401 === $status) {
            throw new \BesmartandPro\UpsApi\Generated\Exception\FreightShipUnauthorizedException($response);
        }
