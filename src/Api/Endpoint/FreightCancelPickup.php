...
class FreightCancelPickup extends \BesmartandPro\Ups\Api\Runtime\Client\BaseEndpoint implements \BesmartandPro\Ups\Api\Runtime\Client\Endpoint
{
    protected $version;
    /**
     ...
     *
     * @return \BesmartandPro\Ups\Api\Model\FREIGHTPICKUPCANCELResponseWrapper
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (is_null($contentType) === false && (200 === $status && mb_strpos($contentType, 'application/json') !== false)) {
            return $serializer->deserialize($body, 'BesmartandPro\\Ups\\Api\\Model\\FREIGHTPICKUPCANCELResponseWrapper', 'json');
        }
        if (401 === $status) {
            throw new \BesmartandPro\Ups\Api\Exception\FreightCancelPickupUnauthorizedException($response);
        }
