...
class FreightRate extends \BesmartandPro\Ups\Api\Runtime\Client\BaseEndpoint implements \BesmartandPro\Ups\Api\Runtime\Client\Endpoint
{
    protected $version;
    ...
    */
    public function __construct(string $version, string $requestoption, \BesmartandPro\Ups\Api\Model\FREIGHTRATERequestWrapper $requestBody, array $headerParameters = [], array $accept = [])
    {
    ...
    {
        if ($this->body instanceof \BesmartandPro\Ups\Api\Model\FREIGHTRATERequestWrapper) {
     ...
     *
     * @return \BesmartandPro\Ups\Api\Model\FREIGHTRATEResponseWrapper
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (is_null($contentType) === false && (200 === $status && mb_strpos($contentType, 'application/json') !== false)) {
            return $serializer->deserialize($body, 'BesmartandPro\\Ups\\Api\\Model\\FREIGHTRATEResponseWrapper', 'json');
        }
        if (401 === $status) {
            throw new \BesmartandPro\Ups\Api\Exception\FreightRateUnauthorizedException($response);
        }
