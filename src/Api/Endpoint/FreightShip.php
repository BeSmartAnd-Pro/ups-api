...
class FreightShip extends \BesmartandPro\Ups\Api\Runtime\Client\BaseEndpoint implements \BesmartandPro\Ups\Api\Runtime\Client\Endpoint
{
    protected $version;
    protected $reqoption;
    /**
    ...
    * }
    */
    public function __construct(string $version, string $reqoption, \BesmartandPro\Ups\Api\Model\FREIGHTSHIPRequestWrapper $requestBody, array $headerParameters = [])
    {
    ...
    {
        if ($this->body instanceof \BesmartandPro\Ups\Api\Model\FREIGHTSHIPRequestWrapper) {
     ...
     *
     * @return \BesmartandPro\Ups\Api\Model\FREIGHTSHIPResponseWrapper
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (is_null($contentType) === false && (200 === $status && mb_strpos($contentType, 'application/json') !== false)) {
            return $serializer->deserialize($body, 'BesmartandPro\\Ups\\Api\\Model\\FREIGHTSHIPResponseWrapper', 'json');
        }
        if (401 === $status) {
            throw new \BesmartandPro\Ups\Api\Exception\FreightShipUnauthorizedException($response);
        }
