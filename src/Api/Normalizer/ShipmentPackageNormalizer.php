...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ShipmentPackageNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\ShipmentPackage';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\ShipmentPackage';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\ShipmentPackage();
            ...
            if (\array_key_exists('Packaging', $data)) {
                $object->setPackaging($this->denormalizer->denormalize($data['Packaging'], 'BesmartandPro\\Ups\\Api\\Model\\PackagePackaging', 'json', $context));
            ...
            if (\array_key_exists('ReferenceNumber', $data)) {
                ...
                foreach ($data['ReferenceNumber'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\PackageReferenceNumber', 'json', $context);
                }
            ...
            if (\array_key_exists('UPSPremier', $data)) {
                $object->setUPSPremier($this->denormalizer->denormalize($data['UPSPremier'], 'BesmartandPro\\Ups\\Api\\Model\\PackageUPSPremier', 'json', $context));
                unset($data['UPSPremier']);
            }
            if (\array_key_exists('PackageServiceOptions', $data)) {
                $object->setPackageServiceOptions($this->denormalizer->denormalize($data['PackageServiceOptions'], 'BesmartandPro\\Ups\\Api\\Model\\PackagePackageServiceOptions', 'json', $context));
            ...
            if (\array_key_exists('HazMatPackageInformation', $data)) {
                $object->setHazMatPackageInformation($this->denormalizer->denormalize($data['HazMatPackageInformation'], 'BesmartandPro\\Ups\\Api\\Model\\PackageHazMatPackageInformation', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\ShipmentPackage' => false];
        }
    }
} else {
    class ShipmentPackageNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
