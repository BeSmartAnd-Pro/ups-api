...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class LabelRecoveryResponseLabelResultsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\LabelRecoveryResponseLabelResults';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\LabelRecoveryResponseLabelResults';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\LabelRecoveryResponseLabelResults();
            ...
            if (\array_key_exists('LabelImage', $data)) {
                $object->setLabelImage($this->denormalizer->denormalize($data['LabelImage'], 'BesmartandPro\\Ups\\Api\\Model\\LabelResultsLabelImage', 'json', $context));
            ...
            if (\array_key_exists('MailInnovationsLabelImage', $data)) {
                $object->setMailInnovationsLabelImage($this->denormalizer->denormalize($data['MailInnovationsLabelImage'], 'BesmartandPro\\Ups\\Api\\Model\\LabelResultsMailInnovationsLabelImage', 'json', $context));
                unset($data['MailInnovationsLabelImage']);
            }
            if (\array_key_exists('Receipt', $data)) {
                $object->setReceipt($this->denormalizer->denormalize($data['Receipt'], 'BesmartandPro\\Ups\\Api\\Model\\LabelResultsReceipt', 'json', $context));
                unset($data['Receipt']);
            }
            if (\array_key_exists('Form', $data)) {
                $object->setForm($this->denormalizer->denormalize($data['Form'], 'BesmartandPro\\Ups\\Api\\Model\\LabelResultsForm', 'json', $context));
                unset($data['Form']);
            }
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\LabelRecoveryResponseLabelResults' => false];
        }
    }
} else {
    class LabelRecoveryResponseLabelResultsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
