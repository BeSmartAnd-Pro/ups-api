...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class InternationalFormsEEIFilingOptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\InternationalFormsEEIFilingOption';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\InternationalFormsEEIFilingOption';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\InternationalFormsEEIFilingOption();
            ...
            if (\array_key_exists('UPSFiled', $data)) {
                $object->setUPSFiled($this->denormalizer->denormalize($data['UPSFiled'], 'BesmartandPro\\Ups\\Api\\Model\\EEIFilingOptionUPSFiled', 'json', $context));
                unset($data['UPSFiled']);
            }
            if (\array_key_exists('ShipperFiled', $data)) {
                $object->setShipperFiled($this->denormalizer->denormalize($data['ShipperFiled'], 'BesmartandPro\\Ups\\Api\\Model\\EEIFilingOptionShipperFiled', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\InternationalFormsEEIFilingOption' => false];
        }
    }
} else {
    class InternationalFormsEEIFilingOptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
