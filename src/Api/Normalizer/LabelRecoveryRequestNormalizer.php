...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class LabelRecoveryRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\LabelRecoveryRequest';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\LabelRecoveryRequest';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\LabelRecoveryRequest();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('Request', $data)) {
                $object->setRequest($this->denormalizer->denormalize($data['Request'], 'BesmartandPro\\Ups\\Api\\Model\\LabelRecoveryRequestRequest', 'json', $context));
                unset($data['Request']);
            }
            if (\array_key_exists('LabelSpecification', $data)) {
                $object->setLabelSpecification($this->denormalizer->denormalize($data['LabelSpecification'], 'BesmartandPro\\Ups\\Api\\Model\\LabelRecoveryRequestLabelSpecification', 'json', $context));
                unset($data['LabelSpecification']);
            }
            if (\array_key_exists('Translate', $data)) {
                $object->setTranslate($this->denormalizer->denormalize($data['Translate'], 'BesmartandPro\\Ups\\Api\\Model\\LabelRecoveryRequestTranslate', 'json', $context));
                unset($data['Translate']);
            }
            if (\array_key_exists('LabelDelivery', $data)) {
                $object->setLabelDelivery($this->denormalizer->denormalize($data['LabelDelivery'], 'BesmartandPro\\Ups\\Api\\Model\\LabelRecoveryRequestLabelDelivery', 'json', $context));
            ...
            if (\array_key_exists('ReferenceValues', $data)) {
                $object->setReferenceValues($this->denormalizer->denormalize($data['ReferenceValues'], 'BesmartandPro\\Ups\\Api\\Model\\LabelRecoveryRequestReferenceValues', 'json', $context));
            ...
            if (\array_key_exists('UPSPremiumCareForm', $data)) {
                $object->setUPSPremiumCareForm($this->denormalizer->denormalize($data['UPSPremiumCareForm'], 'BesmartandPro\\Ups\\Api\\Model\\LabelRecoveryRequestUPSPremiumCareForm', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\LabelRecoveryRequest' => false];
        }
    }
} else {
    class LabelRecoveryRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
