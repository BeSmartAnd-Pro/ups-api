...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class CN22FormCN22ContentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\CN22FormCN22Content';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\CN22FormCN22Content';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\CN22FormCN22Content();
            ...
            if (\array_key_exists('CN22ContentWeight', $data)) {
                $object->setCN22ContentWeight($this->denormalizer->denormalize($data['CN22ContentWeight'], 'BesmartandPro\\Ups\\Api\\Model\\CN22ContentCN22ContentWeight', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\CN22FormCN22Content' => false];
        }
    }
} else {
    class CN22FormCN22ContentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
