...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SubscriptionFileDeliveryNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\SubscriptionFileDelivery';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\SubscriptionFileDelivery';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\SubscriptionFileDelivery();
            ...
            if (\array_key_exists('PackageReferenceNumber', $data)) {
                ...
                foreach ($data['PackageReferenceNumber'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\DeliveryPackageReferenceNumber', 'json', $context);
                }
            ...
            if (\array_key_exists('ShipmentReferenceNumber', $data)) {
                ...
                foreach ($data['ShipmentReferenceNumber'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\Ups\\Api\\Model\\DeliveryShipmentReferenceNumber', 'json', $context);
                }
            ...
            if (\array_key_exists('ActivityLocation', $data)) {
                $object->setActivityLocation($this->denormalizer->denormalize($data['ActivityLocation'], 'BesmartandPro\\Ups\\Api\\Model\\DeliveryActivityLocation', 'json', $context));
                unset($data['ActivityLocation']);
            }
            if (\array_key_exists('DeliveryLocation', $data)) {
                $object->setDeliveryLocation($this->denormalizer->denormalize($data['DeliveryLocation'], 'BesmartandPro\\Ups\\Api\\Model\\DeliveryDeliveryLocation', 'json', $context));
                unset($data['DeliveryLocation']);
            }
            if (\array_key_exists('COD', $data)) {
                $object->setCOD($this->denormalizer->denormalize($data['COD'], 'BesmartandPro\\Ups\\Api\\Model\\DeliveryCOD', 'json', $context));
                unset($data['COD']);
            }
            if (\array_key_exists('BillToAccount', $data)) {
                $object->setBillToAccount($this->denormalizer->denormalize($data['BillToAccount'], 'BesmartandPro\\Ups\\Api\\Model\\DeliveryBillToAccount', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\SubscriptionFileDelivery' => false];
        }
    }
} else {
    class SubscriptionFileDeliveryNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
