...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PickupCreationResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\PickupCreationResponse';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\PickupCreationResponse';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\PickupCreationResponse();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('Response', $data)) {
                $object->setResponse($this->denormalizer->denormalize($data['Response'], 'BesmartandPro\\Ups\\Api\\Model\\PickupCreationResponseResponse', 'json', $context));
                unset($data['Response']);
            }
            ...
            if (\array_key_exists('WeekendServiceTerritory', $data)) {
                $object->setWeekendServiceTerritory($this->denormalizer->denormalize($data['WeekendServiceTerritory'], 'BesmartandPro\\Ups\\Api\\Model\\PickupCreationResponseWeekendServiceTerritory', 'json', $context));
            ...
            if (\array_key_exists('RateStatus', $data)) {
                $object->setRateStatus($this->denormalizer->denormalize($data['RateStatus'], 'BesmartandPro\\Ups\\Api\\Model\\PickupCreationResponseRateStatus', 'json', $context));
                unset($data['RateStatus']);
            }
            if (\array_key_exists('RateResult', $data)) {
                $object->setRateResult($this->denormalizer->denormalize($data['RateResult'], 'BesmartandPro\\Ups\\Api\\Model\\PickupCreationResponseRateResult', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\PickupCreationResponse' => false];
        }
    }
} else {
    class PickupCreationResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
