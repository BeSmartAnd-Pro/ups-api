...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ManifestPackageNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\ManifestPackage';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\ManifestPackage';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\ManifestPackage();
            ...
            if (\array_key_exists('Activity', $data)) {
                ...
                foreach ($data['Activity'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\PackageActivity', 'json', $context);
                }
            ...
            if (\array_key_exists('Dimensions', $data)) {
                $object->setDimensions($this->denormalizer->denormalize($data['Dimensions'], 'BesmartandPro\\Ups\\Api\\Model\\ManifestPackageDimensions', 'json', $context));
                unset($data['Dimensions']);
            }
            if (\array_key_exists('DimensionalWeight', $data)) {
                $object->setDimensionalWeight($this->denormalizer->denormalize($data['DimensionalWeight'], 'BesmartandPro\\Ups\\Api\\Model\\PackageDimensionalWeight', 'json', $context));
                unset($data['DimensionalWeight']);
            }
            if (\array_key_exists('PackageWeight', $data)) {
                $object->setPackageWeight($this->denormalizer->denormalize($data['PackageWeight'], 'BesmartandPro\\Ups\\Api\\Model\\ManifestPackagePackageWeight', 'json', $context));
            ...
            if (\array_key_exists('ReferenceNumber', $data)) {
                ...
                foreach ($data['ReferenceNumber'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\Ups\\Api\\Model\\ManifestPackageReferenceNumber', 'json', $context);
                }
                $object->setReferenceNumber($values_1);
                unset($data['ReferenceNumber']);
            }
            if (\array_key_exists('PackageServiceOptions', $data)) {
                $object->setPackageServiceOptions($this->denormalizer->denormalize($data['PackageServiceOptions'], 'BesmartandPro\\Ups\\Api\\Model\\ManifestPackagePackageServiceOptions', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\ManifestPackage' => false];
        }
    }
} else {
    class ManifestPackageNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
