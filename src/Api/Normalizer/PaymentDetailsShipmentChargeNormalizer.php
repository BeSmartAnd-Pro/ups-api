...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PaymentDetailsShipmentChargeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\PaymentDetailsShipmentCharge';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\PaymentDetailsShipmentCharge';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\PaymentDetailsShipmentCharge();
            ...
            if (\array_key_exists('BillShipper', $data)) {
                $object->setBillShipper($this->denormalizer->denormalize($data['BillShipper'], 'BesmartandPro\\Ups\\Api\\Model\\RateShipmentChargeBillShipper', 'json', $context));
            ...
            if (\array_key_exists('BillThirdParty', $data)) {
                $object->setBillThirdParty($this->denormalizer->denormalize($data['BillThirdParty'], 'BesmartandPro\\Ups\\Api\\Model\\RateShipmentChargeBillThirdParty', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\PaymentDetailsShipmentCharge' => false];
        }
    }
} else {
    class PaymentDetailsShipmentChargeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
