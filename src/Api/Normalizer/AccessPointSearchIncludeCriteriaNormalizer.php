...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class AccessPointSearchIncludeCriteriaNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\AccessPointSearchIncludeCriteria';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\AccessPointSearchIncludeCriteria';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\AccessPointSearchIncludeCriteria();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('MerchantAccountNumberList', $data)) {
                $object->setMerchantAccountNumberList($this->denormalizer->denormalize($data['MerchantAccountNumberList'], 'BesmartandPro\\Ups\\Api\\Model\\IncludeCriteriaMerchantAccountNumberList', 'json', $context));
                unset($data['MerchantAccountNumberList']);
            }
            if (\array_key_exists('SearchFilter', $data)) {
                $object->setSearchFilter($this->denormalizer->denormalize($data['SearchFilter'], 'BesmartandPro\\Ups\\Api\\Model\\IncludeCriteriaSearchFilter', 'json', $context));
                unset($data['SearchFilter']);
            }
            if (\array_key_exists('ServiceOfferingList', $data)) {
                $object->setServiceOfferingList($this->denormalizer->denormalize($data['ServiceOfferingList'], 'BesmartandPro\\Ups\\Api\\Model\\IncludeCriteriaServiceOfferingList', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\AccessPointSearchIncludeCriteria' => false];
        }
    }
} else {
    class AccessPointSearchIncludeCriteriaNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
