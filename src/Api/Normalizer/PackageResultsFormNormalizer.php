...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PackageResultsFormNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\PackageResultsForm';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\PackageResultsForm';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\PackageResultsForm();
            ...
            if (\array_key_exists('Image', $data)) {
                $object->setImage($this->denormalizer->denormalize($data['Image'], 'BesmartandPro\\Ups\\Api\\Model\\FormImage', 'json', $context));
                unset($data['Image']);
            }
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\PackageResultsForm' => false];
        }
    }
} else {
    class PackageResultsFormNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
