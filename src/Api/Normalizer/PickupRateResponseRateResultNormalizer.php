...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PickupRateResponseRateResultNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\PickupRateResponseRateResult';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\PickupRateResponseRateResult';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\PickupRateResponseRateResult();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('Disclaimer', $data)) {
                $object->setDisclaimer($this->denormalizer->denormalize($data['Disclaimer'], 'BesmartandPro\\Ups\\Api\\Model\\RateResultDisclaimer', 'json', $context));
            ...
            if (\array_key_exists('ChargeDetail', $data)) {
                $object->setChargeDetail($this->denormalizer->denormalize($data['ChargeDetail'], 'BesmartandPro\\Ups\\Api\\Model\\RateResultChargeDetail', 'json', $context));
                unset($data['ChargeDetail']);
            }
            if (\array_key_exists('TaxCharges', $data)) {
                $object->setTaxCharges($this->denormalizer->denormalize($data['TaxCharges'], 'BesmartandPro\\Ups\\Api\\Model\\RateResultTaxCharges', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\PickupRateResponseRateResult' => false];
        }
    }
} else {
    class PickupRateResponseRateResultNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
