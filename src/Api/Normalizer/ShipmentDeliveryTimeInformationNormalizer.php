...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ShipmentDeliveryTimeInformationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\ShipmentDeliveryTimeInformation';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\ShipmentDeliveryTimeInformation';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\ShipmentDeliveryTimeInformation();
            ...
            if (\array_key_exists('Pickup', $data)) {
                $object->setPickup($this->denormalizer->denormalize($data['Pickup'], 'BesmartandPro\\Ups\\Api\\Model\\DeliveryTimeInformationPickup', 'json', $context));
                unset($data['Pickup']);
            }
            if (\array_key_exists('ReturnContractServices', $data)) {
                $values = [];
                foreach ($data['ReturnContractServices'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\DeliveryTimeInformationReturnContractServices', 'json', $context);
                }
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\ShipmentDeliveryTimeInformation' => false];
        }
    }
} else {
    class ShipmentDeliveryTimeInformationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
