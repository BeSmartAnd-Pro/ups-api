...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class FreightRateRequestCommodityNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\FreightRateRequestCommodity';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\FreightRateRequestCommodity';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\FreightRateRequestCommodity();
            ...
            if (\array_key_exists('Weight', $data)) {
                $object->setWeight($this->denormalizer->denormalize($data['Weight'], 'BesmartandPro\\Ups\\Api\\Model\\CommodityWeight', 'json', $context));
                unset($data['Weight']);
            }
            if (\array_key_exists('AdjustedWeight', $data)) {
                $object->setAdjustedWeight($this->denormalizer->denormalize($data['AdjustedWeight'], 'BesmartandPro\\Ups\\Api\\Model\\CommodityAdjustedWeight', 'json', $context));
                unset($data['AdjustedWeight']);
            }
            if (\array_key_exists('Dimensions', $data)) {
                $object->setDimensions($this->denormalizer->denormalize($data['Dimensions'], 'BesmartandPro\\Ups\\Api\\Model\\CommodityDimensions', 'json', $context));
            ...
            if (\array_key_exists('PackagingType', $data)) {
                $object->setPackagingType($this->denormalizer->denormalize($data['PackagingType'], 'BesmartandPro\\Ups\\Api\\Model\\CommodityPackagingType', 'json', $context));
            ...
            if (\array_key_exists('CommodityValue', $data)) {
                $object->setCommodityValue($this->denormalizer->denormalize($data['CommodityValue'], 'BesmartandPro\\Ups\\Api\\Model\\CommodityCommodityValue', 'json', $context));
            ...
            if (\array_key_exists('NMFCCommodity', $data)) {
                $object->setNMFCCommodity($this->denormalizer->denormalize($data['NMFCCommodity'], 'BesmartandPro\\Ups\\Api\\Model\\CommodityNMFCCommodity', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\FreightRateRequestCommodity' => false];
        }
    }
} else {
    class FreightRateRequestCommodityNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
