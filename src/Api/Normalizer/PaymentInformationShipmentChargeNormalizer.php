...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PaymentInformationShipmentChargeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\PaymentInformationShipmentCharge';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\PaymentInformationShipmentCharge';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\PaymentInformationShipmentCharge();
            ...
            if (\array_key_exists('BillShipper', $data)) {
                $object->setBillShipper($this->denormalizer->denormalize($data['BillShipper'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentChargeBillShipper', 'json', $context));
                unset($data['BillShipper']);
            }
            if (\array_key_exists('BillReceiver', $data)) {
                $object->setBillReceiver($this->denormalizer->denormalize($data['BillReceiver'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentChargeBillReceiver', 'json', $context));
                unset($data['BillReceiver']);
            }
            if (\array_key_exists('BillThirdParty', $data)) {
                $object->setBillThirdParty($this->denormalizer->denormalize($data['BillThirdParty'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentChargeBillThirdParty', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\PaymentInformationShipmentCharge' => false];
        }
    }
} else {
    class PaymentInformationShipmentChargeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
