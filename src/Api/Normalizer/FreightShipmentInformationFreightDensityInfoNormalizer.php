...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class FreightShipmentInformationFreightDensityInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\FreightShipmentInformationFreightDensityInfo';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\FreightShipmentInformationFreightDensityInfo';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\FreightShipmentInformationFreightDensityInfo();
            ...
            if (\array_key_exists('AdjustedHeight', $data)) {
                $object->setAdjustedHeight($this->denormalizer->denormalize($data['AdjustedHeight'], 'BesmartandPro\\Ups\\Api\\Model\\FreightDensityInfoAdjustedHeight', 'json', $context));
                unset($data['AdjustedHeight']);
            }
            if (\array_key_exists('HandlingUnits', $data)) {
                $values = [];
                foreach ($data['HandlingUnits'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\FreightDensityInfoHandlingUnits', 'json', $context);
                }
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\FreightShipmentInformationFreightDensityInfo' => false];
        }
    }
} else {
    class FreightShipmentInformationFreightDensityInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
