...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class DANGEROUSGOODSUTILITYResponseWrapperNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\DANGEROUSGOODSUTILITYResponseWrapper';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\DANGEROUSGOODSUTILITYResponseWrapper';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\DANGEROUSGOODSUTILITYResponseWrapper();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('ChemicalReferenceDataResponse', $data)) {
                $object->setChemicalReferenceDataResponse($this->denormalizer->denormalize($data['ChemicalReferenceDataResponse'], 'BesmartandPro\\Ups\\Api\\Model\\ChemicalReferenceDataResponse', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\DANGEROUSGOODSUTILITYResponseWrapper' => false];
        }
    }
} else {
    class DANGEROUSGOODSUTILITYResponseWrapperNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
