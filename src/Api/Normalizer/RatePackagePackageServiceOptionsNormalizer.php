...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class RatePackagePackageServiceOptionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\RatePackagePackageServiceOptions';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\RatePackagePackageServiceOptions';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\RatePackagePackageServiceOptions();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('DeliveryConfirmation', $data)) {
                $object->setDeliveryConfirmation($this->denormalizer->denormalize($data['DeliveryConfirmation'], 'BesmartandPro\\Ups\\Api\\Model\\RatePackageServiceOptionsDeliveryConfirmation', 'json', $context));
                unset($data['DeliveryConfirmation']);
            }
            if (\array_key_exists('AccessPointCOD', $data)) {
                $object->setAccessPointCOD($this->denormalizer->denormalize($data['AccessPointCOD'], 'BesmartandPro\\Ups\\Api\\Model\\PackageServiceOptionsAccessPointCOD', 'json', $context));
                unset($data['AccessPointCOD']);
            }
            if (\array_key_exists('COD', $data)) {
                $object->setCOD($this->denormalizer->denormalize($data['COD'], 'BesmartandPro\\Ups\\Api\\Model\\PackageServiceOptionsCOD', 'json', $context));
                unset($data['COD']);
            }
            if (\array_key_exists('DeclaredValue', $data)) {
                $object->setDeclaredValue($this->denormalizer->denormalize($data['DeclaredValue'], 'BesmartandPro\\Ups\\Api\\Model\\RatePackageServiceOptionsDeclaredValue', 'json', $context));
                unset($data['DeclaredValue']);
            }
            if (\array_key_exists('ShipperDeclaredValue', $data)) {
                $object->setShipperDeclaredValue($this->denormalizer->denormalize($data['ShipperDeclaredValue'], 'BesmartandPro\\Ups\\Api\\Model\\PackageServiceOptionsShipperDeclaredValue', 'json', $context));
            ...
            if (\array_key_exists('Insurance', $data)) {
                $object->setInsurance($this->denormalizer->denormalize($data['Insurance'], 'BesmartandPro\\Ups\\Api\\Model\\PackageServiceOptionsInsurance', 'json', $context));
            ...
            if (\array_key_exists('HazMat', $data)) {
                $object->setHazMat($this->denormalizer->denormalize($data['HazMat'], 'BesmartandPro\\Ups\\Api\\Model\\RatePackageServiceOptionsHazMat', 'json', $context));
                unset($data['HazMat']);
            }
            if (\array_key_exists('DryIce', $data)) {
                $object->setDryIce($this->denormalizer->denormalize($data['DryIce'], 'BesmartandPro\\Ups\\Api\\Model\\RatePackageServiceOptionsDryIce', 'json', $context));
                unset($data['DryIce']);
            }
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\RatePackagePackageServiceOptions' => false];
        }
    }
} else {
    class RatePackagePackageServiceOptionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
