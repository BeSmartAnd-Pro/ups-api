...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ShipmentShipFromNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\ShipmentShipFrom';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\ShipmentShipFrom';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\ShipmentShipFrom();
            ...
            if (\array_key_exists('TaxIDType', $data)) {
                $object->setTaxIDType($this->denormalizer->denormalize($data['TaxIDType'], 'BesmartandPro\\Ups\\Api\\Model\\ShipFromTaxIDType', 'json', $context));
                unset($data['TaxIDType']);
            }
            if (\array_key_exists('Phone', $data)) {
                $object->setPhone($this->denormalizer->denormalize($data['Phone'], 'BesmartandPro\\Ups\\Api\\Model\\ShipFromPhone', 'json', $context));
                unset($data['Phone']);
            }
            ...
            if (\array_key_exists('Address', $data)) {
                $object->setAddress($this->denormalizer->denormalize($data['Address'], 'BesmartandPro\\Ups\\Api\\Model\\ShipFromAddress', 'json', $context));
                unset($data['Address']);
            }
            if (\array_key_exists('VendorInfo', $data)) {
                $object->setVendorInfo($this->denormalizer->denormalize($data['VendorInfo'], 'BesmartandPro\\Ups\\Api\\Model\\ShipFromVendorInfo', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\ShipmentShipFrom' => false];
        }
    }
} else {
    class ShipmentShipFromNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
