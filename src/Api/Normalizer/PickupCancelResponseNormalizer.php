...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PickupCancelResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\PickupCancelResponse';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\PickupCancelResponse';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\PickupCancelResponse();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('Response', $data)) {
                $object->setResponse($this->denormalizer->denormalize($data['Response'], 'BesmartandPro\\Ups\\Api\\Model\\PickupCancelResponseResponse', 'json', $context));
                unset($data['Response']);
            }
            ...
            if (\array_key_exists('GWNStatus', $data)) {
                $object->setGWNStatus($this->denormalizer->denormalize($data['GWNStatus'], 'BesmartandPro\\Ups\\Api\\Model\\PickupCancelResponseGWNStatus', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\PickupCancelResponse' => false];
        }
    }
} else {
    class PickupCancelResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
