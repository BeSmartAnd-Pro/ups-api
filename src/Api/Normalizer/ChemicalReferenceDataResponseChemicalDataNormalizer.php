...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ChemicalReferenceDataResponseChemicalDataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\ChemicalReferenceDataResponseChemicalData';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\ChemicalReferenceDataResponseChemicalData';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\ChemicalReferenceDataResponseChemicalData();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('ChemicalDetail', $data)) {
                $object->setChemicalDetail($this->denormalizer->denormalize($data['ChemicalDetail'], 'BesmartandPro\\Ups\\Api\\Model\\ChemicalDataChemicalDetail', 'json', $context));
                unset($data['ChemicalDetail']);
            }
            if (\array_key_exists('ProperShippingNameDetail', $data)) {
                $object->setProperShippingNameDetail($this->denormalizer->denormalize($data['ProperShippingNameDetail'], 'BesmartandPro\\Ups\\Api\\Model\\ChemicalDataProperShippingNameDetail', 'json', $context));
            ...
            if (\array_key_exists('PackageQuantityLimitDetail', $data)) {
                ...
                foreach ($data['PackageQuantityLimitDetail'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\ChemicalDataPackageQuantityLimitDetail', 'json', $context);
                }
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\ChemicalReferenceDataResponseChemicalData' => false];
        }
    }
} else {
    class ChemicalReferenceDataResponseChemicalDataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
