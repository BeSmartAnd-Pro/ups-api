...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class RateShipmentShipmentServiceOptionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\RateShipmentShipmentServiceOptions';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\RateShipmentShipmentServiceOptions';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\RateShipmentShipmentServiceOptions();
            ...
            if (\array_key_exists('DeliveryConfirmation', $data)) {
                $object->setDeliveryConfirmation($this->denormalizer->denormalize($data['DeliveryConfirmation'], 'BesmartandPro\\Ups\\Api\\Model\\RateShipmentServiceOptionsDeliveryConfirmation', 'json', $context));
            ...
            if (\array_key_exists('PickupOptions', $data)) {
                $object->setPickupOptions($this->denormalizer->denormalize($data['PickupOptions'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentServiceOptionsPickupOptions', 'json', $context));
                unset($data['PickupOptions']);
            }
            if (\array_key_exists('DeliveryOptions', $data)) {
                $object->setDeliveryOptions($this->denormalizer->denormalize($data['DeliveryOptions'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentServiceOptionsDeliveryOptions', 'json', $context));
                unset($data['DeliveryOptions']);
            }
            if (\array_key_exists('RestrictedArticles', $data)) {
                $object->setRestrictedArticles($this->denormalizer->denormalize($data['RestrictedArticles'], 'BesmartandPro\\Ups\\Api\\Model\\RateShipmentServiceOptionsRestrictedArticles', 'json', $context));
            ...
            if (\array_key_exists('ImportControl', $data)) {
                $object->setImportControl($this->denormalizer->denormalize($data['ImportControl'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentServiceOptionsImportControl', 'json', $context));
                unset($data['ImportControl']);
            }
            if (\array_key_exists('ReturnService', $data)) {
                $object->setReturnService($this->denormalizer->denormalize($data['ReturnService'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentServiceOptionsReturnService', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\RateShipmentShipmentServiceOptions' => false];
        }
    }
} else {
    class RateShipmentShipmentServiceOptionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
