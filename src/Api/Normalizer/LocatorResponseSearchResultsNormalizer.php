...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class LocatorResponseSearchResultsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\LocatorResponseSearchResults';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\LocatorResponseSearchResults';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\LocatorResponseSearchResults();
            ...
            if (\array_key_exists('GeocodeCandidate', $data)) {
                ...
                foreach ($data['GeocodeCandidate'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\SearchResultsGeocodeCandidate', 'json', $context);
                }
            ...
            if (\array_key_exists('DropLocation', $data)) {
                ...
                foreach ($data['DropLocation'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\Ups\\Api\\Model\\SearchResultsDropLocation', 'json', $context);
                }
            ...
            if (\array_key_exists('AvailableLocationAttributes', $data)) {
                ...
                foreach ($data['AvailableLocationAttributes'] as $value_2) {
                    $values_2[] = $this->denormalizer->denormalize($value_2, 'BesmartandPro\\Ups\\Api\\Model\\SearchResultsAvailableLocationAttributes', 'json', $context);
                }
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\LocatorResponseSearchResults' => false];
        }
    }
} else {
    class LocatorResponseSearchResultsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
