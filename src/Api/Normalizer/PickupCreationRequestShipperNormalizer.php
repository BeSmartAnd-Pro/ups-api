...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PickupCreationRequestShipperNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\PickupCreationRequestShipper';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\PickupCreationRequestShipper';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\PickupCreationRequestShipper();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('Account', $data)) {
                $object->setAccount($this->denormalizer->denormalize($data['Account'], 'BesmartandPro\\Ups\\Api\\Model\\ShipperAccount', 'json', $context));
                unset($data['Account']);
            }
            if (\array_key_exists('ChargeCard', $data)) {
                $object->setChargeCard($this->denormalizer->denormalize($data['ChargeCard'], 'BesmartandPro\\Ups\\Api\\Model\\ShipperChargeCard', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\PickupCreationRequestShipper' => false];
        }
    }
} else {
    class PickupCreationRequestShipperNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
