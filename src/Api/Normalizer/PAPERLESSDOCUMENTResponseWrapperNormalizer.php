...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PAPERLESSDOCUMENTResponseWrapperNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\PAPERLESSDOCUMENTResponseWrapper';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\PAPERLESSDOCUMENTResponseWrapper';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\PAPERLESSDOCUMENTResponseWrapper();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('PushToImageRepositoryResponse', $data)) {
                $object->setPushToImageRepositoryResponse($this->denormalizer->denormalize($data['PushToImageRepositoryResponse'], 'BesmartandPro\\Ups\\Api\\Model\\PushToImageRepositoryResponse', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\PAPERLESSDOCUMENTResponseWrapper' => false];
        }
    }
} else {
    class PAPERLESSDOCUMENTResponseWrapperNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
