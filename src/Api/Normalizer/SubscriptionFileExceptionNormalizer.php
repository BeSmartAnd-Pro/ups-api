...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SubscriptionFileExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\SubscriptionFileException';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\SubscriptionFileException';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\SubscriptionFileException();
            ...
            if (\array_key_exists('PackageReferenceNumber', $data)) {
                ...
                foreach ($data['PackageReferenceNumber'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\ExceptionPackageReferenceNumber', 'json', $context);
                }
            ...
            if (\array_key_exists('ShipmentReferenceNumber', $data)) {
                ...
                foreach ($data['ShipmentReferenceNumber'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\Ups\\Api\\Model\\ExceptionShipmentReferenceNumber', 'json', $context);
                }
            ...
            if (\array_key_exists('UpdatedAddress', $data)) {
                $object->setUpdatedAddress($this->denormalizer->denormalize($data['UpdatedAddress'], 'BesmartandPro\\Ups\\Api\\Model\\ExceptionUpdatedAddress', 'json', $context));
            ...
            if (\array_key_exists('Resolution', $data)) {
                $object->setResolution($this->denormalizer->denormalize($data['Resolution'], 'BesmartandPro\\Ups\\Api\\Model\\ExceptionResolution', 'json', $context));
            ...
            if (\array_key_exists('ActivityLocation', $data)) {
                $object->setActivityLocation($this->denormalizer->denormalize($data['ActivityLocation'], 'BesmartandPro\\Ups\\Api\\Model\\ExceptionActivityLocation', 'json', $context));
                unset($data['ActivityLocation']);
            }
            if (\array_key_exists('BillToAccount', $data)) {
                $object->setBillToAccount($this->denormalizer->denormalize($data['BillToAccount'], 'BesmartandPro\\Ups\\Api\\Model\\ExceptionBillToAccount', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\SubscriptionFileException' => false];
        }
    }
} else {
    class SubscriptionFileExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
