...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PackageUPSPremierNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\PackageUPSPremier';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\PackageUPSPremier';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\PackageUPSPremier();
            ...
            if (\array_key_exists('HandlingInstructions', $data)) {
                $object->setHandlingInstructions($this->denormalizer->denormalize($data['HandlingInstructions'], 'BesmartandPro\\Ups\\Api\\Model\\UPSPremierHandlingInstructions', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\PackageUPSPremier' => false];
        }
    }
} else {
    class PackageUPSPremierNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
