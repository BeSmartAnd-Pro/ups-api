...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class FreightRateRequestShipmentServiceOptionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\FreightRateRequestShipmentServiceOptions';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\FreightRateRequestShipmentServiceOptions';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\FreightRateRequestShipmentServiceOptions();
            ...
            if (\array_key_exists('DangerousGoods', $data)) {
                $object->setDangerousGoods($this->denormalizer->denormalize($data['DangerousGoods'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentServiceOptionsDangerousGoods', 'json', $context));
            ...
            if (\array_key_exists('AdjustedHeight', $data)) {
                $object->setAdjustedHeight($this->denormalizer->denormalize($data['AdjustedHeight'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentServiceOptionsAdjustedHeight', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\FreightRateRequestShipmentServiceOptions' => false];
        }
    }
} else {
    class FreightRateRequestShipmentServiceOptionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
