...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class MilestonesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\Milestones';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\Milestones';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\Milestones();
            ...
            if (\array_key_exists('subMilestone', $data)) {
                $object->setSubMilestone($this->denormalizer->denormalize($data['subMilestone'], 'BesmartandPro\\Ups\\Api\\Model\\SubMilestone', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\Milestones' => false];
        }
    }
} else {
    class MilestonesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
