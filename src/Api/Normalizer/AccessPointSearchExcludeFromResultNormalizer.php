...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class AccessPointSearchExcludeFromResultNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\AccessPointSearchExcludeFromResult';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\AccessPointSearchExcludeFromResult';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\AccessPointSearchExcludeFromResult();
            ...
            if (\array_key_exists('PostalCodeList', $data)) {
                $object->setPostalCodeList($this->denormalizer->denormalize($data['PostalCodeList'], 'BesmartandPro\\Ups\\Api\\Model\\ExcludeFromResultPostalCodeList', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\AccessPointSearchExcludeFromResult' => false];
        }
    }
} else {
    class AccessPointSearchExcludeFromResultNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
