...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PreNotificationRequestShipmentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\PreNotificationRequestShipment';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\PreNotificationRequestShipment';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\PreNotificationRequestShipment();
            ...
            if (\array_key_exists('ShipToAddress', $data)) {
                $object->setShipToAddress($this->denormalizer->denormalize($data['ShipToAddress'], 'BesmartandPro\\Ups\\Api\\Model\\PreNotificationShipmentShipToAddress', 'json', $context));
                unset($data['ShipToAddress']);
            }
            if (\array_key_exists('ShipFromAddress', $data)) {
                $object->setShipFromAddress($this->denormalizer->denormalize($data['ShipFromAddress'], 'BesmartandPro\\Ups\\Api\\Model\\PreNotificationShipmentShipFromAddress', 'json', $context));
            ...
            if (\array_key_exists('Package', $data)) {
                ...
                foreach ($data['Package'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\PreNotificationShipmentPackage', 'json', $context);
                }
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\PreNotificationRequestShipment' => false];
        }
    }
} else {
    class PreNotificationRequestShipmentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
