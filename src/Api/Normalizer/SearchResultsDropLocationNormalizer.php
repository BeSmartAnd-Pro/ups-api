...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SearchResultsDropLocationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\SearchResultsDropLocation';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\SearchResultsDropLocation';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\SearchResultsDropLocation();
            ...
            if (\array_key_exists('IVR', $data)) {
                $object->setIVR($this->denormalizer->denormalize($data['IVR'], 'BesmartandPro\\Ups\\Api\\Model\\DropLocationIVR', 'json', $context));
                unset($data['IVR']);
            }
            if (\array_key_exists('Geocode', $data)) {
                $object->setGeocode($this->denormalizer->denormalize($data['Geocode'], 'BesmartandPro\\Ups\\Api\\Model\\DropLocationGeocode', 'json', $context));
                unset($data['Geocode']);
            }
            if (\array_key_exists('AddressKeyFormat', $data)) {
                $object->setAddressKeyFormat($this->denormalizer->denormalize($data['AddressKeyFormat'], 'BesmartandPro\\Ups\\Api\\Model\\DropLocationAddressKeyFormat', 'json', $context));
            ...
            if (\array_key_exists('LocationAttribute', $data)) {
                ...
                foreach ($data['LocationAttribute'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\Ups\\Api\\Model\\DropLocationLocationAttribute', 'json', $context);
                }
                $object->setLocationAttribute($values_1);
                unset($data['LocationAttribute']);
            }
            if (\array_key_exists('Distance', $data)) {
                $object->setDistance($this->denormalizer->denormalize($data['Distance'], 'BesmartandPro\\Ups\\Api\\Model\\DropLocationDistance', 'json', $context));
                unset($data['Distance']);
            }
            if (\array_key_exists('SpecialInstructions', $data)) {
                $values_2 = [];
                foreach ($data['SpecialInstructions'] as $value_2) {
                    $values_2[] = $this->denormalizer->denormalize($value_2, 'BesmartandPro\\Ups\\Api\\Model\\DropLocationSpecialInstructions', 'json', $context);
                }
            ...
            if (\array_key_exists('AdditionalComments', $data)) {
                $object->setAdditionalComments($this->denormalizer->denormalize($data['AdditionalComments'], 'BesmartandPro\\Ups\\Api\\Model\\DropLocationAdditionalComments', 'json', $context));
            ...
            if (\array_key_exists('OperatingHours', $data)) {
                $object->setOperatingHours($this->denormalizer->denormalize($data['OperatingHours'], 'BesmartandPro\\Ups\\Api\\Model\\DropLocationOperatingHours', 'json', $context));
                unset($data['OperatingHours']);
            }
            if (\array_key_exists('LocalizedInstruction', $data)) {
                $values_6 = [];
                foreach ($data['LocalizedInstruction'] as $value_6) {
                    $values_6[] = $this->denormalizer->denormalize($value_6, 'BesmartandPro\\Ups\\Api\\Model\\DropLocationLocalizedInstruction', 'json', $context);
                }
            ...
            if (\array_key_exists('PromotionInformation', $data)) {
                ...
                foreach ($data['PromotionInformation'] as $value_7) {
                    $values_7[] = $this->denormalizer->denormalize($value_7, 'BesmartandPro\\Ups\\Api\\Model\\DropLocationPromotionInformation', 'json', $context);
                }
                $object->setPromotionInformation($values_7);
                unset($data['PromotionInformation']);
            }
            if (\array_key_exists('SortCode', $data)) {
                $object->setSortCode($this->denormalizer->denormalize($data['SortCode'], 'BesmartandPro\\Ups\\Api\\Model\\DropLocationSortCode', 'json', $context));
                unset($data['SortCode']);
            }
            if (\array_key_exists('ServiceOfferingList', $data)) {
                $object->setServiceOfferingList($this->denormalizer->denormalize($data['ServiceOfferingList'], 'BesmartandPro\\Ups\\Api\\Model\\DropLocationServiceOfferingList', 'json', $context));
            ...
            if (\array_key_exists('AccessPointInformation', $data)) {
                $object->setAccessPointInformation($this->denormalizer->denormalize($data['AccessPointInformation'], 'BesmartandPro\\Ups\\Api\\Model\\DropLocationAccessPointInformation', 'json', $context));
                unset($data['AccessPointInformation']);
            }
            if (\array_key_exists('LocationImage', $data)) {
                $object->setLocationImage($this->denormalizer->denormalize($data['LocationImage'], 'BesmartandPro\\Ups\\Api\\Model\\DropLocationLocationImage', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\SearchResultsDropLocation' => false];
        }
    }
} else {
    class SearchResultsDropLocationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
