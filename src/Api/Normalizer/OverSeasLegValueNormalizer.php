...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class OverSeasLegValueNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\OverSeasLegValue';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\OverSeasLegValue';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\OverSeasLegValue();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('Cube', $data)) {
                $object->setCube($this->denormalizer->denormalize($data['Cube'], 'BesmartandPro\\Ups\\Api\\Model\\ValueCube', 'json', $context));
                unset($data['Cube']);
            }
            if (\array_key_exists('CWT', $data)) {
                $object->setCWT($this->denormalizer->denormalize($data['CWT'], 'BesmartandPro\\Ups\\Api\\Model\\ValueCWT', 'json', $context));
                unset($data['CWT']);
            }
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\OverSeasLegValue' => false];
        }
    }
} else {
    class OverSeasLegValueNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
