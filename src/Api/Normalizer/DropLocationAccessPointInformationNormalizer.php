...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class DropLocationAccessPointInformationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\DropLocationAccessPointInformation';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\DropLocationAccessPointInformation';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\DropLocationAccessPointInformation();
            ...
            if (\array_key_exists('BusinessClassificationList', $data)) {
                $object->setBusinessClassificationList($this->denormalizer->denormalize($data['BusinessClassificationList'], 'BesmartandPro\\Ups\\Api\\Model\\AccessPointInformationBusinessClassificationList', 'json', $context));
                unset($data['BusinessClassificationList']);
            }
            if (\array_key_exists('AccessPointStatus', $data)) {
                $object->setAccessPointStatus($this->denormalizer->denormalize($data['AccessPointStatus'], 'BesmartandPro\\Ups\\Api\\Model\\AccessPointInformationAccessPointStatus', 'json', $context));
            ...
            if (\array_key_exists('PrivateNetworkList', $data)) {
                $object->setPrivateNetworkList($this->denormalizer->denormalize($data['PrivateNetworkList'], 'BesmartandPro\\Ups\\Api\\Model\\AccessPointInformationPrivateNetworkList', 'json', $context));
                unset($data['PrivateNetworkList']);
            }
            if (\array_key_exists('Availability', $data)) {
                $object->setAvailability($this->denormalizer->denormalize($data['Availability'], 'BesmartandPro\\Ups\\Api\\Model\\AccessPointInformationAvailability', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\DropLocationAccessPointInformation' => false];
        }
    }
} else {
    class DropLocationAccessPointInformationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
