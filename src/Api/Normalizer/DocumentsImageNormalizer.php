...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class DocumentsImageNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\DocumentsImage';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\DocumentsImage';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\DocumentsImage();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('Type', $data)) {
                $object->setType($this->denormalizer->denormalize($data['Type'], 'BesmartandPro\\Ups\\Api\\Model\\ImageType', 'json', $context));
                unset($data['Type']);
            }
            ...
            if (\array_key_exists('Format', $data)) {
                $object->setFormat($this->denormalizer->denormalize($data['Format'], 'BesmartandPro\\Ups\\Api\\Model\\ImageFormat', 'json', $context));
                unset($data['Format']);
            }
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\DocumentsImage' => false];
        }
    }
} else {
    class DocumentsImageNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
