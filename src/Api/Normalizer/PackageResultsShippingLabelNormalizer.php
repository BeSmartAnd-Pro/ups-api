...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PackageResultsShippingLabelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\PackageResultsShippingLabel';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\PackageResultsShippingLabel';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\PackageResultsShippingLabel();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('ImageFormat', $data)) {
                $object->setImageFormat($this->denormalizer->denormalize($data['ImageFormat'], 'BesmartandPro\\Ups\\Api\\Model\\ShippingLabelImageFormat', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\PackageResultsShippingLabel' => false];
        }
    }
} else {
    class PackageResultsShippingLabelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
