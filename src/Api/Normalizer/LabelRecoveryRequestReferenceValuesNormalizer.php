...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class LabelRecoveryRequestReferenceValuesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\LabelRecoveryRequestReferenceValues';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\LabelRecoveryRequestReferenceValues';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\LabelRecoveryRequestReferenceValues();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('ReferenceNumber', $data)) {
                $object->setReferenceNumber($this->denormalizer->denormalize($data['ReferenceNumber'], 'BesmartandPro\\Ups\\Api\\Model\\ReferenceValuesReferenceNumber', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\LabelRecoveryRequestReferenceValues' => false];
        }
    }
} else {
    class LabelRecoveryRequestReferenceValuesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
