...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class LocatorRequestLocationSearchCriteriaNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\LocatorRequestLocationSearchCriteria';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\LocatorRequestLocationSearchCriteria';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\LocatorRequestLocationSearchCriteria();
            ...
            if (\array_key_exists('SearchOption', $data)) {
                ...
                foreach ($data['SearchOption'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\LocationSearchCriteriaSearchOption', 'json', $context);
                }
            ...
            if (\array_key_exists('ServiceSearch', $data)) {
                $object->setServiceSearch($this->denormalizer->denormalize($data['ServiceSearch'], 'BesmartandPro\\Ups\\Api\\Model\\LocationSearchCriteriaServiceSearch', 'json', $context));
                unset($data['ServiceSearch']);
            }
            if (\array_key_exists('FreightWillCallSearch', $data)) {
                $object->setFreightWillCallSearch($this->denormalizer->denormalize($data['FreightWillCallSearch'], 'BesmartandPro\\Ups\\Api\\Model\\LocationSearchCriteriaFreightWillCallSearch', 'json', $context));
                unset($data['FreightWillCallSearch']);
            }
            if (\array_key_exists('AccessPointSearch', $data)) {
                $object->setAccessPointSearch($this->denormalizer->denormalize($data['AccessPointSearch'], 'BesmartandPro\\Ups\\Api\\Model\\LocationSearchCriteriaAccessPointSearch', 'json', $context));
                unset($data['AccessPointSearch']);
            }
            if (\array_key_exists('OpenTimeCriteria', $data)) {
                $object->setOpenTimeCriteria($this->denormalizer->denormalize($data['OpenTimeCriteria'], 'BesmartandPro\\Ups\\Api\\Model\\LocationSearchCriteriaOpenTimeCriteria', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\LocatorRequestLocationSearchCriteria' => false];
        }
    }
} else {
    class LocatorRequestLocationSearchCriteriaNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
