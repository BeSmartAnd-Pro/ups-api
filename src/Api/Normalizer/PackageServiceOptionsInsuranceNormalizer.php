...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PackageServiceOptionsInsuranceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\PackageServiceOptionsInsurance';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\PackageServiceOptionsInsurance';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\PackageServiceOptionsInsurance();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('BasicFlexibleParcelIndicator', $data)) {
                $object->setBasicFlexibleParcelIndicator($this->denormalizer->denormalize($data['BasicFlexibleParcelIndicator'], 'BesmartandPro\\Ups\\Api\\Model\\InsuranceBasicFlexibleParcelIndicator', 'json', $context));
                unset($data['BasicFlexibleParcelIndicator']);
            }
            if (\array_key_exists('ExtendedFlexibleParcelIndicator', $data)) {
                $object->setExtendedFlexibleParcelIndicator($this->denormalizer->denormalize($data['ExtendedFlexibleParcelIndicator'], 'BesmartandPro\\Ups\\Api\\Model\\InsuranceExtendedFlexibleParcelIndicator', 'json', $context));
                unset($data['ExtendedFlexibleParcelIndicator']);
            }
            if (\array_key_exists('TimeInTransitFlexibleParcelIndicator', $data)) {
                $object->setTimeInTransitFlexibleParcelIndicator($this->denormalizer->denormalize($data['TimeInTransitFlexibleParcelIndicator'], 'BesmartandPro\\Ups\\Api\\Model\\InsuranceTimeInTransitFlexibleParcelIndicator', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\PackageServiceOptionsInsurance' => false];
        }
    }
} else {
    class PackageServiceOptionsInsuranceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
