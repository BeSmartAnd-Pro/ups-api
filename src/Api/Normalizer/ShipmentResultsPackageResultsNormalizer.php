...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ShipmentResultsPackageResultsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\ShipmentResultsPackageResults';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\ShipmentResultsPackageResults';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\ShipmentResultsPackageResults();
            ...
            if (\array_key_exists('RateModifier', $data)) {
                $object->setRateModifier($this->denormalizer->denormalize($data['RateModifier'], 'BesmartandPro\\Ups\\Api\\Model\\PackageResultsRateModifier', 'json', $context));
                unset($data['RateModifier']);
            }
            if (\array_key_exists('BaseServiceCharge', $data)) {
                $object->setBaseServiceCharge($this->denormalizer->denormalize($data['BaseServiceCharge'], 'BesmartandPro\\Ups\\Api\\Model\\PackageResultsBaseServiceCharge', 'json', $context));
                unset($data['BaseServiceCharge']);
            }
            if (\array_key_exists('ServiceOptionsCharges', $data)) {
                $object->setServiceOptionsCharges($this->denormalizer->denormalize($data['ServiceOptionsCharges'], 'BesmartandPro\\Ups\\Api\\Model\\PackageResultsServiceOptionsCharges', 'json', $context));
                unset($data['ServiceOptionsCharges']);
            }
            if (\array_key_exists('ShippingLabel', $data) && $data['ShippingLabel'] !== null) {
                $object->setShippingLabel($this->denormalizer->denormalize($data['ShippingLabel'], 'BesmartandPro\\Ups\\Api\\Model\\PackageResultsShippingLabel', 'json', $context));
            ...
            if (\array_key_exists('ShippingReceipt', $data)) {
                $object->setShippingReceipt($this->denormalizer->denormalize($data['ShippingReceipt'], 'BesmartandPro\\Ups\\Api\\Model\\PackageResultsShippingReceipt', 'json', $context));
            ...
            if (\array_key_exists('Accessorial', $data)) {
                ...
                foreach ($data['Accessorial'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\PackageResultsAccessorial', 'json', $context);
                }
                $object->setAccessorial($values);
                unset($data['Accessorial']);
            }
            if (\array_key_exists('SimpleRate', $data)) {
                $object->setSimpleRate($this->denormalizer->denormalize($data['SimpleRate'], 'BesmartandPro\\Ups\\Api\\Model\\PackageResultsSimpleRate', 'json', $context));
                unset($data['SimpleRate']);
            }
            if (\array_key_exists('Form', $data) && $data['Form'] !== null) {
                $object->setForm($this->denormalizer->denormalize($data['Form'], 'BesmartandPro\\Ups\\Api\\Model\\PackageResultsForm', 'json', $context));
                unset($data['Form']);
            }
            ...
            if (\array_key_exists('ItemizedCharges', $data)) {
                ...
                foreach ($data['ItemizedCharges'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\Ups\\Api\\Model\\PackageResultsItemizedCharges', 'json', $context);
                }
                $object->setItemizedCharges($values_1);
                unset($data['ItemizedCharges']);
            }
            if (\array_key_exists('NegotiatedCharges', $data)) {
                $object->setNegotiatedCharges($this->denormalizer->denormalize($data['NegotiatedCharges'], 'BesmartandPro\\Ups\\Api\\Model\\PackageResultsNegotiatedCharges', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\ShipmentResultsPackageResults' => false];
        }
    }
} else {
    class ShipmentResultsPackageResultsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
