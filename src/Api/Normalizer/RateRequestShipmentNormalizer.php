...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class RateRequestShipmentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\RateRequestShipment';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\RateRequestShipment';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\RateRequestShipment();
            ...
            if (\array_key_exists('Shipper', $data)) {
                $object->setShipper($this->denormalizer->denormalize($data['Shipper'], 'BesmartandPro\\Ups\\Api\\Model\\RateShipmentShipper', 'json', $context));
                unset($data['Shipper']);
            }
            if (\array_key_exists('ShipTo', $data)) {
                $object->setShipTo($this->denormalizer->denormalize($data['ShipTo'], 'BesmartandPro\\Ups\\Api\\Model\\RateShipmentShipTo', 'json', $context));
                unset($data['ShipTo']);
            }
            if (\array_key_exists('ShipFrom', $data)) {
                $object->setShipFrom($this->denormalizer->denormalize($data['ShipFrom'], 'BesmartandPro\\Ups\\Api\\Model\\RateShipmentShipFrom', 'json', $context));
                unset($data['ShipFrom']);
            }
            if (\array_key_exists('AlternateDeliveryAddress', $data)) {
                $object->setAlternateDeliveryAddress($this->denormalizer->denormalize($data['AlternateDeliveryAddress'], 'BesmartandPro\\Ups\\Api\\Model\\RateShipmentAlternateDeliveryAddress', 'json', $context));
            ...
            if (\array_key_exists('ShipmentIndicationType', $data)) {
                ...
                foreach ($data['ShipmentIndicationType'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\ShipmentShipmentIndicationType', 'json', $context);
                }
                $object->setShipmentIndicationType($values);
                unset($data['ShipmentIndicationType']);
            }
            if (\array_key_exists('PaymentDetails', $data)) {
                $object->setPaymentDetails($this->denormalizer->denormalize($data['PaymentDetails'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentPaymentDetails', 'json', $context));
                unset($data['PaymentDetails']);
            }
            if (\array_key_exists('FRSPaymentInformation', $data)) {
                $object->setFRSPaymentInformation($this->denormalizer->denormalize($data['FRSPaymentInformation'], 'BesmartandPro\\Ups\\Api\\Model\\RateShipmentFRSPaymentInformation', 'json', $context));
            ...
            if (\array_key_exists('ShipmentTotalWeight', $data)) {
                $object->setShipmentTotalWeight($this->denormalizer->denormalize($data['ShipmentTotalWeight'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentShipmentTotalWeight', 'json', $context));
            ...
            if (\array_key_exists('Package', $data)) {
                ...
                foreach ($data['Package'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\Ups\\Api\\Model\\RateShipmentPackage', 'json', $context);
                }
                $object->setPackage($values_1);
                unset($data['Package']);
            }
            if (\array_key_exists('ShipmentServiceOptions', $data)) {
                $object->setShipmentServiceOptions($this->denormalizer->denormalize($data['ShipmentServiceOptions'], 'BesmartandPro\\Ups\\Api\\Model\\RateShipmentShipmentServiceOptions', 'json', $context));
            ...
            if (\array_key_exists('DeliveryTimeInformation', $data)) {
                $object->setDeliveryTimeInformation($this->denormalizer->denormalize($data['DeliveryTimeInformation'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentDeliveryTimeInformation', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\RateRequestShipment' => false];
        }
    }
} else {
    class RateRequestShipmentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
