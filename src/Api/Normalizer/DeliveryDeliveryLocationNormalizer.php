...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class DeliveryDeliveryLocationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\DeliveryDeliveryLocation';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\DeliveryDeliveryLocation';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\DeliveryDeliveryLocation();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('AddressArtifactFormat', $data)) {
                $object->setAddressArtifactFormat($this->denormalizer->denormalize($data['AddressArtifactFormat'], 'BesmartandPro\\Ups\\Api\\Model\\DeliveryLocationAddressArtifactFormat', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\DeliveryDeliveryLocation' => false];
        }
    }
} else {
    class DeliveryDeliveryLocationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
