...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class VoidShipmentResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\VoidShipmentResponse';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\VoidShipmentResponse';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\VoidShipmentResponse();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('Response', $data)) {
                $object->setResponse($this->denormalizer->denormalize($data['Response'], 'BesmartandPro\\Ups\\Api\\Model\\VoidShipmentResponseResponse', 'json', $context));
                unset($data['Response']);
            }
            if (\array_key_exists('SummaryResult', $data)) {
                $object->setSummaryResult($this->denormalizer->denormalize($data['SummaryResult'], 'BesmartandPro\\Ups\\Api\\Model\\VoidShipmentResponseSummaryResult', 'json', $context));
                unset($data['SummaryResult']);
            }
            if (\array_key_exists('PackageLevelResult', $data)) {
                $values = [];
                foreach ($data['PackageLevelResult'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\VoidShipmentResponsePackageLevelResult', 'json', $context);
                }
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\VoidShipmentResponse' => false];
        }
    }
} else {
    class VoidShipmentResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
