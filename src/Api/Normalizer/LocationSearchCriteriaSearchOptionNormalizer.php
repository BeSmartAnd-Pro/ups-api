...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class LocationSearchCriteriaSearchOptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\LocationSearchCriteriaSearchOption';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\LocationSearchCriteriaSearchOption';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\LocationSearchCriteriaSearchOption();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('OptionType', $data)) {
                $object->setOptionType($this->denormalizer->denormalize($data['OptionType'], 'BesmartandPro\\Ups\\Api\\Model\\SearchOptionOptionType', 'json', $context));
                unset($data['OptionType']);
            }
            if (\array_key_exists('OptionCode', $data)) {
                $values = [];
                foreach ($data['OptionCode'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\SearchOptionOptionCode', 'json', $context);
                }
                $object->setOptionCode($values);
                unset($data['OptionCode']);
            }
            if (\array_key_exists('Relation', $data)) {
                $object->setRelation($this->denormalizer->denormalize($data['Relation'], 'BesmartandPro\\Ups\\Api\\Model\\SearchOptionRelation', 'json', $context));
                unset($data['Relation']);
            }
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\LocationSearchCriteriaSearchOption' => false];
        }
    }
} else {
    class LocationSearchCriteriaSearchOptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
