...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class FreightRateResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\FreightRateResponse';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\FreightRateResponse';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\FreightRateResponse();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('Response', $data)) {
                $object->setResponse($this->denormalizer->denormalize($data['Response'], 'BesmartandPro\\Ups\\Api\\Model\\FreightRateResponseResponse', 'json', $context));
                unset($data['Response']);
            }
            if (\array_key_exists('Rate', $data)) {
                $values = [];
                foreach ($data['Rate'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\FreightRateResponseRate', 'json', $context);
                }
                $object->setRate($values);
                unset($data['Rate']);
            }
            if (\array_key_exists('FreightDensityRate', $data)) {
                $object->setFreightDensityRate($this->denormalizer->denormalize($data['FreightDensityRate'], 'BesmartandPro\\Ups\\Api\\Model\\FreightRateResponseFreightDensityRate', 'json', $context));
                unset($data['FreightDensityRate']);
            }
            if (\array_key_exists('Commodity', $data)) {
                $values_1 = [];
                foreach ($data['Commodity'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\Ups\\Api\\Model\\FreightRateResponseCommodity', 'json', $context);
                }
                $object->setCommodity($values_1);
                unset($data['Commodity']);
            }
            if (\array_key_exists('TotalShipmentCharge', $data)) {
                $object->setTotalShipmentCharge($this->denormalizer->denormalize($data['TotalShipmentCharge'], 'BesmartandPro\\Ups\\Api\\Model\\FreightRateResponseTotalShipmentCharge', 'json', $context));
                unset($data['TotalShipmentCharge']);
            }
            if (\array_key_exists('BillableShipmentWeight', $data)) {
                $object->setBillableShipmentWeight($this->denormalizer->denormalize($data['BillableShipmentWeight'], 'BesmartandPro\\Ups\\Api\\Model\\FreightRateResponseBillableShipmentWeight', 'json', $context));
                unset($data['BillableShipmentWeight']);
            }
            if (\array_key_exists('DimensionalWeight', $data)) {
                $object->setDimensionalWeight($this->denormalizer->denormalize($data['DimensionalWeight'], 'BesmartandPro\\Ups\\Api\\Model\\FreightRateResponseDimensionalWeight', 'json', $context));
                unset($data['DimensionalWeight']);
            }
            if (\array_key_exists('Service', $data)) {
                $object->setService($this->denormalizer->denormalize($data['Service'], 'BesmartandPro\\Ups\\Api\\Model\\FreightRateResponseService', 'json', $context));
                unset($data['Service']);
            }
            ...
            if (\array_key_exists('AlternateRatesResponse', $data)) {
                ...
                foreach ($data['AlternateRatesResponse'] as $value_2) {
                    $values_2[] = $this->denormalizer->denormalize($value_2, 'BesmartandPro\\Ups\\Api\\Model\\FreightRateResponseAlternateRatesResponse', 'json', $context);
                }
                $object->setAlternateRatesResponse($values_2);
                unset($data['AlternateRatesResponse']);
            }
            if (\array_key_exists('TimeInTransit', $data)) {
                $object->setTimeInTransit($this->denormalizer->denormalize($data['TimeInTransit'], 'BesmartandPro\\Ups\\Api\\Model\\FreightRateResponseTimeInTransit', 'json', $context));
                unset($data['TimeInTransit']);
            }
            if (\array_key_exists('HandlingUnits', $data)) {
                $object->setHandlingUnits($this->denormalizer->denormalize($data['HandlingUnits'], 'BesmartandPro\\Ups\\Api\\Model\\FreightRateResponseHandlingUnits', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\FreightRateResponse' => false];
        }
    }
} else {
    class FreightRateResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
