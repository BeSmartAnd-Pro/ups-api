...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SubscriptionEventsSubscriptionFileNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\SubscriptionEventsSubscriptionFile';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\SubscriptionEventsSubscriptionFile';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\SubscriptionEventsSubscriptionFile();
            ...
            if (\array_key_exists('StatusType', $data)) {
                $object->setStatusType($this->denormalizer->denormalize($data['StatusType'], 'BesmartandPro\\Ups\\Api\\Model\\SubscriptionFileStatusType', 'json', $context));
                unset($data['StatusType']);
            }
            if (\array_key_exists('Manifest', $data)) {
                $values = [];
                foreach ($data['Manifest'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\SubscriptionFileManifest', 'json', $context);
                }
            ...
            if (\array_key_exists('Origin', $data)) {
                ...
                foreach ($data['Origin'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\Ups\\Api\\Model\\SubscriptionFileOrigin', 'json', $context);
                }
            ...
            if (\array_key_exists('Exception', $data)) {
                ...
                foreach ($data['Exception'] as $value_2) {
                    $values_2[] = $this->denormalizer->denormalize($value_2, 'BesmartandPro\\Ups\\Api\\Model\\SubscriptionFileException', 'json', $context);
                }
            ...
            if (\array_key_exists('Delivery', $data)) {
                ...
                foreach ($data['Delivery'] as $value_3) {
                    $values_3[] = $this->denormalizer->denormalize($value_3, 'BesmartandPro\\Ups\\Api\\Model\\SubscriptionFileDelivery', 'json', $context);
                }
            ...
            if (\array_key_exists('Generic', $data)) {
                ...
                foreach ($data['Generic'] as $value_4) {
                    $values_4[] = $this->denormalizer->denormalize($value_4, 'BesmartandPro\\Ups\\Api\\Model\\SubscriptionFileGeneric', 'json', $context);
                }
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\SubscriptionEventsSubscriptionFile' => false];
        }
    }
} else {
    class SubscriptionEventsSubscriptionFileNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
