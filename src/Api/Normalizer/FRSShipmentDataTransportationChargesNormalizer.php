...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class FRSShipmentDataTransportationChargesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\FRSShipmentDataTransportationCharges';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\FRSShipmentDataTransportationCharges';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\FRSShipmentDataTransportationCharges();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('GrossCharge', $data)) {
                $object->setGrossCharge($this->denormalizer->denormalize($data['GrossCharge'], 'BesmartandPro\\Ups\\Api\\Model\\TransportationChargesGrossCharge', 'json', $context));
                unset($data['GrossCharge']);
            }
            if (\array_key_exists('DiscountAmount', $data)) {
                $object->setDiscountAmount($this->denormalizer->denormalize($data['DiscountAmount'], 'BesmartandPro\\Ups\\Api\\Model\\TransportationChargesDiscountAmount', 'json', $context));
            ...
            if (\array_key_exists('NetCharge', $data)) {
                $object->setNetCharge($this->denormalizer->denormalize($data['NetCharge'], 'BesmartandPro\\Ups\\Api\\Model\\TransportationChargesNetCharge', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\FRSShipmentDataTransportationCharges' => false];
        }
    }
} else {
    class FRSShipmentDataTransportationChargesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
