...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ServiceSummaryEstimatedArrivalNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\ServiceSummaryEstimatedArrival';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\ServiceSummaryEstimatedArrival';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\ServiceSummaryEstimatedArrival();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('Arrival', $data)) {
                $object->setArrival($this->denormalizer->denormalize($data['Arrival'], 'BesmartandPro\\Ups\\Api\\Model\\EstimatedArrivalArrival', 'json', $context));
                unset($data['Arrival']);
            }
            ...
            if (\array_key_exists('Pickup', $data)) {
                $object->setPickup($this->denormalizer->denormalize($data['Pickup'], 'BesmartandPro\\Ups\\Api\\Model\\EstimatedArrivalPickup', 'json', $context));
                unset($data['Pickup']);
            }
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\ServiceSummaryEstimatedArrival' => false];
        }
    }
} else {
    class ServiceSummaryEstimatedArrivalNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
