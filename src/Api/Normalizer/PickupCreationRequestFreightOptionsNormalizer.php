...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PickupCreationRequestFreightOptionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\PickupCreationRequestFreightOptions';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\PickupCreationRequestFreightOptions';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\PickupCreationRequestFreightOptions();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('ShipmentServiceOptions', $data)) {
                $object->setShipmentServiceOptions($this->denormalizer->denormalize($data['ShipmentServiceOptions'], 'BesmartandPro\\Ups\\Api\\Model\\FreightOptionsShipmentServiceOptions', 'json', $context));
            ...
            if (\array_key_exists('DestinationAddress', $data)) {
                $object->setDestinationAddress($this->denormalizer->denormalize($data['DestinationAddress'], 'BesmartandPro\\Ups\\Api\\Model\\FreightOptionsDestinationAddress', 'json', $context));
                unset($data['DestinationAddress']);
            }
            if (\array_key_exists('ShipmentDetail', $data)) {
                $object->setShipmentDetail($this->denormalizer->denormalize($data['ShipmentDetail'], 'BesmartandPro\\Ups\\Api\\Model\\FreightOptionsShipmentDetail', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\PickupCreationRequestFreightOptions' => false];
        }
    }
} else {
    class PickupCreationRequestFreightOptionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
