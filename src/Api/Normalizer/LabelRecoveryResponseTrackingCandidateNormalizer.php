...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class LabelRecoveryResponseTrackingCandidateNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\LabelRecoveryResponseTrackingCandidate';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\LabelRecoveryResponseTrackingCandidate';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\LabelRecoveryResponseTrackingCandidate();
            ...
            if (\array_key_exists('PickupDateRange', $data)) {
                $object->setPickupDateRange($this->denormalizer->denormalize($data['PickupDateRange'], 'BesmartandPro\\Ups\\Api\\Model\\TrackingCandidatePickupDateRange', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\LabelRecoveryResponseTrackingCandidate' => false];
        }
    }
} else {
    class LabelRecoveryResponseTrackingCandidateNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
