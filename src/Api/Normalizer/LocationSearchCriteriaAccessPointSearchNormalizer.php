...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class LocationSearchCriteriaAccessPointSearchNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\LocationSearchCriteriaAccessPointSearch';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\LocationSearchCriteriaAccessPointSearch';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\LocationSearchCriteriaAccessPointSearch();
            ...
            if (\array_key_exists('IncludeCriteria', $data)) {
                $object->setIncludeCriteria($this->denormalizer->denormalize($data['IncludeCriteria'], 'BesmartandPro\\Ups\\Api\\Model\\AccessPointSearchIncludeCriteria', 'json', $context));
                unset($data['IncludeCriteria']);
            }
            if (\array_key_exists('ExcludeFromResult', $data)) {
                $object->setExcludeFromResult($this->denormalizer->denormalize($data['ExcludeFromResult'], 'BesmartandPro\\Ups\\Api\\Model\\AccessPointSearchExcludeFromResult', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\LocationSearchCriteriaAccessPointSearch' => false];
        }
    }
} else {
    class LocationSearchCriteriaAccessPointSearchNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
