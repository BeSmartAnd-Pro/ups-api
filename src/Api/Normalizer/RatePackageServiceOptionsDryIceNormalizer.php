...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class RatePackageServiceOptionsDryIceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\RatePackageServiceOptionsDryIce';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\RatePackageServiceOptionsDryIce';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\RatePackageServiceOptionsDryIce();
            ...
            if (\array_key_exists('DryIceWeight', $data)) {
                $object->setDryIceWeight($this->denormalizer->denormalize($data['DryIceWeight'], 'BesmartandPro\\Ups\\Api\\Model\\DryIceDryIceWeight', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\RatePackageServiceOptionsDryIce' => false];
        }
    }
} else {
    class RatePackageServiceOptionsDryIceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
