...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PickupGetServiceCenterFacilitiesResponseResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\PickupGetServiceCenterFacilitiesResponseResponse';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\PickupGetServiceCenterFacilitiesResponseResponse';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\PickupGetServiceCenterFacilitiesResponseResponse();
            ...
            if (\array_key_exists('Alert', $data)) {
                $object->setAlert($this->denormalizer->denormalize($data['Alert'], 'BesmartandPro\\Ups\\Api\\Model\\ResponseAlert', 'json', $context));
                unset($data['Alert']);
            }
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\PickupGetServiceCenterFacilitiesResponseResponse' => false];
        }
    }
} else {
    class PickupGetServiceCenterFacilitiesResponseResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
