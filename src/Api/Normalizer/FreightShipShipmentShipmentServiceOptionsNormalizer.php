...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class FreightShipShipmentShipmentServiceOptionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\FreightShipShipmentShipmentServiceOptions';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\FreightShipShipmentShipmentServiceOptions';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\FreightShipShipmentShipmentServiceOptions();
            ...
            if (\array_key_exists('EMailInformation', $data)) {
                ...
                foreach ($data['EMailInformation'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\ShipmentServiceOptionsEMailInformation', 'json', $context);
                }
                $object->setEMailInformation($values);
                unset($data['EMailInformation']);
            }
            if (\array_key_exists('PickupOptions', $data)) {
                $object->setPickupOptions($this->denormalizer->denormalize($data['PickupOptions'], 'BesmartandPro\\Ups\\Api\\Model\\FreightShipmentServiceOptionsPickupOptions', 'json', $context));
                unset($data['PickupOptions']);
            }
            if (\array_key_exists('DeliveryOptions', $data)) {
                $object->setDeliveryOptions($this->denormalizer->denormalize($data['DeliveryOptions'], 'BesmartandPro\\Ups\\Api\\Model\\FreightShipmentServiceOptionsDeliveryOptions', 'json', $context));
                unset($data['DeliveryOptions']);
            }
            if (\array_key_exists('OverSeasLeg', $data)) {
                $object->setOverSeasLeg($this->denormalizer->denormalize($data['OverSeasLeg'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentServiceOptionsOverSeasLeg', 'json', $context));
                unset($data['OverSeasLeg']);
            }
            if (\array_key_exists('COD', $data)) {
                $object->setCOD($this->denormalizer->denormalize($data['COD'], 'BesmartandPro\\Ups\\Api\\Model\\FreightShipmentServiceOptionsCOD', 'json', $context));
                unset($data['COD']);
            }
            if (\array_key_exists('DangerousGoods', $data)) {
                $object->setDangerousGoods($this->denormalizer->denormalize($data['DangerousGoods'], 'BesmartandPro\\Ups\\Api\\Model\\FreightShipShipmentServiceOptionsDangerousGoods', 'json', $context));
                unset($data['DangerousGoods']);
            }
            if (\array_key_exists('SortingAndSegregating', $data)) {
                $object->setSortingAndSegregating($this->denormalizer->denormalize($data['SortingAndSegregating'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentServiceOptionsSortingAndSegregating', 'json', $context));
                unset($data['SortingAndSegregating']);
            }
            if (\array_key_exists('DeclaredValue', $data)) {
                $object->setDeclaredValue($this->denormalizer->denormalize($data['DeclaredValue'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentServiceOptionsDeclaredValue', 'json', $context));
                unset($data['DeclaredValue']);
            }
            if (\array_key_exists('ExcessDeclaredValue', $data)) {
                $object->setExcessDeclaredValue($this->denormalizer->denormalize($data['ExcessDeclaredValue'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentServiceOptionsExcessDeclaredValue', 'json', $context));
                unset($data['ExcessDeclaredValue']);
            }
            if (\array_key_exists('HandlingCharge', $data)) {
                $object->setHandlingCharge($this->denormalizer->denormalize($data['HandlingCharge'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentServiceOptionsHandlingCharge', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\FreightShipShipmentShipmentServiceOptions' => false];
        }
    }
} else {
    class FreightShipShipmentShipmentServiceOptionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
