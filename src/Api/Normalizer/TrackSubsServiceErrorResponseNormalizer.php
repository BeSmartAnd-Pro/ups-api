...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class TrackSubsServiceErrorResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\TrackSubsServiceErrorResponse';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\TrackSubsServiceErrorResponse';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\TrackSubsServiceErrorResponse();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('response', $data)) {
                $object->setResponse($this->denormalizer->denormalize($data['response'], 'BesmartandPro\\Ups\\Api\\Model\\ErrorResponseWrapper', 'json', $context));
                unset($data['response']);
            }
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\TrackSubsServiceErrorResponse' => false];
        }
    }
} else {
    class TrackSubsServiceErrorResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
