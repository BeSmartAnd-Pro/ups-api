...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class LandedCostResponseShipmentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\LandedCostResponseShipment';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\LandedCostResponseShipment';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\LandedCostResponseShipment();
            ...
            if (\array_key_exists('brokerageFeeItems', $data)) {
                ...
                foreach ($data['brokerageFeeItems'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\BrokerageFeeItems', 'json', $context);
                }
            ...
            if (\array_key_exists('shipmentItems', $data)) {
                ...
                foreach ($data['shipmentItems'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\Ups\\Api\\Model\\ResponseShipmentItems', 'json', $context);
                }
            ...
            if (\array_key_exists('perfStats', $data)) {
                $object->setPerfStats($this->denormalizer->denormalize($data['perfStats'], 'BesmartandPro\\Ups\\Api\\Model\\LandedCostResponseShipmentPerfStats', 'json', $context));
            ...
            if (\array_key_exists('errors', $data)) {
                $object->setErrors($this->denormalizer->denormalize($data['errors'], 'BesmartandPro\\Ups\\Api\\Model\\Errors', 'json', $context));
                unset($data['errors']);
            }
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\LandedCostResponseShipment' => false];
        }
    }
} else {
    class LandedCostResponseShipmentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
