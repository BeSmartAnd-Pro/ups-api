...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SubscriptionFileGenericNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\SubscriptionFileGeneric';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\SubscriptionFileGeneric';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\SubscriptionFileGeneric();
            ...
            if (\array_key_exists('ShipmentReferenceNumber', $data)) {
                ...
                foreach ($data['ShipmentReferenceNumber'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\GenericShipmentReferenceNumber', 'json', $context);
                }
            ...
            if (\array_key_exists('PackageReferenceNumber', $data)) {
                ...
                foreach ($data['PackageReferenceNumber'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\Ups\\Api\\Model\\GenericPackageReferenceNumber', 'json', $context);
                }
                $object->setPackageReferenceNumber($values_1);
                unset($data['PackageReferenceNumber']);
            }
            if (\array_key_exists('Service', $data)) {
                $object->setService($this->denormalizer->denormalize($data['Service'], 'BesmartandPro\\Ups\\Api\\Model\\GenericService', 'json', $context));
                unset($data['Service']);
            }
            if (\array_key_exists('Activity', $data)) {
                $object->setActivity($this->denormalizer->denormalize($data['Activity'], 'BesmartandPro\\Ups\\Api\\Model\\GenericActivity', 'json', $context));
                unset($data['Activity']);
            }
            if (\array_key_exists('BillToAccount', $data)) {
                $object->setBillToAccount($this->denormalizer->denormalize($data['BillToAccount'], 'BesmartandPro\\Ups\\Api\\Model\\GenericBillToAccount', 'json', $context));
                unset($data['BillToAccount']);
            }
            if (\array_key_exists('ShipTo', $data)) {
                $object->setShipTo($this->denormalizer->denormalize($data['ShipTo'], 'BesmartandPro\\Ups\\Api\\Model\\GenericShipTo', 'json', $context));
                unset($data['ShipTo']);
            }
            ...
            if (\array_key_exists('FailureNotification', $data)) {
                $object->setFailureNotification($this->denormalizer->denormalize($data['FailureNotification'], 'BesmartandPro\\Ups\\Api\\Model\\GenericFailureNotification', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\SubscriptionFileGeneric' => false];
        }
    }
} else {
    class SubscriptionFileGenericNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
