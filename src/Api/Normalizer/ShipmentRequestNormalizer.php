...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ShipmentRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\ShipmentRequest';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\ShipmentRequest';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\ShipmentRequest();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('Request', $data)) {
                $object->setRequest($this->denormalizer->denormalize($data['Request'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentRequestRequest', 'json', $context));
                unset($data['Request']);
            }
            if (\array_key_exists('Shipment', $data)) {
                $object->setShipment($this->denormalizer->denormalize($data['Shipment'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentRequestShipment', 'json', $context));
                unset($data['Shipment']);
            }
            if (\array_key_exists('LabelSpecification', $data)) {
                $object->setLabelSpecification($this->denormalizer->denormalize($data['LabelSpecification'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentRequestLabelSpecification', 'json', $context));
                unset($data['LabelSpecification']);
            }
            if (\array_key_exists('ReceiptSpecification', $data)) {
                $object->setReceiptSpecification($this->denormalizer->denormalize($data['ReceiptSpecification'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentRequestReceiptSpecification', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\ShipmentRequest' => false];
        }
    }
} else {
    class ShipmentRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
