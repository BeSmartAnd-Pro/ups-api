...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class QuantumViewEventsSubscriptionEventsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\QuantumViewEventsSubscriptionEvents';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\QuantumViewEventsSubscriptionEvents';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\QuantumViewEventsSubscriptionEvents();
            ...
            if (\array_key_exists('SubscriptionStatus', $data)) {
                $object->setSubscriptionStatus($this->denormalizer->denormalize($data['SubscriptionStatus'], 'BesmartandPro\\Ups\\Api\\Model\\SubscriptionEventsSubscriptionStatus', 'json', $context));
                unset($data['SubscriptionStatus']);
            }
            if (\array_key_exists('DateRange', $data)) {
                $object->setDateRange($this->denormalizer->denormalize($data['DateRange'], 'BesmartandPro\\Ups\\Api\\Model\\SubscriptionEventsDateRange', 'json', $context));
                unset($data['DateRange']);
            }
            if (\array_key_exists('SubscriptionFile', $data)) {
                $values = [];
                foreach ($data['SubscriptionFile'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\SubscriptionEventsSubscriptionFile', 'json', $context);
                }
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\QuantumViewEventsSubscriptionEvents' => false];
        }
    }
} else {
    class QuantumViewEventsSubscriptionEventsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
