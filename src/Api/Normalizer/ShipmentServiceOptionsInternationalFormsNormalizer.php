...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ShipmentServiceOptionsInternationalFormsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\ShipmentServiceOptionsInternationalForms';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\ShipmentServiceOptionsInternationalForms';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\ShipmentServiceOptionsInternationalForms();
            ...
            if (\array_key_exists('UserCreatedForm', $data)) {
                $object->setUserCreatedForm($this->denormalizer->denormalize($data['UserCreatedForm'], 'BesmartandPro\\Ups\\Api\\Model\\InternationalFormsUserCreatedForm', 'json', $context));
                unset($data['UserCreatedForm']);
            }
            if (\array_key_exists('UPSPremiumCareForm', $data)) {
                $object->setUPSPremiumCareForm($this->denormalizer->denormalize($data['UPSPremiumCareForm'], 'BesmartandPro\\Ups\\Api\\Model\\InternationalFormsUPSPremiumCareForm', 'json', $context));
                unset($data['UPSPremiumCareForm']);
            }
            if (\array_key_exists('CN22Form', $data)) {
                $object->setCN22Form($this->denormalizer->denormalize($data['CN22Form'], 'BesmartandPro\\Ups\\Api\\Model\\InternationalFormsCN22Form', 'json', $context));
                unset($data['CN22Form']);
            }
            ...
            if (\array_key_exists('EEIFilingOption', $data)) {
                $object->setEEIFilingOption($this->denormalizer->denormalize($data['EEIFilingOption'], 'BesmartandPro\\Ups\\Api\\Model\\InternationalFormsEEIFilingOption', 'json', $context));
                unset($data['EEIFilingOption']);
            }
            if (\array_key_exists('Contacts', $data)) {
                $object->setContacts($this->denormalizer->denormalize($data['Contacts'], 'BesmartandPro\\Ups\\Api\\Model\\InternationalFormsContacts', 'json', $context));
                unset($data['Contacts']);
            }
            if (\array_key_exists('Product', $data)) {
                $values_1 = [];
                foreach ($data['Product'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\Ups\\Api\\Model\\InternationalFormsProduct', 'json', $context);
                }
            ...
            if (\array_key_exists('Discount', $data)) {
                $object->setDiscount($this->denormalizer->denormalize($data['Discount'], 'BesmartandPro\\Ups\\Api\\Model\\InternationalFormsDiscount', 'json', $context));
                unset($data['Discount']);
            }
            if (\array_key_exists('FreightCharges', $data)) {
                $object->setFreightCharges($this->denormalizer->denormalize($data['FreightCharges'], 'BesmartandPro\\Ups\\Api\\Model\\InternationalFormsFreightCharges', 'json', $context));
                unset($data['FreightCharges']);
            }
            if (\array_key_exists('InsuranceCharges', $data)) {
                $object->setInsuranceCharges($this->denormalizer->denormalize($data['InsuranceCharges'], 'BesmartandPro\\Ups\\Api\\Model\\InternationalFormsInsuranceCharges', 'json', $context));
                unset($data['InsuranceCharges']);
            }
            if (\array_key_exists('OtherCharges', $data)) {
                $object->setOtherCharges($this->denormalizer->denormalize($data['OtherCharges'], 'BesmartandPro\\Ups\\Api\\Model\\InternationalFormsOtherCharges', 'json', $context));
            ...
            if (\array_key_exists('BlanketPeriod', $data)) {
                $object->setBlanketPeriod($this->denormalizer->denormalize($data['BlanketPeriod'], 'BesmartandPro\\Ups\\Api\\Model\\InternationalFormsBlanketPeriod', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\ShipmentServiceOptionsInternationalForms' => false];
        }
    }
} else {
    class ShipmentServiceOptionsInternationalFormsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
