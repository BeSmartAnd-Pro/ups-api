...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class FreightPickupRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\FreightPickupRequest';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\FreightPickupRequest';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\FreightPickupRequest();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('Request', $data)) {
                $object->setRequest($this->denormalizer->denormalize($data['Request'], 'BesmartandPro\\Ups\\Api\\Model\\FreightPickupRequestRequest', 'json', $context));
                unset($data['Request']);
            }
            ...
            if (\array_key_exists('Requester', $data)) {
                $object->setRequester($this->denormalizer->denormalize($data['Requester'], 'BesmartandPro\\Ups\\Api\\Model\\FreightPickupRequestRequester', 'json', $context));
                unset($data['Requester']);
            }
            if (\array_key_exists('ShipFrom', $data)) {
                $object->setShipFrom($this->denormalizer->denormalize($data['ShipFrom'], 'BesmartandPro\\Ups\\Api\\Model\\FreightPickupRequestShipFrom', 'json', $context));
                unset($data['ShipFrom']);
            }
            if (\array_key_exists('ShipTo', $data)) {
                $object->setShipTo($this->denormalizer->denormalize($data['ShipTo'], 'BesmartandPro\\Ups\\Api\\Model\\FreightPickupRequestShipTo', 'json', $context));
                unset($data['ShipTo']);
            }
            ...
            if (\array_key_exists('ShipmentServiceOptions', $data)) {
                $object->setShipmentServiceOptions($this->denormalizer->denormalize($data['ShipmentServiceOptions'], 'BesmartandPro\\Ups\\Api\\Model\\FreightPickupRequestShipmentServiceOptions', 'json', $context));
                unset($data['ShipmentServiceOptions']);
            }
            if (\array_key_exists('ShipmentDetail', $data)) {
                $values = [];
                foreach ($data['ShipmentDetail'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\FreightPickupRequestShipmentDetail', 'json', $context);
                }
                $object->setShipmentDetail($values);
                unset($data['ShipmentDetail']);
            }
            if (\array_key_exists('ExistingShipmentID', $data)) {
                $object->setExistingShipmentID($this->denormalizer->denormalize($data['ExistingShipmentID'], 'BesmartandPro\\Ups\\Api\\Model\\FreightPickupRequestExistingShipmentID', 'json', $context));
                unset($data['ExistingShipmentID']);
            }
            if (\array_key_exists('POM', $data)) {
                $object->setPOM($this->denormalizer->denormalize($data['POM'], 'BesmartandPro\\Ups\\Api\\Model\\FreightPickupRequestPOM', 'json', $context));
                unset($data['POM']);
            }
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\FreightPickupRequest' => false];
        }
    }
} else {
    class FreightPickupRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
