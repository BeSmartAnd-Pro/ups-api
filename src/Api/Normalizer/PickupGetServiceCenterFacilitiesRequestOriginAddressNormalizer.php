...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PickupGetServiceCenterFacilitiesRequestOriginAddressNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\PickupGetServiceCenterFacilitiesRequestOriginAddress';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\PickupGetServiceCenterFacilitiesRequestOriginAddress';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\PickupGetServiceCenterFacilitiesRequestOriginAddress();
            ...
            if (\array_key_exists('OriginSearchCriteria', $data)) {
                $object->setOriginSearchCriteria($this->denormalizer->denormalize($data['OriginSearchCriteria'], 'BesmartandPro\\Ups\\Api\\Model\\OriginAddressOriginSearchCriteria', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\PickupGetServiceCenterFacilitiesRequestOriginAddress' => false];
        }
    }
} else {
    class PickupGetServiceCenterFacilitiesRequestOriginAddressNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
