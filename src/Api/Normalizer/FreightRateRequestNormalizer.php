...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class FreightRateRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\FreightRateRequest';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\FreightRateRequest';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\FreightRateRequest();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('Request', $data)) {
                $object->setRequest($this->denormalizer->denormalize($data['Request'], 'BesmartandPro\\Ups\\Api\\Model\\FreightRateRequestRequest', 'json', $context));
                unset($data['Request']);
            }
            if (\array_key_exists('ShipFrom', $data)) {
                $object->setShipFrom($this->denormalizer->denormalize($data['ShipFrom'], 'BesmartandPro\\Ups\\Api\\Model\\FreightRateRequestShipFrom', 'json', $context));
                unset($data['ShipFrom']);
            }
            if (\array_key_exists('ShipTo', $data)) {
                $object->setShipTo($this->denormalizer->denormalize($data['ShipTo'], 'BesmartandPro\\Ups\\Api\\Model\\FreightRateRequestShipTo', 'json', $context));
                unset($data['ShipTo']);
            }
            if (\array_key_exists('PaymentInformation', $data)) {
                $object->setPaymentInformation($this->denormalizer->denormalize($data['PaymentInformation'], 'BesmartandPro\\Ups\\Api\\Model\\FreightRateRequestPaymentInformation', 'json', $context));
                unset($data['PaymentInformation']);
            }
            if (\array_key_exists('Service', $data)) {
                $object->setService($this->denormalizer->denormalize($data['Service'], 'BesmartandPro\\Ups\\Api\\Model\\FreightRateRequestService', 'json', $context));
                unset($data['Service']);
            }
            if (\array_key_exists('HandlingUnitOne', $data)) {
                $object->setHandlingUnitOne($this->denormalizer->denormalize($data['HandlingUnitOne'], 'BesmartandPro\\Ups\\Api\\Model\\FreightRateRequestHandlingUnitOne', 'json', $context));
                unset($data['HandlingUnitOne']);
            }
            if (\array_key_exists('HandlingUnitTwo', $data)) {
                $object->setHandlingUnitTwo($this->denormalizer->denormalize($data['HandlingUnitTwo'], 'BesmartandPro\\Ups\\Api\\Model\\FreightRateRequestHandlingUnitTwo', 'json', $context));
                unset($data['HandlingUnitTwo']);
            }
            if (\array_key_exists('Commodity', $data)) {
                $values = [];
                foreach ($data['Commodity'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\FreightRateRequestCommodity', 'json', $context);
                }
                $object->setCommodity($values);
                unset($data['Commodity']);
            }
            if (\array_key_exists('ShipmentServiceOptions', $data)) {
                $object->setShipmentServiceOptions($this->denormalizer->denormalize($data['ShipmentServiceOptions'], 'BesmartandPro\\Ups\\Api\\Model\\FreightRateRequestShipmentServiceOptions', 'json', $context));
                unset($data['ShipmentServiceOptions']);
            }
            if (\array_key_exists('PickupRequest', $data)) {
                $object->setPickupRequest($this->denormalizer->denormalize($data['PickupRequest'], 'BesmartandPro\\Ups\\Api\\Model\\FreightRateRequestPickupRequest', 'json', $context));
                unset($data['PickupRequest']);
            }
            if (\array_key_exists('AlternateRateOptions', $data)) {
                $object->setAlternateRateOptions($this->denormalizer->denormalize($data['AlternateRateOptions'], 'BesmartandPro\\Ups\\Api\\Model\\FreightRateRequestAlternateRateOptions', 'json', $context));
                unset($data['AlternateRateOptions']);
            }
            if (\array_key_exists('GFPOptions', $data)) {
                $object->setGFPOptions($this->denormalizer->denormalize($data['GFPOptions'], 'BesmartandPro\\Ups\\Api\\Model\\FreightRateRequestGFPOptions', 'json', $context));
                unset($data['GFPOptions']);
            }
            if (\array_key_exists('HandlingUnitWeight', $data)) {
                $object->setHandlingUnitWeight($this->denormalizer->denormalize($data['HandlingUnitWeight'], 'BesmartandPro\\Ups\\Api\\Model\\FreightRateRequestHandlingUnitWeight', 'json', $context));
            ...
            if (\array_key_exists('HandlingUnits', $data)) {
                ...
                foreach ($data['HandlingUnits'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\Ups\\Api\\Model\\FreightRateRequestHandlingUnits', 'json', $context);
                }
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\FreightRateRequest' => false];
        }
    }
} else {
    class FreightRateRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
