...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PackageNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\Package';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\Package';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\Package();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('accessPointInformation', $data)) {
                $object->setAccessPointInformation($this->denormalizer->denormalize($data['accessPointInformation'], 'BesmartandPro\\Ups\\Api\\Model\\AccessPointInformation', 'json', $context));
                unset($data['accessPointInformation']);
            }
            if (\array_key_exists('activity', $data)) {
                $values = [];
                foreach ($data['activity'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\Activity', 'json', $context);
                }
            ...
            if (\array_key_exists('alternateTrackingNumber', $data)) {
                ...
                foreach ($data['alternateTrackingNumber'] as $value_3) {
                    $values_3[] = $this->denormalizer->denormalize($value_3, 'BesmartandPro\\Ups\\Api\\Model\\AlternateTrackingNumber', 'json', $context);
                }
                $object->setAlternateTrackingNumber($values_3);
                unset($data['alternateTrackingNumber']);
            }
            if (\array_key_exists('currentStatus', $data)) {
                $object->setCurrentStatus($this->denormalizer->denormalize($data['currentStatus'], 'BesmartandPro\\Ups\\Api\\Model\\Status', 'json', $context));
                unset($data['currentStatus']);
            }
            if (\array_key_exists('deliveryDate', $data)) {
                $values_4 = [];
                foreach ($data['deliveryDate'] as $value_4) {
                    $values_4[] = $this->denormalizer->denormalize($value_4, 'BesmartandPro\\Ups\\Api\\Model\\DeliveryDate', 'json', $context);
                }
                $object->setDeliveryDate($values_4);
                unset($data['deliveryDate']);
            }
            if (\array_key_exists('deliveryInformation', $data)) {
                $object->setDeliveryInformation($this->denormalizer->denormalize($data['deliveryInformation'], 'BesmartandPro\\Ups\\Api\\Model\\DeliveryInformation', 'json', $context));
                unset($data['deliveryInformation']);
            }
            if (\array_key_exists('deliveryTime', $data)) {
                $object->setDeliveryTime($this->denormalizer->denormalize($data['deliveryTime'], 'BesmartandPro\\Ups\\Api\\Model\\DeliveryTime', 'json', $context));
                unset($data['deliveryTime']);
            }
            if (\array_key_exists('milestones', $data)) {
                $values_5 = [];
                foreach ($data['milestones'] as $value_5) {
                    $values_5[] = $this->denormalizer->denormalize($value_5, 'BesmartandPro\\Ups\\Api\\Model\\Milestones', 'json', $context);
                }
            ...
            if (\array_key_exists('packageAddress', $data)) {
                ...
                foreach ($data['packageAddress'] as $value_6) {
                    $values_6[] = $this->denormalizer->denormalize($value_6, 'BesmartandPro\\Ups\\Api\\Model\\PackageAddress', 'json', $context);
                }
            ...
            if (\array_key_exists('paymentInformation', $data)) {
                ...
                foreach ($data['paymentInformation'] as $value_7) {
                    $values_7[] = $this->denormalizer->denormalize($value_7, 'BesmartandPro\\Ups\\Api\\Model\\PaymentInformation', 'json', $context);
                }
            ...
            if (\array_key_exists('referenceNumber', $data)) {
                ...
                foreach ($data['referenceNumber'] as $value_8) {
                    $values_8[] = $this->denormalizer->denormalize($value_8, 'BesmartandPro\\Ups\\Api\\Model\\ReferenceNumber', 'json', $context);
                }
                $object->setReferenceNumber($values_8);
                unset($data['referenceNumber']);
            }
            if (\array_key_exists('service', $data)) {
                $object->setService($this->denormalizer->denormalize($data['service'], 'BesmartandPro\\Ups\\Api\\Model\\Service', 'json', $context));
                unset($data['service']);
            }
            ...
            if (\array_key_exists('weight', $data) && $data['weight'] !== null) {
                $object->setWeight($this->denormalizer->denormalize($data['weight'], 'BesmartandPro\\Ups\\Api\\Model\\Weight', 'json', $context));
                unset($data['weight']);
            }
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\Package' => false];
        }
    }
} else {
    class PackageNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
