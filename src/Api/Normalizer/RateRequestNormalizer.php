...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class RateRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\RateRequest';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\RateRequest';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\RateRequest();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('Request', $data)) {
                $object->setRequest($this->denormalizer->denormalize($data['Request'], 'BesmartandPro\\Ups\\Api\\Model\\RateRequestRequest', 'json', $context));
                unset($data['Request']);
            }
            if (\array_key_exists('PickupType', $data)) {
                $object->setPickupType($this->denormalizer->denormalize($data['PickupType'], 'BesmartandPro\\Ups\\Api\\Model\\RateRequestPickupType', 'json', $context));
                unset($data['PickupType']);
            }
            if (\array_key_exists('CustomerClassification', $data)) {
                $object->setCustomerClassification($this->denormalizer->denormalize($data['CustomerClassification'], 'BesmartandPro\\Ups\\Api\\Model\\RateRequestCustomerClassification', 'json', $context));
                unset($data['CustomerClassification']);
            }
            if (\array_key_exists('Shipment', $data)) {
                $object->setShipment($this->denormalizer->denormalize($data['Shipment'], 'BesmartandPro\\Ups\\Api\\Model\\RateRequestShipment', 'json', $context));
                unset($data['Shipment']);
            }
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\RateRequest' => false];
        }
    }
} else {
    class RateRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
