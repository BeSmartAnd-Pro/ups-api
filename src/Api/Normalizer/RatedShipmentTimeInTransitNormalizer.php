...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class RatedShipmentTimeInTransitNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\RatedShipmentTimeInTransit';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\RatedShipmentTimeInTransit';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\RatedShipmentTimeInTransit();
            ...
            if (\array_key_exists('ServiceSummary', $data)) {
                $object->setServiceSummary($this->denormalizer->denormalize($data['ServiceSummary'], 'BesmartandPro\\Ups\\Api\\Model\\TimeInTransitServiceSummary', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\RatedShipmentTimeInTransit' => false];
        }
    }
} else {
    class RatedShipmentTimeInTransitNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
