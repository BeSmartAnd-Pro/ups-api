...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ProductEEIInformationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\ProductEEIInformation';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\ProductEEIInformation';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\ProductEEIInformation();
            ...
            if (\array_key_exists('License', $data)) {
                $object->setLicense($this->denormalizer->denormalize($data['License'], 'BesmartandPro\\Ups\\Api\\Model\\EEIInformationLicense', 'json', $context));
                unset($data['License']);
            }
            if (\array_key_exists('DDTCInformation', $data)) {
                $object->setDDTCInformation($this->denormalizer->denormalize($data['DDTCInformation'], 'BesmartandPro\\Ups\\Api\\Model\\EEIInformationDDTCInformation', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\ProductEEIInformation' => false];
        }
    }
} else {
    class ProductEEIInformationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
