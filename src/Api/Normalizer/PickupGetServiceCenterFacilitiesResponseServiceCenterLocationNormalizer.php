...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PickupGetServiceCenterFacilitiesResponseServiceCenterLocationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\PickupGetServiceCenterFacilitiesResponseServiceCenterLocation';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\PickupGetServiceCenterFacilitiesResponseServiceCenterLocation';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\PickupGetServiceCenterFacilitiesResponseServiceCenterLocation();
            ...
            if (\array_key_exists('DropOffFacilities', $data)) {
                ...
                foreach ($data['DropOffFacilities'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\ServiceCenterLocationDropOffFacilities', 'json', $context);
                }
                $object->setDropOffFacilities($values);
                unset($data['DropOffFacilities']);
            }
            if (\array_key_exists('PickupFacilities', $data)) {
                $object->setPickupFacilities($this->denormalizer->denormalize($data['PickupFacilities'], 'BesmartandPro\\Ups\\Api\\Model\\ServiceCenterLocationPickupFacilities', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\PickupGetServiceCenterFacilitiesResponseServiceCenterLocation' => false];
        }
    }
} else {
    class PickupGetServiceCenterFacilitiesResponseServiceCenterLocationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
