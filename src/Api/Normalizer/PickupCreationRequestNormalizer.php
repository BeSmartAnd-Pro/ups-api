...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PickupCreationRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\PickupCreationRequest';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\PickupCreationRequest';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\PickupCreationRequest();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('Request', $data)) {
                $object->setRequest($this->denormalizer->denormalize($data['Request'], 'BesmartandPro\\Ups\\Api\\Model\\PickupCreationRequestRequest', 'json', $context));
                unset($data['Request']);
            }
            ...
            if (\array_key_exists('Shipper', $data)) {
                $object->setShipper($this->denormalizer->denormalize($data['Shipper'], 'BesmartandPro\\Ups\\Api\\Model\\PickupCreationRequestShipper', 'json', $context));
                unset($data['Shipper']);
            }
            if (\array_key_exists('PickupDateInfo', $data)) {
                $object->setPickupDateInfo($this->denormalizer->denormalize($data['PickupDateInfo'], 'BesmartandPro\\Ups\\Api\\Model\\PickupCreationRequestPickupDateInfo', 'json', $context));
                unset($data['PickupDateInfo']);
            }
            if (\array_key_exists('PickupAddress', $data)) {
                $object->setPickupAddress($this->denormalizer->denormalize($data['PickupAddress'], 'BesmartandPro\\Ups\\Api\\Model\\PickupCreationRequestPickupAddress', 'json', $context));
            ...
            if (\array_key_exists('PickupPiece', $data)) {
                ...
                foreach ($data['PickupPiece'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\PickupCreationRequestPickupPiece', 'json', $context);
                }
                $object->setPickupPiece($values);
                unset($data['PickupPiece']);
            }
            if (\array_key_exists('TotalWeight', $data)) {
                $object->setTotalWeight($this->denormalizer->denormalize($data['TotalWeight'], 'BesmartandPro\\Ups\\Api\\Model\\PickupCreationRequestTotalWeight', 'json', $context));
            ...
            if (\array_key_exists('TrackingData', $data)) {
                ...
                foreach ($data['TrackingData'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\Ups\\Api\\Model\\PickupCreationRequestTrackingData', 'json', $context);
                }
                $object->setTrackingData($values_1);
                unset($data['TrackingData']);
            }
            if (\array_key_exists('TrackingDataWithReferenceNumber', $data)) {
                $object->setTrackingDataWithReferenceNumber($this->denormalizer->denormalize($data['TrackingDataWithReferenceNumber'], 'BesmartandPro\\Ups\\Api\\Model\\PickupCreationRequestTrackingDataWithReferenceNumber', 'json', $context));
            ...
            if (\array_key_exists('FreightOptions', $data)) {
                $object->setFreightOptions($this->denormalizer->denormalize($data['FreightOptions'], 'BesmartandPro\\Ups\\Api\\Model\\PickupCreationRequestFreightOptions', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\PickupCreationRequest' => false];
        }
    }
} else {
    class PickupCreationRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
