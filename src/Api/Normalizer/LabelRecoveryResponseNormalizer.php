...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class LabelRecoveryResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\LabelRecoveryResponse';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\LabelRecoveryResponse';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\LabelRecoveryResponse();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('Response', $data)) {
                $object->setResponse($this->denormalizer->denormalize($data['Response'], 'BesmartandPro\\Ups\\Api\\Model\\LabelRecoveryResponseResponse', 'json', $context));
                unset($data['Response']);
            }
            ...
            if (\array_key_exists('LabelResults', $data)) {
                ...
                foreach ($data['LabelResults'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\LabelRecoveryResponseLabelResults', 'json', $context);
                }
                $object->setLabelResults($values);
                unset($data['LabelResults']);
            }
            if (\array_key_exists('CODTurnInPage', $data)) {
                $object->setCODTurnInPage($this->denormalizer->denormalize($data['CODTurnInPage'], 'BesmartandPro\\Ups\\Api\\Model\\LabelRecoveryResponseCODTurnInPage', 'json', $context));
                unset($data['CODTurnInPage']);
            }
            if (\array_key_exists('Form', $data)) {
                $object->setForm($this->denormalizer->denormalize($data['Form'], 'BesmartandPro\\Ups\\Api\\Model\\LabelRecoveryResponseForm', 'json', $context));
                unset($data['Form']);
            }
            if (\array_key_exists('HighValueReport', $data)) {
                $object->setHighValueReport($this->denormalizer->denormalize($data['HighValueReport'], 'BesmartandPro\\Ups\\Api\\Model\\LabelRecoveryResponseHighValueReport', 'json', $context));
                unset($data['HighValueReport']);
            }
            if (\array_key_exists('TrackingCandidate', $data)) {
                $values_1 = [];
                foreach ($data['TrackingCandidate'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\Ups\\Api\\Model\\LabelRecoveryResponseTrackingCandidate', 'json', $context);
                }
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\LabelRecoveryResponse' => false];
        }
    }
} else {
    class LabelRecoveryResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
