...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ShipmentResultsNegotiatedRateChargesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\ShipmentResultsNegotiatedRateCharges';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\ShipmentResultsNegotiatedRateCharges';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\ShipmentResultsNegotiatedRateCharges();
            ...
            if (\array_key_exists('ItemizedCharges', $data)) {
                ...
                foreach ($data['ItemizedCharges'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\NegotiatedRateChargesItemizedCharges', 'json', $context);
                }
            ...
            if (\array_key_exists('TaxCharges', $data)) {
                ...
                foreach ($data['TaxCharges'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\Ups\\Api\\Model\\NegotiatedRateChargesTaxCharges', 'json', $context);
                }
                $object->setTaxCharges($values_1);
                unset($data['TaxCharges']);
            }
            if (\array_key_exists('TotalCharge', $data)) {
                $object->setTotalCharge($this->denormalizer->denormalize($data['TotalCharge'], 'BesmartandPro\\Ups\\Api\\Model\\NegotiatedRateChargesTotalCharge', 'json', $context));
                unset($data['TotalCharge']);
            }
            if (\array_key_exists('TotalChargesWithTaxes', $data)) {
                $object->setTotalChargesWithTaxes($this->denormalizer->denormalize($data['TotalChargesWithTaxes'], 'BesmartandPro\\Ups\\Api\\Model\\NegotiatedRateChargesTotalChargesWithTaxes', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\ShipmentResultsNegotiatedRateCharges' => false];
        }
    }
} else {
    class ShipmentResultsNegotiatedRateChargesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
