...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class TimeInTransitResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\TimeInTransitResponse';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\TimeInTransitResponse';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\TimeInTransitResponse();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('validationList', $data)) {
                $object->setValidationList($this->denormalizer->denormalize($data['validationList'], 'BesmartandPro\\Ups\\Api\\Model\\ValidationList', 'json', $context));
                unset($data['validationList']);
            }
            if (\array_key_exists('destinationPickList', $data)) {
                $values = [];
                foreach ($data['destinationPickList'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\CandidateAddress', 'json', $context);
                }
            ...
            if (\array_key_exists('originPickList', $data)) {
                ...
                foreach ($data['originPickList'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\Ups\\Api\\Model\\CandidateAddress', 'json', $context);
                }
                $object->setOriginPickList($values_1);
                unset($data['originPickList']);
            }
            if (\array_key_exists('emsResponse', $data)) {
                $object->setEmsResponse($this->denormalizer->denormalize($data['emsResponse'], 'BesmartandPro\\Ups\\Api\\Model\\EmsResponse', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\TimeInTransitResponse' => false];
        }
    }
} else {
    class TimeInTransitResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
