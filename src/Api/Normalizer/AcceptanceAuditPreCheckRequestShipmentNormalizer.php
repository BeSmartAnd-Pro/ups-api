...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class AcceptanceAuditPreCheckRequestShipmentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\AcceptanceAuditPreCheckRequestShipment';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\AcceptanceAuditPreCheckRequestShipment';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\AcceptanceAuditPreCheckRequestShipment();
            ...
            if (\array_key_exists('ShipFromAddress', $data)) {
                $object->setShipFromAddress($this->denormalizer->denormalize($data['ShipFromAddress'], 'BesmartandPro\\Ups\\Api\\Model\\AcceptanceAuditPreCheckShipmentShipFromAddress', 'json', $context));
                unset($data['ShipFromAddress']);
            }
            if (\array_key_exists('ShipToAddress', $data)) {
                $object->setShipToAddress($this->denormalizer->denormalize($data['ShipToAddress'], 'BesmartandPro\\Ups\\Api\\Model\\AcceptanceAuditPreCheckShipmentShipToAddress', 'json', $context));
            ...
            if (\array_key_exists('Package', $data)) {
                ...
                foreach ($data['Package'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\AcceptanceAuditPreCheckShipmentPackage', 'json', $context);
                }
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\AcceptanceAuditPreCheckRequestShipment' => false];
        }
    }
} else {
    class AcceptanceAuditPreCheckRequestShipmentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
