...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ShipmentResponseShipmentResultsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\ShipmentResponseShipmentResults';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\ShipmentResponseShipmentResults';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\ShipmentResponseShipmentResults();
            ...
            if (\array_key_exists('Disclaimer', $data)) {
                ...
                foreach ($data['Disclaimer'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\ShipmentResultsDisclaimer', 'json', $context);
                }
                $object->setDisclaimer($values);
                unset($data['Disclaimer']);
            }
            if (\array_key_exists('ShipmentCharges', $data)) {
                $object->setShipmentCharges($this->denormalizer->denormalize($data['ShipmentCharges'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentResultsShipmentCharges', 'json', $context));
                unset($data['ShipmentCharges']);
            }
            if (\array_key_exists('NegotiatedRateCharges', $data) && $data['NegotiatedRateCharges'] !== null) {
                $object->setNegotiatedRateCharges($this->denormalizer->denormalize($data['NegotiatedRateCharges'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentResultsNegotiatedRateCharges', 'json', $context));
            ...
            if (\array_key_exists('FRSShipmentData', $data) && $data['FRSShipmentData'] !== null) {
                $object->setFRSShipmentData($this->denormalizer->denormalize($data['FRSShipmentData'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentResultsFRSShipmentData', 'json', $context));
            ...
            if (\array_key_exists('BillingWeight', $data)) {
                $object->setBillingWeight($this->denormalizer->denormalize($data['BillingWeight'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentResultsBillingWeight', 'json', $context));
            ...
            if (\array_key_exists('PackageResults', $data) && $data['PackageResults'] !== null) {
                ...
                foreach ($data['PackageResults'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\Ups\\Api\\Model\\ShipmentResultsPackageResults', 'json', $context);
                }
            ...
            if (\array_key_exists('ControlLogReceipt', $data) && $data['ControlLogReceipt'] !== null) {
                ...
                foreach ($data['ControlLogReceipt'] as $value_2) {
                    $values_2[] = $this->denormalizer->denormalize($value_2, 'BesmartandPro\\Ups\\Api\\Model\\ShipmentResultsControlLogReceipt', 'json', $context);
                }
            ...
            if (\array_key_exists('Form', $data) && $data['Form'] !== null) {
                $object->setForm($this->denormalizer->denormalize($data['Form'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentResultsForm', 'json', $context));
                unset($data['Form']);
            }
            ...
            if (\array_key_exists('CODTurnInPage', $data) && $data['CODTurnInPage'] !== null) {
                $object->setCODTurnInPage($this->denormalizer->denormalize($data['CODTurnInPage'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentResultsCODTurnInPage', 'json', $context));
            ...
            if (\array_key_exists('HighValueReport', $data) && $data['HighValueReport'] !== null) {
                $object->setHighValueReport($this->denormalizer->denormalize($data['HighValueReport'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentResultsHighValueReport', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\ShipmentResponseShipmentResults' => false];
        }
    }
} else {
    class ShipmentResponseShipmentResultsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
