...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class AvailabilityShippingAvailabilityNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\AvailabilityShippingAvailability';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\AvailabilityShippingAvailability';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\AvailabilityShippingAvailability();
            ...
            if (\array_key_exists('UnavailableReason', $data)) {
                $object->setUnavailableReason($this->denormalizer->denormalize($data['UnavailableReason'], 'BesmartandPro\\Ups\\Api\\Model\\ShippingAvailabilityUnavailableReason', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\AvailabilityShippingAvailability' => false];
        }
    }
} else {
    class AvailabilityShippingAvailabilityNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
