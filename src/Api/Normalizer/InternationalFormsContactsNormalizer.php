...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class InternationalFormsContactsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\InternationalFormsContacts';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\InternationalFormsContacts';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\InternationalFormsContacts();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('ForwardAgent', $data)) {
                $object->setForwardAgent($this->denormalizer->denormalize($data['ForwardAgent'], 'BesmartandPro\\Ups\\Api\\Model\\ContactsForwardAgent', 'json', $context));
                unset($data['ForwardAgent']);
            }
            if (\array_key_exists('UltimateConsignee', $data)) {
                $object->setUltimateConsignee($this->denormalizer->denormalize($data['UltimateConsignee'], 'BesmartandPro\\Ups\\Api\\Model\\ContactsUltimateConsignee', 'json', $context));
                unset($data['UltimateConsignee']);
            }
            if (\array_key_exists('IntermediateConsignee', $data)) {
                $object->setIntermediateConsignee($this->denormalizer->denormalize($data['IntermediateConsignee'], 'BesmartandPro\\Ups\\Api\\Model\\ContactsIntermediateConsignee', 'json', $context));
                unset($data['IntermediateConsignee']);
            }
            if (\array_key_exists('Producer', $data)) {
                $object->setProducer($this->denormalizer->denormalize($data['Producer'], 'BesmartandPro\\Ups\\Api\\Model\\ContactsProducer', 'json', $context));
                unset($data['Producer']);
            }
            if (\array_key_exists('SoldTo', $data)) {
                $object->setSoldTo($this->denormalizer->denormalize($data['SoldTo'], 'BesmartandPro\\Ups\\Api\\Model\\ContactsSoldTo', 'json', $context));
                unset($data['SoldTo']);
            }
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\InternationalFormsContacts' => false];
        }
    }
} else {
    class InternationalFormsContactsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
