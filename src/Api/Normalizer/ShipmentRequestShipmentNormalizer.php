...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ShipmentRequestShipmentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\ShipmentRequestShipment';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\ShipmentRequestShipment';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\ShipmentRequestShipment();
            ...
            if (\array_key_exists('ReturnService', $data)) {
                $object->setReturnService($this->denormalizer->denormalize($data['ReturnService'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentReturnService', 'json', $context));
            ...
            if (\array_key_exists('Shipper', $data)) {
                $object->setShipper($this->denormalizer->denormalize($data['Shipper'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentShipper', 'json', $context));
                unset($data['Shipper']);
            }
            if (\array_key_exists('ShipTo', $data)) {
                $object->setShipTo($this->denormalizer->denormalize($data['ShipTo'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentShipTo', 'json', $context));
                unset($data['ShipTo']);
            }
            if (\array_key_exists('AlternateDeliveryAddress', $data)) {
                $object->setAlternateDeliveryAddress($this->denormalizer->denormalize($data['AlternateDeliveryAddress'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentAlternateDeliveryAddress', 'json', $context));
                unset($data['AlternateDeliveryAddress']);
            }
            if (\array_key_exists('ShipFrom', $data)) {
                $object->setShipFrom($this->denormalizer->denormalize($data['ShipFrom'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentShipFrom', 'json', $context));
                unset($data['ShipFrom']);
            }
            if (\array_key_exists('PaymentInformation', $data)) {
                $object->setPaymentInformation($this->denormalizer->denormalize($data['PaymentInformation'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentPaymentInformation', 'json', $context));
                unset($data['PaymentInformation']);
            }
            if (\array_key_exists('FRSPaymentInformation', $data)) {
                $object->setFRSPaymentInformation($this->denormalizer->denormalize($data['FRSPaymentInformation'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentFRSPaymentInformation', 'json', $context));
                unset($data['FRSPaymentInformation']);
            }
            if (\array_key_exists('FreightShipmentInformation', $data)) {
                $object->setFreightShipmentInformation($this->denormalizer->denormalize($data['FreightShipmentInformation'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentFreightShipmentInformation', 'json', $context));
            ...
            if (\array_key_exists('PromotionalDiscountInformation', $data)) {
                $object->setPromotionalDiscountInformation($this->denormalizer->denormalize($data['PromotionalDiscountInformation'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentPromotionalDiscountInformation', 'json', $context));
                unset($data['PromotionalDiscountInformation']);
            }
            if (\array_key_exists('DGSignatoryInfo', $data)) {
                $object->setDGSignatoryInfo($this->denormalizer->denormalize($data['DGSignatoryInfo'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentDGSignatoryInfo', 'json', $context));
                unset($data['DGSignatoryInfo']);
            }
            if (\array_key_exists('ShipmentRatingOptions', $data)) {
                $object->setShipmentRatingOptions($this->denormalizer->denormalize($data['ShipmentRatingOptions'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentShipmentRatingOptions', 'json', $context));
            ...
            if (\array_key_exists('ReferenceNumber', $data)) {
                ...
                foreach ($data['ReferenceNumber'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\ShipmentReferenceNumber', 'json', $context);
                }
                $object->setReferenceNumber($values);
                unset($data['ReferenceNumber']);
            }
            if (\array_key_exists('Service', $data)) {
                $object->setService($this->denormalizer->denormalize($data['Service'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentService', 'json', $context));
                unset($data['Service']);
            }
            if (\array_key_exists('InvoiceLineTotal', $data)) {
                $object->setInvoiceLineTotal($this->denormalizer->denormalize($data['InvoiceLineTotal'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentInvoiceLineTotal', 'json', $context));
            ...
            if (\array_key_exists('ShipmentIndicationType', $data)) {
                ...
                foreach ($data['ShipmentIndicationType'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\Ups\\Api\\Model\\ShipmentShipmentIndicationType', 'json', $context);
                }
            ...
            if (\array_key_exists('ShipmentServiceOptions', $data)) {
                $object->setShipmentServiceOptions($this->denormalizer->denormalize($data['ShipmentServiceOptions'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentShipmentServiceOptions', 'json', $context));
            ...
            if (\array_key_exists('Package', $data)) {
                ...
                foreach ($data['Package'] as $value_2) {
                    $values_2[] = $this->denormalizer->denormalize($value_2, 'BesmartandPro\\Ups\\Api\\Model\\ShipmentPackage', 'json', $context);
                }
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\ShipmentRequestShipment' => false];
        }
    }
} else {
    class ShipmentRequestShipmentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
