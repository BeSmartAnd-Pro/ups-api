...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class RateResponseRatedShipmentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\RateResponseRatedShipment';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\RateResponseRatedShipment';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\RateResponseRatedShipment();
            ...
            if (\array_key_exists('Disclaimer', $data)) {
                ...
                foreach ($data['Disclaimer'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\RatedShipmentDisclaimer', 'json', $context);
                }
                $object->setDisclaimer($values);
                unset($data['Disclaimer']);
            }
            if (\array_key_exists('Service', $data)) {
                $object->setService($this->denormalizer->denormalize($data['Service'], 'BesmartandPro\\Ups\\Api\\Model\\RatedShipmentService', 'json', $context));
                unset($data['Service']);
            }
            ...
            if (\array_key_exists('RatedShipmentAlert', $data)) {
                ...
                foreach ($data['RatedShipmentAlert'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\Ups\\Api\\Model\\RatedShipmentRatedShipmentAlert', 'json', $context);
                }
            ...
            if (\array_key_exists('BillingWeight', $data)) {
                $object->setBillingWeight($this->denormalizer->denormalize($data['BillingWeight'], 'BesmartandPro\\Ups\\Api\\Model\\RatedShipmentBillingWeight', 'json', $context));
                unset($data['BillingWeight']);
            }
            if (\array_key_exists('TransportationCharges', $data)) {
                $object->setTransportationCharges($this->denormalizer->denormalize($data['TransportationCharges'], 'BesmartandPro\\Ups\\Api\\Model\\RatedShipmentTransportationCharges', 'json', $context));
                unset($data['TransportationCharges']);
            }
            if (\array_key_exists('BaseServiceCharge', $data)) {
                $object->setBaseServiceCharge($this->denormalizer->denormalize($data['BaseServiceCharge'], 'BesmartandPro\\Ups\\Api\\Model\\RatedShipmentBaseServiceCharge', 'json', $context));
                unset($data['BaseServiceCharge']);
            }
            if (\array_key_exists('ItemizedCharges', $data)) {
                $values_2 = [];
                foreach ($data['ItemizedCharges'] as $value_2) {
                    $values_2[] = $this->denormalizer->denormalize($value_2, 'BesmartandPro\\Ups\\Api\\Model\\RatedShipmentItemizedCharges', 'json', $context);
                }
                $object->setItemizedCharges($values_2);
                unset($data['ItemizedCharges']);
            }
            if (\array_key_exists('FRSShipmentData', $data)) {
                $object->setFRSShipmentData($this->denormalizer->denormalize($data['FRSShipmentData'], 'BesmartandPro\\Ups\\Api\\Model\\RatedShipmentFRSShipmentData', 'json', $context));
                unset($data['FRSShipmentData']);
            }
            if (\array_key_exists('ServiceOptionsCharges', $data)) {
                $object->setServiceOptionsCharges($this->denormalizer->denormalize($data['ServiceOptionsCharges'], 'BesmartandPro\\Ups\\Api\\Model\\RatedShipmentServiceOptionsCharges', 'json', $context));
                unset($data['ServiceOptionsCharges']);
            }
            if (\array_key_exists('TaxCharges', $data)) {
                $values_3 = [];
                foreach ($data['TaxCharges'] as $value_3) {
                    $values_3[] = $this->denormalizer->denormalize($value_3, 'BesmartandPro\\Ups\\Api\\Model\\RatedShipmentTaxCharges', 'json', $context);
                }
                $object->setTaxCharges($values_3);
                unset($data['TaxCharges']);
            }
            if (\array_key_exists('TotalCharges', $data)) {
                $object->setTotalCharges($this->denormalizer->denormalize($data['TotalCharges'], 'BesmartandPro\\Ups\\Api\\Model\\RatedShipmentTotalCharges', 'json', $context));
                unset($data['TotalCharges']);
            }
            if (\array_key_exists('TotalChargesWithTaxes', $data)) {
                $object->setTotalChargesWithTaxes($this->denormalizer->denormalize($data['TotalChargesWithTaxes'], 'BesmartandPro\\Ups\\Api\\Model\\RatedShipmentTotalChargesWithTaxes', 'json', $context));
                unset($data['TotalChargesWithTaxes']);
            }
            if (\array_key_exists('NegotiatedRateCharges', $data)) {
                $object->setNegotiatedRateCharges($this->denormalizer->denormalize($data['NegotiatedRateCharges'], 'BesmartandPro\\Ups\\Api\\Model\\RatedShipmentNegotiatedRateCharges', 'json', $context));
                unset($data['NegotiatedRateCharges']);
            }
            if (\array_key_exists('RatedPackage', $data)) {
                $values_4 = [];
                foreach ($data['RatedPackage'] as $value_4) {
                    $values_4[] = $this->denormalizer->denormalize($value_4, 'BesmartandPro\\Ups\\Api\\Model\\RatedShipmentRatedPackage', 'json', $context);
                }
                $object->setRatedPackage($values_4);
                unset($data['RatedPackage']);
            }
            if (\array_key_exists('TimeInTransit', $data)) {
                $object->setTimeInTransit($this->denormalizer->denormalize($data['TimeInTransit'], 'BesmartandPro\\Ups\\Api\\Model\\RatedShipmentTimeInTransit', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\RateResponseRatedShipment' => false];
        }
    }
} else {
    class RateResponseRatedShipmentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
