...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ShipmentShipmentServiceOptionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\ShipmentShipmentServiceOptions';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\ShipmentShipmentServiceOptions';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\ShipmentShipmentServiceOptions();
            ...
            if (\array_key_exists('COD', $data)) {
                $object->setCOD($this->denormalizer->denormalize($data['COD'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentServiceOptionsCOD', 'json', $context));
                unset($data['COD']);
            }
            if (\array_key_exists('AccessPointCOD', $data)) {
                $object->setAccessPointCOD($this->denormalizer->denormalize($data['AccessPointCOD'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentServiceOptionsAccessPointCOD', 'json', $context));
            ...
            if (\array_key_exists('Notification', $data)) {
                ...
                foreach ($data['Notification'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'BesmartandPro\\Ups\\Api\\Model\\ShipmentServiceOptionsNotification', 'json', $context);
                }
                $object->setNotification($values);
                unset($data['Notification']);
            }
            if (\array_key_exists('LabelDelivery', $data)) {
                $object->setLabelDelivery($this->denormalizer->denormalize($data['LabelDelivery'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentServiceOptionsLabelDelivery', 'json', $context));
                unset($data['LabelDelivery']);
            }
            if (\array_key_exists('InternationalForms', $data)) {
                $object->setInternationalForms($this->denormalizer->denormalize($data['InternationalForms'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentServiceOptionsInternationalForms', 'json', $context));
                unset($data['InternationalForms']);
            }
            if (\array_key_exists('DeliveryConfirmation', $data)) {
                $object->setDeliveryConfirmation($this->denormalizer->denormalize($data['DeliveryConfirmation'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentServiceOptionsDeliveryConfirmation', 'json', $context));
            ...
            if (\array_key_exists('LabelMethod', $data)) {
                $object->setLabelMethod($this->denormalizer->denormalize($data['LabelMethod'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentServiceOptionsLabelMethod', 'json', $context));
            ...
            if (\array_key_exists('PreAlertNotification', $data)) {
                ...
                foreach ($data['PreAlertNotification'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'BesmartandPro\\Ups\\Api\\Model\\ShipmentServiceOptionsPreAlertNotification', 'json', $context);
                }
            ...
            if (\array_key_exists('RestrictedArticles', $data)) {
                $object->setRestrictedArticles($this->denormalizer->denormalize($data['RestrictedArticles'], 'BesmartandPro\\Ups\\Api\\Model\\ShipmentServiceOptionsRestrictedArticles', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\ShipmentShipmentServiceOptions' => false];
        }
    }
} else {
    class ShipmentShipmentServiceOptionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
