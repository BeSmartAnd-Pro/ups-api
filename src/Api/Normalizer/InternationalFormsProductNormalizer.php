...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class InternationalFormsProductNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\InternationalFormsProduct';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\InternationalFormsProduct';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\InternationalFormsProduct();
            ...
            if (\array_key_exists('Unit', $data)) {
                $object->setUnit($this->denormalizer->denormalize($data['Unit'], 'BesmartandPro\\Ups\\Api\\Model\\ProductUnit', 'json', $context));
                unset($data['Unit']);
            }
            ...
            if (\array_key_exists('NetCostDateRange', $data)) {
                $object->setNetCostDateRange($this->denormalizer->denormalize($data['NetCostDateRange'], 'BesmartandPro\\Ups\\Api\\Model\\ProductNetCostDateRange', 'json', $context));
            ...
            if (\array_key_exists('ProductWeight', $data)) {
                $object->setProductWeight($this->denormalizer->denormalize($data['ProductWeight'], 'BesmartandPro\\Ups\\Api\\Model\\ProductProductWeight', 'json', $context));
            ...
            if (\array_key_exists('ScheduleB', $data)) {
                $object->setScheduleB($this->denormalizer->denormalize($data['ScheduleB'], 'BesmartandPro\\Ups\\Api\\Model\\ProductScheduleB', 'json', $context));
            ...
            if (\array_key_exists('ExcludeFromForm', $data)) {
                $object->setExcludeFromForm($this->denormalizer->denormalize($data['ExcludeFromForm'], 'BesmartandPro\\Ups\\Api\\Model\\ProductExcludeFromForm', 'json', $context));
                unset($data['ExcludeFromForm']);
            }
            if (\array_key_exists('PackingListInfo', $data)) {
                $object->setPackingListInfo($this->denormalizer->denormalize($data['PackingListInfo'], 'BesmartandPro\\Ups\\Api\\Model\\ProductPackingListInfo', 'json', $context));
                unset($data['PackingListInfo']);
            }
            if (\array_key_exists('EEIInformation', $data)) {
                $object->setEEIInformation($this->denormalizer->denormalize($data['EEIInformation'], 'BesmartandPro\\Ups\\Api\\Model\\ProductEEIInformation', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\InternationalFormsProduct' => false];
        }
    }
} else {
    class InternationalFormsProductNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
