...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class LocatorRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\LocatorRequest';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\LocatorRequest';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\LocatorRequest();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('Request', $data)) {
                $object->setRequest($this->denormalizer->denormalize($data['Request'], 'BesmartandPro\\Ups\\Api\\Model\\LocatorRequestRequest', 'json', $context));
                unset($data['Request']);
            }
            if (\array_key_exists('OriginAddress', $data)) {
                $object->setOriginAddress($this->denormalizer->denormalize($data['OriginAddress'], 'BesmartandPro\\Ups\\Api\\Model\\LocatorRequestOriginAddress', 'json', $context));
                unset($data['OriginAddress']);
            }
            if (\array_key_exists('Translate', $data)) {
                $object->setTranslate($this->denormalizer->denormalize($data['Translate'], 'BesmartandPro\\Ups\\Api\\Model\\LocatorRequestTranslate', 'json', $context));
                unset($data['Translate']);
            }
            if (\array_key_exists('UnitOfMeasurement', $data)) {
                $object->setUnitOfMeasurement($this->denormalizer->denormalize($data['UnitOfMeasurement'], 'BesmartandPro\\Ups\\Api\\Model\\LocatorRequestUnitOfMeasurement', 'json', $context));
            ...
            if (\array_key_exists('LocationSearchCriteria', $data)) {
                $object->setLocationSearchCriteria($this->denormalizer->denormalize($data['LocationSearchCriteria'], 'BesmartandPro\\Ups\\Api\\Model\\LocatorRequestLocationSearchCriteria', 'json', $context));
                unset($data['LocationSearchCriteria']);
            }
            if (\array_key_exists('SortCriteria', $data)) {
                $object->setSortCriteria($this->denormalizer->denormalize($data['SortCriteria'], 'BesmartandPro\\Ups\\Api\\Model\\LocatorRequestSortCriteria', 'json', $context));
            ...
            if (\array_key_exists('ServiceGeoUnit', $data)) {
                $object->setServiceGeoUnit($this->denormalizer->denormalize($data['ServiceGeoUnit'], 'BesmartandPro\\Ups\\Api\\Model\\LocatorRequestServiceGeoUnit', 'json', $context));
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\LocatorRequest' => false];
        }
    }
} else {
    class LocatorRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
