...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class FreightShipmentServiceOptionsCODNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'BesmartandPro\\Ups\\Api\\Model\\FreightShipmentServiceOptionsCOD';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'BesmartandPro\\Ups\\Api\\Model\\FreightShipmentServiceOptionsCOD';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \BesmartandPro\Ups\Api\Model\FreightShipmentServiceOptionsCOD();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('CODValue', $data)) {
                $object->setCODValue($this->denormalizer->denormalize($data['CODValue'], 'BesmartandPro\\Ups\\Api\\Model\\CODCODValue', 'json', $context));
                unset($data['CODValue']);
            }
            if (\array_key_exists('CODPaymentMethod', $data)) {
                $object->setCODPaymentMethod($this->denormalizer->denormalize($data['CODPaymentMethod'], 'BesmartandPro\\Ups\\Api\\Model\\CODCODPaymentMethod', 'json', $context));
                unset($data['CODPaymentMethod']);
            }
            if (\array_key_exists('CODBillingOption', $data)) {
                $object->setCODBillingOption($this->denormalizer->denormalize($data['CODBillingOption'], 'BesmartandPro\\Ups\\Api\\Model\\CODCODBillingOption', 'json', $context));
                unset($data['CODBillingOption']);
            }
            if (\array_key_exists('RemitTo', $data)) {
                $object->setRemitTo($this->denormalizer->denormalize($data['RemitTo'], 'BesmartandPro\\Ups\\Api\\Model\\CODRemitTo', 'json', $context));
                unset($data['RemitTo']);
            }
        ...
        {
            return ['BesmartandPro\\Ups\\Api\\Model\\FreightShipmentServiceOptionsCOD' => false];
        }
    }
} else {
    class FreightShipmentServiceOptionsCODNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
