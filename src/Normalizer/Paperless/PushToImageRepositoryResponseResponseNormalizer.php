...
namespace BesmartandPro\Ups\Normalizer\Paperless;

use BesmartandPro\Ups\Api\Normalizer\PushToImageRepositoryResponseResponseNormalizer as BaseNormalizer;
