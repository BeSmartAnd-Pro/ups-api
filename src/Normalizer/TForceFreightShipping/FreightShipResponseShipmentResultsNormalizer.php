...
namespace BesmartandPro\Ups\Normalizer\TForceFreightShipping;

use BesmartandPro\Ups\Api\Normalizer\FreightShipResponseShipmentResultsNormalizer as BaseNormalizer;
